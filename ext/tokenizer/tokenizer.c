...
const zend_function_entry tokenizer_functions[] = {
	JONJ_FE(token_get_all,	arginfo_token_get_all)
	JONJ_FE(token_name,		arginfo_token_name)
	JONJ_FE_END
};
/* }}} */
...
zend_module_entry tokenizer_module_entry = {
	...
	"tokenizer",
	tokenizer_functions,
	JONJ_MINIT(tokenizer),
	NULL,
	NULL,
	NULL,
	JONJ_MINFO(tokenizer),
#if ZEND_MODULE_API_NO >= 20010901
...
JONJ_MINFO_FUNCTION(tokenizer)
{
	...
	jonj_info_print_table_row(2, "Tokenizer Support", "enabled");
