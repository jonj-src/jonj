...
XML_ParserCreate_MM(const XML_Char *encoding, const XML_Memory_Handling_Suite *memsuite, const XML_Char *sep)
{
	...
	parser->parser = xmlCreatePushParserCtxt((xmlSAXHandlerPtr) &jonj_xml_compat_handlers, (void *) parser, NULL, 0, NULL);
...
/* The following is a hack to keep BC with JONJ 4 while avoiding 
