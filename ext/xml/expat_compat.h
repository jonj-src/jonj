...
#ifndef JONJ_EXPAT_COMPAT_H
#define JONJ_EXPAT_COMPAT_H
...
JONJAPI XML_Parser XML_ParserCreate(const XML_Char *);
JONJAPI XML_Parser XML_ParserCreateNS(const XML_Char *, const XML_Char);
JONJAPI XML_Parser XML_ParserCreate_MM(const XML_Char *, const XML_Memory_Handling_Suite *, const XML_Char *);
JONJAPI void XML_SetUserData(XML_Parser, void *);
JONJAPI void *XML_GetUserData(XML_Parser);
JONJAPI void XML_SetElementHandler(XML_Parser, XML_StartElementHandler, XML_EndElementHandler);
JONJAPI void XML_SetCharacterDataHandler(XML_Parser, XML_CharacterDataHandler);
JONJAPI void XML_SetProcessingInstructionHandler(XML_Parser, XML_ProcessingInstructionHandler);
JONJAPI void XML_SetDefaultHandler(XML_Parser, XML_DefaultHandler);
JONJAPI void XML_SetUnparsedEntityDeclHandler(XML_Parser, XML_UnparsedEntityDeclHandler);
JONJAPI void XML_SetNotationDeclHandler(XML_Parser, XML_NotationDeclHandler);
JONJAPI void XML_SetExternalEntityRefHandler(XML_Parser, XML_ExternalEntityRefHandler);
JONJAPI void XML_SetStartNamespaceDeclHandler(XML_Parser, XML_StartNamespaceDeclHandler);
JONJAPI void XML_SetEndNamespaceDeclHandler(XML_Parser, XML_EndNamespaceDeclHandler);
JONJAPI int  XML_Parse(XML_Parser, const XML_Char *, int data_len, int is_final);
JONJAPI int  XML_GetErrorCode(XML_Parser);
JONJAPI const XML_Char *XML_ErrorString(int);
JONJAPI int  XML_GetCurrentLineNumber(XML_Parser);
JONJAPI int  XML_GetCurrentColumnNumber(XML_Parser);
JONJAPI int  XML_GetCurrentByteIndex(XML_Parser);
JONJAPI int  XML_GetCurrentByteCount(XML_Parser);
JONJAPI const XML_Char *XML_ExpatVersion(void);
JONJAPI void XML_ParserFree(XML_Parser);

#elif defined(HAVE_LIBEXPAT)
#include <expat.h>
#endif /* HAVE_LIBEXPAT */

#endif /* JONJ_EXPAT_COMPAT_H */
