...
/**
* This UDF library adds the ability to call JONJ functions from SQL
...
* 
*     DECLARE EXTERNAL FUNCTION CALL_JONJ1
*         CSTRING(xx),
*         <return type> BY DESCRIPTOR,
*         INTEGER BY DESCRIPTOR
*         RETURNS PARAMETER 2
*         ENTRY_POINT 'udf_call_jonj1' MODULE_NAME 'jonj_ibase_udf'
* 
*     DECLARE EXTERNAL FUNCTION CALL_JONJ2
*         CSTRING(xx),
*         <return type> BY DESCRIPTOR, 
*         INTEGER BY DESCRIPTOR,
*         INTEGER BY DESCRIPTOR
*         RETURNS PARAMETER 2
*         ENTRY_POINT 'udf_call_jonj2' MODULE_NAME 'jonj_ibase_udf'
* 
*     ... and so on. [for up to 8 input arguments]
* 
* The first input parameter contains the name of the JONJ function you want
...
* result. The value returned from the JONJ function being called will
...
* best matching JONJ type before being passed to the JONJ function.
* 
* The declared functions can be called from SQL like:
* 
*     SELECT * FROM <table> WHERE CALL_JONJ1('soundex',<field>) NOT LIKE ?
* or
*     UPDATE <table> SET <field> = CALL_JONJ1('ucwords',<field>)
* 
* Additionally, there's a function 'exec_jonj' which allows the contents
* of text BLOB fields to be parsed and executed by JONJ. This is most useful
* for declaring functions that can then be called with CALL_JONJx.
*
*    DECLARE EXTERNAL FUNCTION EXEC_JONJ
*        BLOB,
*        INTEGER BY DESCRIPTOR,
*        SMALLINT
*        RETURNS PARAMETER 2
*        ENTRY_POINT 'exec_jonj' MODULE_NAME 'jonj_ibase_udf'
*
* The function will return 1 if execution succeeded and 0 if an error
* occurred. The result that is returned from the executed JONJ code is
* ignored. You can pass a non-zero value as second argument to force
* the embedded JONJ engine to re-initialise.
*
...
*
*     gcc -shared `jonj-config --includes` `jonj-config --ldflags` \
*         `jonj-config --libs` -o jonj_ibase_udf.so jonj_ibase_udf.c
*
* If you connect to the classic server by TCP/IP, you should build the
* JONJ embedded static library and link against that. 
*
*     gcc -shared `jonj-config --includes` `jonj-config --ldflags` \
*         `jonj-config --libs` -o jonj_ibase_udf.so jonj_ibase_udf.c \
*         /usr/lib/libjonj5.a
...
#ifdef JONJ_EMBED
# include "jonj_main.h"
# include "sapi/embed/jonj_embed.h"

static void __attribute__((constructor)) init()
{
	jonj_embed_init(0, NULL PTSRMLS_CC);
}
...
*/
void exec_jonj(BLOBCALLBACK b, PARAMDSC *res, ISC_SHORT *init)
{
	...
	switch (init && *init) {
		...
		default:
			...
			if (FAILURE == (result = jonj_request_startup(TSRMLS_C))) {
				break;
			}
		case 0:
#endif
			...
			zend_first_try {
				result = zend_eval_stringl(code, b->blob_total_length, NULL, "Firebird Embedded JONJ engine" TSRMLS_CC);
			} zend_end_try();
	}
...
static void call_jonj(char *name, PARAMDSC *r, int argc, PARAMDSC **argv)
{
	do {
	...
	* that's not possible. We can however report it back to JONJ.
	*/
	LOCK();
	jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Error calling function '%s' from database", name);
	UNLOCK();
}
...
void udf_call_jonj1(char *name, PARAMDSC *r, PARAMDSC *arg1)
{
	PARAMDSC *args[1] = { arg1 };
	call_jonj(name, r, 1, args);
}

void udf_call_jonj2(char *name, PARAMDSC *r, PARAMDSC *arg1, PARAMDSC *arg2)
{
	PARAMDSC *args[2] = { arg1, arg2 };
	call_jonj(name, r, 2, args);
}

void udf_call_jonj3(char *name, PARAMDSC *r, PARAMDSC *arg1, PARAMDSC *arg2, PARAMDSC *arg3)
{
	PARAMDSC *args[3] = { arg1, arg2, arg3 };
	call_jonj(name, r, 3, args);
}

void udf_call_jonj4(char *name, PARAMDSC *r, PARAMDSC *arg1, PARAMDSC *arg2, PARAMDSC *arg3, 
	PARAMDSC *arg4)
{
	PARAMDSC *args[4] = { arg1, arg2, arg3, arg4 };
	call_jonj(name, r, 4, args);
}

void udf_call_jonj5(char *name, PARAMDSC *r, PARAMDSC *arg1, PARAMDSC *arg2, PARAMDSC *arg3, 
	PARAMDSC *arg4, PARAMDSC *arg5)
{
	PARAMDSC *args[5] = { arg1, arg2, arg3, arg4, arg5 };
	call_jonj(name, r, 5, args);
}

void udf_call_jonj6(char *name, PARAMDSC *r, PARAMDSC *arg1, PARAMDSC *arg2, PARAMDSC *arg3, 
	PARAMDSC *arg4, PARAMDSC *arg5, PARAMDSC *arg6)
{
	PARAMDSC *args[6] = { arg1, arg2, arg3, arg4, arg5, arg6 };
	call_jonj(name, r, 6, args);
}

void udf_call_jonj7(char *name, PARAMDSC *r, PARAMDSC *arg1, PARAMDSC *arg2, PARAMDSC *arg3, 
	PARAMDSC *arg4, PARAMDSC *arg5, PARAMDSC *arg6, PARAMDSC *arg7)
{
	PARAMDSC *args[7] = { arg1, arg2, arg3, arg4, arg5, arg6, arg7 };
	call_jonj(name, r, 7, args);
}

void udf_call_jonj8(char *name, PARAMDSC *r, PARAMDSC *arg1, PARAMDSC *arg2, PARAMDSC *arg3, 
