...
#include "ext/standard/jonj_versioning.h"
#include "ext/standard/jonj_math.h"
#include "jonj_date.h"
...
#ifdef JONJ_WIN32
static __inline __int64 jonj_date_llabs( __int64 i ) { return i >= 0? i: -i; }
#elif defined(__GNUC__) && __GNUC__ < 3
static __inline __int64_t jonj_date_llabs( __int64_t i ) { return i >= 0 ? i : -i; }
#else
static inline long long jonj_date_llabs( long long i ) { return i >= 0 ? i : -i; }
#endif
...
const zend_function_entry date_functions[] = {
	JONJ_FE(strtotime, arginfo_strtotime)
	JONJ_FE(date, arginfo_date)
	JONJ_FE(idate, arginfo_idate)
	JONJ_FE(gmdate, arginfo_gmdate)
	JONJ_FE(mktime, arginfo_mktime)
	JONJ_FE(gmmktime, arginfo_gmmktime)
	JONJ_FE(checkdate, arginfo_checkdate)

#ifdef HAVE_STRFTIME
	JONJ_FE(strftime, arginfo_strftime)
	JONJ_FE(gmstrftime, arginfo_gmstrftime)
#endif

	JONJ_FE(time, arginfo_time)
	JONJ_FE(localtime, arginfo_localtime)
	JONJ_FE(getdate, arginfo_getdate)

	/* Advanced Interface */
	JONJ_FE(date_create, arginfo_date_create)
	JONJ_FE(date_create_immutable, arginfo_date_create)
	JONJ_FE(date_create_from_format, arginfo_date_create_from_format)
	JONJ_FE(date_create_immutable_from_format, arginfo_date_create_from_format)
	JONJ_FE(date_parse, arginfo_date_parse)
	JONJ_FE(date_parse_from_format, arginfo_date_parse_from_format)
	JONJ_FE(date_get_last_errors, arginfo_date_get_last_errors)
	JONJ_FE(date_format, arginfo_date_format)
	JONJ_FE(date_modify, arginfo_date_modify)
	JONJ_FE(date_add, arginfo_date_add)
	JONJ_FE(date_sub, arginfo_date_sub)
	JONJ_FE(date_timezone_get, arginfo_date_timezone_get)
	JONJ_FE(date_timezone_set, arginfo_date_timezone_set)
	JONJ_FE(date_offset_get, arginfo_date_offset_get)
	JONJ_FE(date_diff, arginfo_date_diff)

	JONJ_FE(date_time_set, arginfo_date_time_set)
	JONJ_FE(date_date_set, arginfo_date_date_set)
	JONJ_FE(date_isodate_set, arginfo_date_isodate_set)
	JONJ_FE(date_timestamp_set, arginfo_date_timestamp_set)
	JONJ_FE(date_timestamp_get, arginfo_date_timestamp_get)

	JONJ_FE(timezone_open, arginfo_timezone_open)
	JONJ_FE(timezone_name_get, arginfo_timezone_name_get)
	JONJ_FE(timezone_name_from_abbr, arginfo_timezone_name_from_abbr)
	JONJ_FE(timezone_offset_get, arginfo_timezone_offset_get)
	JONJ_FE(timezone_transitions_get, arginfo_timezone_transitions_get)
	JONJ_FE(timezone_location_get, arginfo_timezone_location_get)
	JONJ_FE(timezone_identifiers_list, arginfo_timezone_identifiers_list)
	JONJ_FE(timezone_abbreviations_list, arginfo_timezone_abbreviations_list)
	JONJ_FE(timezone_version_get, arginfo_timezone_version_get)

	JONJ_FE(date_interval_create_from_date_string, arginfo_date_interval_create_from_date_string)
	JONJ_FE(date_interval_format, arginfo_date_interval_format)

	/* Options and Configuration */
	JONJ_FE(date_default_timezone_set, arginfo_date_default_timezone_set)
	JONJ_FE(date_default_timezone_get, arginfo_date_default_timezone_get)

	/* Astronomical functions */
	JONJ_FE(date_sunrise, arginfo_date_sunrise)
	JONJ_FE(date_sunset, arginfo_date_sunset)
	JONJ_FE(date_sun_info, arginfo_date_sun_info)
	JONJ_FE_END
};

static const zend_function_entry date_funcs_interface[] = {
	JONJ_ABSTRACT_ME(DateTimeInterface, format, arginfo_date_method_format)
	JONJ_ABSTRACT_ME(DateTimeInterface, getTimezone, arginfo_date_method_timezone_get)
	JONJ_ABSTRACT_ME(DateTimeInterface, getOffset, arginfo_date_method_offset_get)
	JONJ_ABSTRACT_ME(DateTimeInterface, getTimestamp, arginfo_date_method_timestamp_get)
	JONJ_ABSTRACT_ME(DateTimeInterface, diff, arginfo_date_method_diff)
	JONJ_ABSTRACT_ME(DateTimeInterface, __wakeup, NULL)
	JONJ_FE_END
};

const zend_function_entry date_funcs_date[] = {
	JONJ_ME(DateTime,			__construct,		arginfo_date_create, ZEND_ACC_CTOR|ZEND_ACC_PUBLIC)
	JONJ_ME(DateTime,			__wakeup,			NULL, ZEND_ACC_PUBLIC)
	JONJ_ME(DateTime,			__set_state,		NULL, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	JONJ_ME_MAPPING(createFromFormat, date_create_from_format,	arginfo_date_create_from_format, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	JONJ_ME_MAPPING(getLastErrors, date_get_last_errors,	arginfo_date_get_last_errors, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	JONJ_ME_MAPPING(format,		date_format,		arginfo_date_method_format, 0)
	JONJ_ME_MAPPING(modify,		date_modify,		arginfo_date_method_modify, 0)
	JONJ_ME_MAPPING(add,			date_add,			arginfo_date_method_add, 0)
	JONJ_ME_MAPPING(sub,			date_sub,			arginfo_date_method_sub, 0)
	JONJ_ME_MAPPING(getTimezone, date_timezone_get,	arginfo_date_method_timezone_get, 0)
	JONJ_ME_MAPPING(setTimezone, date_timezone_set,	arginfo_date_method_timezone_set, 0)
	JONJ_ME_MAPPING(getOffset,	date_offset_get,	arginfo_date_method_offset_get, 0)
	JONJ_ME_MAPPING(setTime,		date_time_set,		arginfo_date_method_time_set, 0)
	JONJ_ME_MAPPING(setDate,		date_date_set,		arginfo_date_method_date_set, 0)
	JONJ_ME_MAPPING(setISODate,	date_isodate_set,	arginfo_date_method_isodate_set, 0)
	JONJ_ME_MAPPING(setTimestamp,	date_timestamp_set, arginfo_date_method_timestamp_set, 0)
	JONJ_ME_MAPPING(getTimestamp,	date_timestamp_get, arginfo_date_method_timestamp_get, 0)
	JONJ_ME_MAPPING(diff,			date_diff, arginfo_date_method_diff, 0)
	JONJ_FE_END
};

const zend_function_entry date_funcs_immutable[] = {
	JONJ_ME(DateTimeImmutable, __construct,   arginfo_date_create, ZEND_ACC_CTOR|ZEND_ACC_PUBLIC)
	JONJ_ME(DateTime, __wakeup,       NULL, ZEND_ACC_PUBLIC)
	JONJ_ME(DateTimeImmutable, __set_state,   NULL, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	JONJ_ME_MAPPING(createFromFormat, date_create_immutable_from_format, arginfo_date_create_from_format, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	JONJ_ME_MAPPING(getLastErrors,    date_get_last_errors,    arginfo_date_get_last_errors, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	JONJ_ME_MAPPING(format,           date_format,             arginfo_date_method_format, 0)
	JONJ_ME_MAPPING(getTimezone, date_timezone_get,	arginfo_date_method_timezone_get, 0)
	JONJ_ME_MAPPING(getOffset,	date_offset_get,	arginfo_date_method_offset_get, 0)
	JONJ_ME_MAPPING(getTimestamp,	date_timestamp_get, arginfo_date_method_timestamp_get, 0)
	JONJ_ME_MAPPING(diff,			date_diff, arginfo_date_method_diff, 0)
	JONJ_ME(DateTimeImmutable, modify,        arginfo_date_method_modify, 0)
	JONJ_ME(DateTimeImmutable, add,           arginfo_date_method_add, 0)
	JONJ_ME(DateTimeImmutable, sub,           arginfo_date_method_sub, 0)
	JONJ_ME(DateTimeImmutable, setTimezone,   arginfo_date_method_timezone_set, 0)
	JONJ_ME(DateTimeImmutable, setTime,       arginfo_date_method_time_set, 0)
	JONJ_ME(DateTimeImmutable, setDate,       arginfo_date_method_date_set, 0)
	JONJ_ME(DateTimeImmutable, setISODate,    arginfo_date_method_isodate_set, 0)
	JONJ_ME(DateTimeImmutable, setTimestamp,  arginfo_date_method_timestamp_set, 0)
	JONJ_ME(DateTimeImmutable, createFromMutable, arginfo_date_method_create_from_mutable, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	JONJ_FE_END
};

const zend_function_entry date_funcs_timezone[] = {
	JONJ_ME(DateTimeZone,              __construct,                 arginfo_timezone_open, ZEND_ACC_CTOR|ZEND_ACC_PUBLIC)
	JONJ_ME(DateTimeZone,              __wakeup,                    NULL, ZEND_ACC_PUBLIC)
	JONJ_ME(DateTimeZone,              __set_state,                 NULL, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	JONJ_ME_MAPPING(getName,           timezone_name_get,           arginfo_timezone_method_name_get, 0)
	JONJ_ME_MAPPING(getOffset,         timezone_offset_get,         arginfo_timezone_method_offset_get, 0)
	JONJ_ME_MAPPING(getTransitions,    timezone_transitions_get,    arginfo_timezone_method_transitions_get, 0)
	JONJ_ME_MAPPING(getLocation,       timezone_location_get,       arginfo_timezone_method_location_get, 0)
	JONJ_ME_MAPPING(listAbbreviations, timezone_abbreviations_list, arginfo_timezone_abbreviations_list, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	JONJ_ME_MAPPING(listIdentifiers,   timezone_identifiers_list,   arginfo_timezone_identifiers_list, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	JONJ_FE_END
};

const zend_function_entry date_funcs_interval[] = {
	JONJ_ME(DateInterval,              __construct,                 arginfo_date_interval_construct, ZEND_ACC_CTOR|ZEND_ACC_PUBLIC)
	JONJ_ME(DateInterval,              __wakeup,                    NULL, ZEND_ACC_PUBLIC)
	JONJ_ME(DateInterval,              __set_state,                 NULL, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	JONJ_ME_MAPPING(format,            date_interval_format,        arginfo_date_method_interval_format, 0)
	JONJ_ME_MAPPING(createFromDateString, date_interval_create_from_date_string,	arginfo_date_interval_create_from_date_string, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	JONJ_FE_END
};

const zend_function_entry date_funcs_period[] = {
	JONJ_ME(DatePeriod,                __construct,                 arginfo_date_period_construct, ZEND_ACC_CTOR|ZEND_ACC_PUBLIC)
	JONJ_ME(DatePeriod,                __wakeup,                    NULL, ZEND_ACC_PUBLIC)
	JONJ_ME(DatePeriod,                __set_state,                 NULL, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	JONJ_ME(DatePeriod,                getStartDate,                NULL, ZEND_ACC_PUBLIC)
	JONJ_ME(DatePeriod,                getEndDate,                  NULL, ZEND_ACC_PUBLIC)
	JONJ_ME(DatePeriod,                getDateInterval,             NULL, ZEND_ACC_PUBLIC)
	JONJ_FE_END
};
...
static JONJ_GINIT_FUNCTION(date);

/* True global */
timelib_tzdb *jonj_date_global_timezone_db;
int jonj_date_global_timezone_db_enabled;
...
static JONJ_INI_MH(OnUpdate_date_timezone);

/* {{{ INI Settings */
JONJ_INI_BEGIN()
	STD_JONJ_INI_ENTRY("date.timezone", "", JONJ_INI_ALL, OnUpdate_date_timezone, default_timezone, zend_date_globals, date_globals)
	JONJ_INI_ENTRY("date.default_latitude",           DATE_DEFAULT_LATITUDE,        JONJ_INI_ALL, NULL)
	JONJ_INI_ENTRY("date.default_longitude",          DATE_DEFAULT_LONGITUDE,       JONJ_INI_ALL, NULL)
	JONJ_INI_ENTRY("date.sunset_zenith",              DATE_SUNSET_ZENITH,           JONJ_INI_ALL, NULL)
	JONJ_INI_ENTRY("date.sunrise_zenith",             DATE_SUNRISE_ZENITH,          JONJ_INI_ALL, NULL)
JONJ_INI_END()
/* }}} */
...
#define DATE_FETCH_OBJECT	\
	...
	obj = (jonj_date_obj *) zend_object_store_get_object(object TSRMLS_CC);	\

#define DATE_CHECK_INITIALIZED(member, class_name) \
	if (!(member)) { \
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "The " #class_name " object has not been correctly initialized by its constructor"); \
		RETURN_FALSE; \
	}
...
zend_module_entry date_module_entry = {
	...
	JONJ_MINIT(date),            /* process startup */
	JONJ_MSHUTDOWN(date),        /* process shutdown */
	JONJ_RINIT(date),            /* request startup */
	JONJ_RSHUTDOWN(date),        /* request shutdown */
	JONJ_MINFO(date),            /* extension info */
	JONJ_VERSION,                /* extension version */
	JONJ_MODULE_GLOBALS(date),   /* globals descriptor */
	JONJ_GINIT(date),            /* globals ctor */
	NULL,                       /* globals dtor */
...
static void _jonj_date_tzinfo_dtor(void *tzinfo)
{
...
#define DATE_TIMEZONEDB      jonj_date_global_timezone_db ? jonj_date_global_timezone_db : timelib_builtin_db()
 ...
 */
	...
	jonj_date_global_timezone_db = NULL;
	jonj_date_global_timezone_db_enabled = 0;
	DATEG(last_errors) = NULL;
	return SUCCESS;
}
/* }}} */
...
JONJ_MINFO_FUNCTION(date)
{
	...
	jonj_info_print_table_row(2, "date/time support", "enabled");
	jonj_info_print_table_row(2, "\"Olson\" Timezone Database Version", tzdb->version);
	jonj_info_print_table_row(2, "Timezone Database", jonj_date_global_timezone_db_enabled ? "external" : "internal");
	jonj_info_print_table_row(2, "Default timezone", guess_timezone(tzdb TSRMLS_CC));
...
static timelib_tzinfo *jonj_date_parse_tzfile(char *formal_tzname, const timelib_tzdb *tzdb TSRMLS_DC)
{
	timelib_tzinfo *tzi, **ptzi;

	if(!DATEG(tzcache)) {
		ALLOC_HASHTABLE(DATEG(tzcache));
		zend_hash_init(DATEG(tzcache), 4, NULL, _jonj_date_tzinfo_dtor, 0);
	}
...
timelib_tzinfo *jonj_date_parse_tzfile_wrapper(char *formal_tzname, const timelib_tzdb *tzdb)
{
	TSRMLS_FETCH();
	return jonj_date_parse_tzfile(formal_tzname, tzdb TSRMLS_CC);
}
/* }}} */
...
static JONJ_INI_MH(OnUpdate_date_timezone)
{
	...
	if (stage == JONJ_INI_STAGE_RUNTIME) {
		if (!timelib_timezone_id_is_valid(DATEG(default_timezone), DATE_TIMEZONEDB)) {
			jonj_error_docref(NULL TSRMLS_CC, E_WARNING, DATE_TZ_ERRMSG);
		} else {
...
static char* guess_timezone(const timelib_tzdb *tzdb TSRMLS_DC)
{
	...
	if (!DATEG(default_timezone)) {
		...
		if (!timelib_timezone_id_is_valid(DATEG(default_timezone), tzdb)) {
			jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Invalid date.timezone value '%s', we selected the timezone 'UTC' for now.", DATEG(default_timezone));
			return "UTC";
		}
	...
	/* Fallback to UTC */
	jonj_error_docref(NULL TSRMLS_CC, E_WARNING, DATE_TZ_ERRMSG "We selected the timezone 'UTC' for now, but please set date.timezone to select your timezone.");
	return "UTC";
}
...
JONJAPI timelib_tzinfo *get_timezone_info(TSRMLS_D)
{
	...
	tzi = jonj_date_parse_tzfile(tz, DATE_TIMEZONEDB TSRMLS_CC);
	if (! tzi) {
		jonj_error_docref(NULL TSRMLS_CC, E_ERROR, "Timezone database is corrupt - this should *never* happen!");
	}
	return tzi;
}
/* }}} */
...
/* {{{ day of week helpers */
char *jonj_date_full_day_name(timelib_sll y, timelib_sll m, timelib_sll d)
{
...
char *jonj_date_short_day_name(timelib_sll y, timelib_sll m, timelib_sll d)
{
	timelib_sll day_of_week = timelib_day_of_week(y, m, d);
	if (day_of_week < 0) {
		return "Unknown";
...
static char *date_format(char *format, int format_len, timelib_time *t, int localtime)
{
	...
	for (i = 0; i < format_len; i++) {
		...
		switch (format[i]) {
			...
			case 'D': length = slprintf(buffer, 32, "%s", jonj_date_short_day_name(t->y, t->m, t->d)); break;
			case 'j': length = slprintf(buffer, 32, "%d", (int) t->d); break;
			case 'l': length = slprintf(buffer, 32, "%s", jonj_date_full_day_name(t->y, t->m, t->d)); break;
			...
			case 'Y': length = slprintf(buffer, 32, "%s%04lld", t->y < 0 ? "-" : "", jonj_date_llabs((timelib_sll) t->y)); break;
			...
			case 'r': length = slprintf(buffer, 96, "%3s, %02d %3s %04d %02d:%02d:%02d %c%02d%02d",
							                jonj_date_short_day_name(t->y, t->m, t->d),
...
static void jonj_date(INTERNAL_FUNCTION_PARAMETERS, int localtime)
{
	char   *format;
	int     format_len;
	long    ts;
	...
	string = jonj_format_date(format, format_len, ts, localtime TSRMLS_CC);
...
JONJ_FUNCTION(date)
{
	jonj_date(INTERNAL_FUNCTION_PARAM_PASSTHRU, 1);
}
/* }}} */
...
{
	jonj_date(INTERNAL_FUNCTION_PARAM_PASSTHRU, 0);
}
/* }}} */
...
JONJ_FUNCTION(idate)
{
	...
	if (format_len != 1) {
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "idate format is one char");
		RETURN_FALSE;
	}
	...
	ret = jonj_idate(format[0], ts, 0 TSRMLS_CC);
	if (ret == -1) {
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Unrecognized date format token.");
		RETURN_FALSE;
	}
	RETURN_LONG(ret);
}
...
/* {{{ jonj_date_set_tzdb - NOT THREADSAFE */
JONJAPI void jonj_date_set_tzdb(timelib_tzdb *tzdb)
{
	const timelib_tzdb *builtin = timelib_builtin_db();

	if (jonj_version_compare(tzdb->version, builtin->version) > 0) {
		jonj_date_global_timezone_db = tzdb;
		jonj_date_global_timezone_db_enabled = 1;
	}
}
/* }}} */

/* {{{ jonj_parse_date: Backwards compatibility function */
JONJAPI signed long jonj_parse_date(char *string, signed long *now)
{
	...
	parsed_time = timelib_strtotime(string, strlen(string), &error, DATE_TIMEZONEDB, jonj_date_parse_tzfile_wrapper);
...
JONJ_FUNCTION(strtotime)
{
	...
	if (zend_parse_parameters_ex(ZEND_PARSE_PARAMS_QUIET, ZEND_NUM_ARGS() TSRMLS_CC, "sl", &times, &time_len, &preset_ts) != FAILURE) {
		...
		t = timelib_strtotime(initial_ts, strlen(initial_ts), NULL, DATE_TIMEZONEDB, jonj_date_parse_tzfile_wrapper); /* we ignore the error here, as this should never fail */
	...
	t = timelib_strtotime(times, time_len, &error, DATE_TIMEZONEDB, jonj_date_parse_tzfile_wrapper);
...
JONJAPI void jonj_mktime(INTERNAL_FUNCTION_PARAMETERS, int gmt)
{
	...
	switch (ZEND_NUM_ARGS()) {
		...
		case 1:
			...
			break;
		default:
			jonj_error_docref(NULL TSRMLS_CC, E_STRICT, "You should be using the time() function instead");
	}
	...
	if (dst != -1) {
		jonj_error_docref(NULL TSRMLS_CC, E_DEPRECATED, "The is_dst parameter is deprecated");
		if (gmt) {
			/* GMT never uses DST */
			if (dst == 1) {
				adjust_seconds = -3600;
...
{
	jonj_mktime(INTERNAL_FUNCTION_PARAM_PASSTHRU, 0);
}
/* }}} */
...
{
	jonj_mktime(INTERNAL_FUNCTION_PARAM_PASSTHRU, 1);
}
/* }}} */
...
#ifdef HAVE_STRFTIME
/* {{{ jonj_strftime - (gm)strftime helper */
JONJAPI void jonj_strftime(INTERNAL_FUNCTION_PARAMETERS, int gmt)
{
	char                *format, *buf;
	int                  format_len;
	long                 timestamp = 0;
...
#if defined(JONJ_WIN32) && _MSC_VER >= 1700
...
{
	jonj_strftime(INTERNAL_FUNCTION_PARAM_PASSTHRU, 0);
}
/* }}} */
...
{
	jonj_strftime(INTERNAL_FUNCTION_PARAM_PASSTHRU, 1);
}
/* }}} */
#endif
...
JONJ_FUNCTION(getdate)
{
	...
	add_assoc_string(return_value, "weekday", jonj_date_full_day_name(ts->y, ts->m, ts->d), 1);
...
#define JONJ_DATE_TIMEZONE_GROUP_AFRICA     0x0001
#define JONJ_DATE_TIMEZONE_GROUP_AMERICA    0x0002
#define JONJ_DATE_TIMEZONE_GROUP_ANTARCTICA 0x0004
#define JONJ_DATE_TIMEZONE_GROUP_ARCTIC     0x0008
#define JONJ_DATE_TIMEZONE_GROUP_ASIA       0x0010
#define JONJ_DATE_TIMEZONE_GROUP_ATLANTIC   0x0020
#define JONJ_DATE_TIMEZONE_GROUP_AUSTRALIA  0x0040
#define JONJ_DATE_TIMEZONE_GROUP_EUROPE     0x0080
#define JONJ_DATE_TIMEZONE_GROUP_INDIAN     0x0100
#define JONJ_DATE_TIMEZONE_GROUP_PACIFIC    0x0200
#define JONJ_DATE_TIMEZONE_GROUP_UTC        0x0400
#define JONJ_DATE_TIMEZONE_GROUP_ALL        0x07FF
#define JONJ_DATE_TIMEZONE_GROUP_ALL_W_BC   0x0FFF
#define JONJ_DATE_TIMEZONE_PER_COUNTRY      0x1000

#define JONJ_DATE_PERIOD_EXCLUDE_START_DATE 0x0001
...
{
	date_period_it *iterator = (date_period_it *)iter;
	jonj_period_obj *object   = iterator->object;
...
static void date_period_it_current_data(zend_object_iterator *iter, zval ***data TSRMLS_DC)
{
	...
	jonj_period_obj *object   = iterator->object;
	timelib_time   *it_time = object->current;
	jonj_date_obj   *newdateobj;

	/* Create new object */
	MAKE_STD_ZVAL(iterator->current);
	jonj_date_instantiate(object->start_ce, iterator->current TSRMLS_CC);
	newdateobj = (jonj_date_obj *) zend_object_store_get_object(iterator->current TSRMLS_CC);
...
zend_object_iterator *date_object_period_get_iterator(zend_class_entry *ce, zval *object, int by_ref TSRMLS_DC)
{
	...
	jonj_period_obj  *dpobj    = (jonj_period_obj *)zend_object_store_get_object(object TSRMLS_CC);
...
#define REGISTER_TIMEZONE_CLASS_CONST_STRING(const_name, value) \
	...
	REGISTER_TIMEZONE_CLASS_CONST_STRING("AFRICA",      JONJ_DATE_TIMEZONE_GROUP_AFRICA);
	REGISTER_TIMEZONE_CLASS_CONST_STRING("AMERICA",     JONJ_DATE_TIMEZONE_GROUP_AMERICA);
	REGISTER_TIMEZONE_CLASS_CONST_STRING("ANTARCTICA",  JONJ_DATE_TIMEZONE_GROUP_ANTARCTICA);
	REGISTER_TIMEZONE_CLASS_CONST_STRING("ARCTIC",      JONJ_DATE_TIMEZONE_GROUP_ARCTIC);
	REGISTER_TIMEZONE_CLASS_CONST_STRING("ASIA",        JONJ_DATE_TIMEZONE_GROUP_ASIA);
	REGISTER_TIMEZONE_CLASS_CONST_STRING("ATLANTIC",    JONJ_DATE_TIMEZONE_GROUP_ATLANTIC);
	REGISTER_TIMEZONE_CLASS_CONST_STRING("AUSTRALIA",   JONJ_DATE_TIMEZONE_GROUP_AUSTRALIA);
	REGISTER_TIMEZONE_CLASS_CONST_STRING("EUROPE",      JONJ_DATE_TIMEZONE_GROUP_EUROPE);
	REGISTER_TIMEZONE_CLASS_CONST_STRING("INDIAN",      JONJ_DATE_TIMEZONE_GROUP_INDIAN);
	REGISTER_TIMEZONE_CLASS_CONST_STRING("PACIFIC",     JONJ_DATE_TIMEZONE_GROUP_PACIFIC);
	REGISTER_TIMEZONE_CLASS_CONST_STRING("UTC",         JONJ_DATE_TIMEZONE_GROUP_UTC);
	REGISTER_TIMEZONE_CLASS_CONST_STRING("ALL",         JONJ_DATE_TIMEZONE_GROUP_ALL);
	REGISTER_TIMEZONE_CLASS_CONST_STRING("ALL_WITH_BC", JONJ_DATE_TIMEZONE_GROUP_ALL_W_BC);
	REGISTER_TIMEZONE_CLASS_CONST_STRING("PER_COUNTRY", JONJ_DATE_TIMEZONE_PER_COUNTRY);
...
#define REGISTER_PERIOD_CLASS_CONST_STRING(const_name, value) \
	...
	REGISTER_PERIOD_CLASS_CONST_STRING("EXCLUDE_START_DATE", JONJ_DATE_PERIOD_EXCLUDE_START_DATE);
}

static inline zend_object_value date_object_new_date_ex(zend_class_entry *class_type, jonj_date_obj **ptr TSRMLS_DC)
{
	jonj_date_obj *intern;
	zend_object_value retval;

	intern = emalloc(sizeof(jonj_date_obj));
	memset(intern, 0, sizeof(jonj_date_obj));
	if (ptr) {
		*ptr = intern;
	}
...
static zend_object_value date_object_clone_date(zval *this_ptr TSRMLS_DC)
{
	jonj_date_obj *new_obj = NULL;
	jonj_date_obj *old_obj = (jonj_date_obj *) zend_object_store_get_object(this_ptr TSRMLS_CC);
...
static int date_object_compare_date(zval *d1, zval *d2 TSRMLS_DC)
{
	jonj_date_obj *o1 = zend_object_store_get_object(d1 TSRMLS_CC);
	jonj_date_obj *o2 = zend_object_store_get_object(d2 TSRMLS_CC);

	if (!o1->time || !o2->time) {
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Trying to compare an incomplete DateTime or DateTimeImmutable object");
		return 1;
	}
...
static HashTable *date_object_get_properties(zval *object TSRMLS_DC)
{
	HashTable *props;
	zval *zv;
	jonj_date_obj     *dateobj;


	dateobj = (jonj_date_obj *) zend_object_store_get_object(object TSRMLS_CC);
...
static inline zend_object_value date_object_new_timezone_ex(zend_class_entry *class_type, jonj_timezone_obj **ptr TSRMLS_DC)
{
	jonj_timezone_obj *intern;
	zend_object_value retval;

	intern = emalloc(sizeof(jonj_timezone_obj));
	memset(intern, 0, sizeof(jonj_timezone_obj));
	if (ptr) {
		*ptr = intern;
	}
...
static zend_object_value date_object_clone_timezone(zval *this_ptr TSRMLS_DC)
{
	jonj_timezone_obj *new_obj = NULL;
	jonj_timezone_obj *old_obj = (jonj_timezone_obj *) zend_object_store_get_object(this_ptr TSRMLS_CC);
...
static HashTable *date_object_get_properties_timezone(zval *object TSRMLS_DC)
{
	HashTable *props;
	zval *zv;
	jonj_timezone_obj     *tzobj;


	tzobj = (jonj_timezone_obj *) zend_object_store_get_object(object TSRMLS_CC);
...
static inline zend_object_value date_object_new_interval_ex(zend_class_entry *class_type, jonj_interval_obj **ptr TSRMLS_DC)
{
	jonj_interval_obj *intern;
	zend_object_value retval;

	intern = emalloc(sizeof(jonj_interval_obj));
	memset(intern, 0, sizeof(jonj_interval_obj));
	if (ptr) {
		*ptr = intern;
	}
...
static zend_object_value date_object_clone_interval(zval *this_ptr TSRMLS_DC)
{
	jonj_interval_obj *new_obj = NULL;
	jonj_interval_obj *old_obj = (jonj_interval_obj *) zend_object_store_get_object(this_ptr TSRMLS_CC);
...
static HashTable *date_object_get_properties_interval(zval *object TSRMLS_DC)
{
	HashTable *props;
	zval *zv;
	jonj_interval_obj     *intervalobj;

	intervalobj = (jonj_interval_obj *) zend_object_store_get_object(object TSRMLS_CC);
...
#define JONJ_DATE_INTERVAL_ADD_PROPERTY(n,f) \
	MAKE_STD_ZVAL(zv); \
	ZVAL_LONG(zv, (long)intervalobj->diff->f); \
	zend_hash_update(props, n, strlen(n) + 1, &zv, sizeof(zv), NULL);

	JONJ_DATE_INTERVAL_ADD_PROPERTY("y", y);
	JONJ_DATE_INTERVAL_ADD_PROPERTY("m", m);
	JONJ_DATE_INTERVAL_ADD_PROPERTY("d", d);
	JONJ_DATE_INTERVAL_ADD_PROPERTY("h", h);
	JONJ_DATE_INTERVAL_ADD_PROPERTY("i", i);
	JONJ_DATE_INTERVAL_ADD_PROPERTY("s", s);
	JONJ_DATE_INTERVAL_ADD_PROPERTY("weekday", weekday);
	JONJ_DATE_INTERVAL_ADD_PROPERTY("weekday_behavior", weekday_behavior);
	JONJ_DATE_INTERVAL_ADD_PROPERTY("first_last_day_of", first_last_day_of);
	JONJ_DATE_INTERVAL_ADD_PROPERTY("invert", invert);
	if (intervalobj->diff->days != -99999) {
		JONJ_DATE_INTERVAL_ADD_PROPERTY("days", days);
	} else {
		MAKE_STD_ZVAL(zv);
		ZVAL_FALSE(zv);
		zend_hash_update(props, "days", 5, &zv, sizeof(zv), NULL);
	}
	JONJ_DATE_INTERVAL_ADD_PROPERTY("special_type", special.type);
	JONJ_DATE_INTERVAL_ADD_PROPERTY("special_amount", special.amount);
	JONJ_DATE_INTERVAL_ADD_PROPERTY("have_weekday_relative", have_weekday_relative);
	JONJ_DATE_INTERVAL_ADD_PROPERTY("have_special_relative", have_special_relative);

	return props;
}

static inline zend_object_value date_object_new_period_ex(zend_class_entry *class_type, jonj_period_obj **ptr TSRMLS_DC)
{
	jonj_period_obj *intern;
	zend_object_value retval;

	intern = emalloc(sizeof(jonj_period_obj));
	memset(intern, 0, sizeof(jonj_period_obj));
	if (ptr) {
		*ptr = intern;
	}
...
static zend_object_value date_object_clone_period(zval *this_ptr TSRMLS_DC)
{
	jonj_period_obj *new_obj = NULL;
	jonj_period_obj *old_obj = (jonj_period_obj *) zend_object_store_get_object(this_ptr TSRMLS_CC);
...
static void date_object_free_storage_date(void *object TSRMLS_DC)
{
	jonj_date_obj *intern = (jonj_date_obj *)object;
...
static void date_object_free_storage_timezone(void *object TSRMLS_DC)
{
	jonj_timezone_obj *intern = (jonj_timezone_obj *)object;
...
static void date_object_free_storage_interval(void *object TSRMLS_DC)
{
	jonj_interval_obj *intern = (jonj_interval_obj *)object;
...
static void date_object_free_storage_period(void *object TSRMLS_DC)
{
	jonj_period_obj *intern = (jonj_period_obj *)object;
...
JONJAPI int jonj_date_initialize(jonj_date_obj *dateobj, /*const*/ char *time_str, int time_str_len, char *format, zval *timezone_object, int ctor TSRMLS_DC)
{
	...
	if (format) {
		dateobj->time = timelib_parse_from_format(format, time_str_len ? time_str : "", time_str_len ? time_str_len : 0, &err, DATE_TIMEZONEDB, jonj_date_parse_tzfile_wrapper);
	} else {
		dateobj->time = timelib_strtotime(time_str_len ? time_str : "now", time_str_len ? time_str_len : sizeof("now") -1, &err, DATE_TIMEZONEDB, jonj_date_parse_tzfile_wrapper);
	}
	...
	if (ctor && err && err->error_count) {
		...
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Failed to parse time string (%s) at position %d (%c): %s", time_str,
	...
	if (timezone_object) {
		...
		tzobj = (jonj_timezone_obj *) zend_object_store_get_object(timezone_object TSRMLS_CC);
		switch (tzobj->type) {
			case TIMELIB_ZONETYPE_ID:
				tzi = tzobj->tzi.tz;
				break;
...
JONJ_FUNCTION(date_create)
{
	...
	jonj_date_instantiate(date_ce_date, &datetime_object TSRMLS_CC);
	if (!jonj_date_initialize(zend_object_store_get_object(&datetime_object TSRMLS_CC), time_str, time_str_len, NULL, timezone_object, 0 TSRMLS_CC)) {
...
JONJ_FUNCTION(date_create_immutable)
{
	...
	jonj_date_instantiate(date_ce_immutable, &datetime_object TSRMLS_CC);
	if (!jonj_date_initialize(zend_object_store_get_object(&datetime_object TSRMLS_CC), time_str, time_str_len, NULL, timezone_object, 0 TSRMLS_CC)) {
		zval_dtor(&datetime_object);
		RETURN_FALSE;
	}
...
JONJ_FUNCTION(date_create_from_format)
{
	...
	jonj_date_instantiate(date_ce_date, &datetime_object TSRMLS_CC);
	if (!jonj_date_initialize(zend_object_store_get_object(&datetime_object TSRMLS_CC), time_str, time_str_len, format_str, timezone_object, 0 TSRMLS_CC)) {
		zval_dtor(&datetime_object);
		RETURN_FALSE;
	}
	RETVAL_ZVAL(&datetime_object, 0, 0);
...
JONJ_METHOD(DateTime, __construct)
{
	...
	if (SUCCESS == zend_parse_parameters(ZEND_NUM_ARGS() TSRMLS_CC, "|sO!", &time_str, &time_str_len, &timezone_object, date_ce_timezone)) {
		jonj_date_initialize(zend_object_store_get_object(getThis() TSRMLS_CC), time_str, time_str_len, NULL, timezone_object, 1 TSRMLS_CC);
	}
...
JONJ_METHOD(DateTimeImmutable, createFromMutable)
{
	...
	jonj_date_obj *new_obj = NULL;
	jonj_date_obj *old_obj = NULL;

	if (zend_parse_parameters(ZEND_NUM_ARGS() TSRMLS_CC, "O", &datetime_object, date_ce_date) == FAILURE) {
		return;
	}

	jonj_date_instantiate(date_ce_immutable, return_value TSRMLS_CC);
	old_obj = (jonj_date_obj *) zend_object_store_get_object(datetime_object TSRMLS_CC);
	new_obj = (jonj_date_obj *) zend_object_store_get_object(return_value TSRMLS_CC);
...
static int jonj_date_initialize_from_hash(jonj_date_obj **dateobj, HashTable *myht TSRMLS_DC)
{
	zval            **z_date = NULL;
			...
			if (zend_hash_find(myht, "timezone", 9, (void**) &z_timezone) == SUCCESS && Z_TYPE_PP(z_timezone) == IS_STRING) {
				...
				switch (Z_LVAL_PP(z_timezone_type)) {
					...
					case TIMELIB_ZONETYPE_ABBR: {
						...
						ret = jonj_date_initialize(*dateobj, tmp, Z_STRLEN_PP(z_date) + Z_STRLEN_PP(z_timezone) + 1, NULL, NULL, 0 TSRMLS_CC);
						efree(tmp);
						return 1 == ret;
					}
					...
					case TIMELIB_ZONETYPE_ID: {
						...
						tzi = jonj_date_parse_tzfile(Z_STRVAL_PP(z_timezone), DATE_TIMEZONEDB TSRMLS_CC);
						...
						tzobj = zend_object_store_get_object(jonj_date_instantiate(date_ce_timezone, tmp_obj TSRMLS_CC) TSRMLS_CC);
						tzobj->type = TIMELIB_ZONETYPE_ID;
						tzobj->tzi.tz = tzi;
						tzobj->initialized = 1;

						ret = jonj_date_initialize(*dateobj, Z_STRVAL_PP(z_date), Z_STRLEN_PP(z_date), NULL, tmp_obj, 0 TSRMLS_CC);
...
JONJ_METHOD(DateTime, __set_state)
{
	...
	jonj_date_instantiate(date_ce_date, return_value TSRMLS_CC);
	dateobj = (jonj_date_obj *) zend_object_store_get_object(return_value TSRMLS_CC);
	if (!jonj_date_initialize_from_hash(&dateobj, myht TSRMLS_CC)) {
		jonj_error(E_ERROR, "Invalid serialization data for DateTime object");
	}
}
/* }}} */
...
JONJ_METHOD(DateTimeImmutable, __set_state)
{
	...
	dateobj = (jonj_date_obj *) zend_object_store_get_object(return_value TSRMLS_CC);
	if (!jonj_date_initialize_from_hash(&dateobj, myht TSRMLS_CC)) {
		jonj_error(E_ERROR, "Invalid serialization data for DateTimeImmutable object");
	}
}
/* }}} */
...
void jonj_date_do_return_parsed_time(INTERNAL_FUNCTION_PARAMETERS, timelib_time *parsed_time, struct timelib_error_container *error)
{
	zval *element;

	array_init(return_value);
#define JONJ_DATE_PARSE_DATE_SET_TIME_ELEMENT(name, elem) \
	if (parsed_time->elem == -99999) {               \
		add_assoc_bool(return_value, #name, 0); \
	} else {                                       \
		add_assoc_long(return_value, #name, parsed_time->elem); \
	}
	JONJ_DATE_PARSE_DATE_SET_TIME_ELEMENT(year,      y);
	JONJ_DATE_PARSE_DATE_SET_TIME_ELEMENT(month,     m);
	JONJ_DATE_PARSE_DATE_SET_TIME_ELEMENT(day,       d);
	JONJ_DATE_PARSE_DATE_SET_TIME_ELEMENT(hour,      h);
	JONJ_DATE_PARSE_DATE_SET_TIME_ELEMENT(minute,    i);
	JONJ_DATE_PARSE_DATE_SET_TIME_ELEMENT(second,    s);
	...
	if (parsed_time->is_localtime) {
		JONJ_DATE_PARSE_DATE_SET_TIME_ELEMENT(zone_type, zone_type);
		switch (parsed_time->zone_type) {
			case TIMELIB_ZONETYPE_OFFSET:
				JONJ_DATE_PARSE_DATE_SET_TIME_ELEMENT(zone, z);
...
JONJ_FUNCTION(date_parse)
{
	...
	parsed_time = timelib_strtotime(date, date_len, &error, DATE_TIMEZONEDB, jonj_date_parse_tzfile_wrapper);
	jonj_date_do_return_parsed_time(INTERNAL_FUNCTION_PARAM_PASSTHRU, parsed_time, error);
}
/* }}} */
...
JONJ_FUNCTION(date_parse_from_format)
{
	...
	parsed_time = timelib_parse_from_format(format, date, date_len, &error, DATE_TIMEZONEDB, jonj_date_parse_tzfile_wrapper);
	jonj_date_do_return_parsed_time(INTERNAL_FUNCTION_PARAM_PASSTHRU, parsed_time, error);
}
/* }}} */
...
static int jonj_date_modify(zval *object, char *modify, int modify_len TSRMLS_DC)
{
	jonj_date_obj *dateobj;
	...
	if (!(dateobj->time)) {
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "The DateTime object has not been correctly initialized by its constructor");
		return 0;
	}

	tmp_time = timelib_strtotime(modify, modify_len, &err, DATE_TIMEZONEDB, jonj_date_parse_tzfile_wrapper);

	/* update last errors and warnings */
	update_errors_warnings(err TSRMLS_CC);
	if (err && err->error_count) {
		/* spit out the first library error message, at least */
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Failed to parse time string (%s) at position %d (%c): %s", modify,
			err->error_messages[0].position, err->error_messages[0].character, err->error_messages[0].message);
...
JONJ_FUNCTION(date_modify)
{
	...
	if (jonj_date_modify(object, modify, modify_len TSRMLS_CC)) {
...
JONJ_METHOD(DateTimeImmutable, modify)
{
	...
	if (jonj_date_modify(new_object, modify, modify_len TSRMLS_CC)) {
...
static void jonj_date_add(zval *object, zval *interval, zval *return_value TSRMLS_DC)
{
	jonj_date_obj     *dateobj;
	jonj_interval_obj *intobj;
	timelib_time     *new_time;

	dateobj = (jonj_date_obj *) zend_object_store_get_object(object TSRMLS_CC);
	DATE_CHECK_INITIALIZED(dateobj->time, DateTime);
	intobj = (jonj_interval_obj *) zend_object_store_get_object(interval TSRMLS_CC);
...
JONJ_FUNCTION(date_add)
{
	...
	jonj_date_add(object, interval, return_value TSRMLS_CC);
...
JONJ_METHOD(DateTimeImmutable, add)
{
	...
	new_object = date_clone_immutable(object TSRMLS_CC);
	jonj_date_add(new_object, interval, return_value TSRMLS_CC);

	RETURN_ZVAL(new_object, 0, 1);
}
/* }}} */

static void jonj_date_sub(zval *object, zval *interval, zval *return_value TSRMLS_DC)
{
	jonj_date_obj     *dateobj;
	jonj_interval_obj *intobj;
	timelib_time     *new_time;
	...
	if (intobj->diff->have_special_relative) {
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Only non-special relative time specifications are supported for subtraction");
		return;
	}
...
JONJ_FUNCTION(date_sub)
{
	...
	jonj_date_sub(object, interval, return_value TSRMLS_CC);
...
JONJ_METHOD(DateTimeImmutable, sub)
{
	...
	new_object = date_clone_immutable(object TSRMLS_CC);
	jonj_date_sub(new_object, interval, return_value TSRMLS_CC);

	RETURN_ZVAL(new_object, 0, 1);
}
/* }}} */

static void set_timezone_from_timelib_time(jonj_timezone_obj *tzobj, timelib_time *t)
{
       tzobj->initialized = 1;
...
JONJ_FUNCTION(date_timezone_get)
{
	...
	if (dateobj->time->is_localtime/* && dateobj->time->tz_info*/) {
		jonj_date_instantiate(date_ce_timezone, return_value TSRMLS_CC);
		tzobj = (jonj_timezone_obj *) zend_object_store_get_object(return_value TSRMLS_CC);
...
static void jonj_date_timezone_set(zval *object, zval *timezone_object, zval *return_value TSRMLS_DC)
{
	jonj_date_obj     *dateobj;
	jonj_timezone_obj *tzobj;
...
JONJ_FUNCTION(date_timezone_set)
{
	...
	jonj_date_timezone_set(object, timezone_object, return_value TSRMLS_CC);
...
JONJ_METHOD(DateTimeImmutable, setTimezone)
{
	...
	new_object = date_clone_immutable(object TSRMLS_CC);
	jonj_date_timezone_set(new_object, timezone_object, return_value TSRMLS_CC);
...
static void jonj_date_time_set(zval *object, long h, long i, long s, zval *return_value TSRMLS_DC)
{
	jonj_date_obj *dateobj;
...
JONJ_FUNCTION(date_time_set)
{
	...
	jonj_date_time_set(object, h, i, s, return_value TSRMLS_CC);
...
JONJ_METHOD(DateTimeImmutable, setTime)
{
	...
	new_object = date_clone_immutable(object TSRMLS_CC);
	jonj_date_time_set(new_object, h, i, s, return_value TSRMLS_CC);

	RETURN_ZVAL(new_object, 0, 1);
}
/* }}} */

static void jonj_date_date_set(zval *object, long y, long m, long d, zval *return_value TSRMLS_DC)
{
	jonj_date_obj *dateobj;
...
JONJ_FUNCTION(date_date_set)
{
	...
	jonj_date_date_set(object, y, m, d, return_value TSRMLS_CC);
...
JONJ_METHOD(DateTimeImmutable, setDate)
{
	...
	new_object = date_clone_immutable(object TSRMLS_CC);
	jonj_date_date_set(new_object, y, m, d, return_value TSRMLS_CC);

	RETURN_ZVAL(new_object, 0, 1);
}
/* }}} */

static void jonj_date_isodate_set(zval *object, long y, long w, long d, zval *return_value TSRMLS_DC)
{
	jonj_date_obj *dateobj;
...
JONJ_FUNCTION(date_isodate_set)
{
	...
	jonj_date_isodate_set(object, y, w, d, return_value TSRMLS_CC);
...
JONJ_METHOD(DateTimeImmutable, setISODate)
{
	...
	new_object = date_clone_immutable(object TSRMLS_CC);
	jonj_date_isodate_set(new_object, y, w, d, return_value TSRMLS_CC);

	RETURN_ZVAL(new_object, 0, 1);
}
/* }}} */

static void jonj_date_timestamp_set(zval *object, long timestamp, zval *return_value TSRMLS_DC)
{
	jonj_date_obj *dateobj;
...
JONJ_FUNCTION(date_timestamp_set)
{
	...
	jonj_date_timestamp_set(object, timestamp, return_value TSRMLS_CC);
...
JONJ_METHOD(DateTimeImmutable, setTimestamp)
{
	...
	new_object = date_clone_immutable(object TSRMLS_CC);
	jonj_date_timestamp_set(new_object, timestamp, return_value TSRMLS_CC);
...
JONJ_FUNCTION(date_diff)
{
	...
	jonj_date_obj *dateobj1, *dateobj2;
	jonj_interval_obj *interval;
	long          absolute = 0;
	...
	dateobj1 = (jonj_date_obj *) zend_object_store_get_object(object1 TSRMLS_CC);
	dateobj2 = (jonj_date_obj *) zend_object_store_get_object(object2 TSRMLS_CC);
	...
	jonj_date_instantiate(date_ce_interval, return_value TSRMLS_CC);
...
static int timezone_initialize(jonj_timezone_obj *tzobj, /*const*/ char *tz, size_t tz_len TSRMLS_DC)
{
	...
	if (strlen(tz) != tz_len) {
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Timezone must not contain null bytes");
		return FAILURE;
	}

	dummy_t->z = timelib_parse_zone(&tz, &dst, dummy_t, &not_found, DATE_TIMEZONEDB, jonj_date_parse_tzfile_wrapper);
	if (not_found) {
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Unknown or bad timezone (%s)", orig_tz);
		efree(dummy_t);
		return FAILURE;
	} else {
...
JONJ_FUNCTION(timezone_open)
{
	...
	tzobj = zend_object_store_get_object(jonj_date_instantiate(date_ce_timezone, return_value TSRMLS_CC) TSRMLS_CC);
...
static int jonj_date_timezone_initialize_from_hash(zval **return_value, jonj_timezone_obj **tzobj, HashTable *myht TSRMLS_DC)
{
	zval            **z_timezone = NULL;
	zval            **z_timezone_type = NULL;
...
JONJ_METHOD(DateTimeZone, __set_state)
{
	...
	jonj_date_instantiate(date_ce_timezone, return_value TSRMLS_CC);
	tzobj = (jonj_timezone_obj *) zend_object_store_get_object(return_value TSRMLS_CC);
	if(jonj_date_timezone_initialize_from_hash(&return_value, &tzobj, myht TSRMLS_CC) != SUCCESS) {
		jonj_error_docref(NULL TSRMLS_CC, E_ERROR, "Timezone initialization failed");
	}
}
/* }}} */
...
JONJ_FUNCTION(timezone_offset_get)
{
	...
	tzobj = (jonj_timezone_obj *) zend_object_store_get_object(object TSRMLS_CC);
	DATE_CHECK_INITIALIZED(tzobj->initialized, DateTimeZone);
	dateobj = (jonj_date_obj *) zend_object_store_get_object(dateobject TSRMLS_CC);
...
#define add_nominal() \
		...
		add_assoc_string(element, "time", jonj_format_date(DATE_FORMAT_ISO8601, 13, timestamp_begin, 0 TSRMLS_CC), 0); \
...
#define add(i,ts) \
		...
		add_assoc_string(element, "time", jonj_format_date(DATE_FORMAT_ISO8601, 13, ts, 0 TSRMLS_CC), 0); \
...
static int date_interval_initialize(timelib_rel_time **rt, /*const*/ char *format, int format_length TSRMLS_DC)
{
	...
	if (errors->error_count > 0) {
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Unknown or bad format (%s)", format);
		retval = FAILURE;
	} else {
		if(p) {
			*rt = p;
			...
			if(b && e) {
				...
				*rt = timelib_diff(b, e);
				...
				jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Failed to parse interval (%s)", format);
				retval = FAILURE;
			}
		}
	}
...
zval *date_interval_read_property(zval *object, zval *member, int type, const zend_literal *key TSRMLS_DC)
{
	...
	obj = (jonj_interval_obj *)zend_objects_get_address(object TSRMLS_CC);
...
static int jonj_date_interval_initialize_from_hash(zval **return_value, jonj_interval_obj **intobj, HashTable *myht TSRMLS_DC)
{
	(*intobj)->diff = timelib_rel_time_ctor();

#define JONJ_DATE_INTERVAL_READ_PROPERTY(element, member, itype, def) \
	do { \
		zval **z_arg = NULL; \
...
#define JONJ_DATE_INTERVAL_READ_PROPERTY_I64(element, member) \
	do { \
		zval **z_arg = NULL; \
	...
	JONJ_DATE_INTERVAL_READ_PROPERTY("y", y, timelib_sll, -1)
	JONJ_DATE_INTERVAL_READ_PROPERTY("m", m, timelib_sll, -1)
	JONJ_DATE_INTERVAL_READ_PROPERTY("d", d, timelib_sll, -1)
	JONJ_DATE_INTERVAL_READ_PROPERTY("h", h, timelib_sll, -1)
	JONJ_DATE_INTERVAL_READ_PROPERTY("i", i, timelib_sll, -1)
	JONJ_DATE_INTERVAL_READ_PROPERTY("s", s, timelib_sll, -1)
	JONJ_DATE_INTERVAL_READ_PROPERTY("weekday", weekday, int, -1)
	JONJ_DATE_INTERVAL_READ_PROPERTY("weekday_behavior", weekday_behavior, int, -1)
	JONJ_DATE_INTERVAL_READ_PROPERTY("first_last_day_of", first_last_day_of, int, -1)
	JONJ_DATE_INTERVAL_READ_PROPERTY("invert", invert, int, 0);
	JONJ_DATE_INTERVAL_READ_PROPERTY_I64("days", days);
	JONJ_DATE_INTERVAL_READ_PROPERTY("special_type", special.type, unsigned int, 0);
	JONJ_DATE_INTERVAL_READ_PROPERTY_I64("special_amount", special.amount);
	JONJ_DATE_INTERVAL_READ_PROPERTY("have_weekday_relative", have_weekday_relative, unsigned int, 0);
	JONJ_DATE_INTERVAL_READ_PROPERTY("have_special_relative", have_special_relative, unsigned int, 0);
...
JONJ_METHOD(DateInterval, __set_state)
{
	...
	jonj_date_instantiate(date_ce_interval, return_value TSRMLS_CC);
	intobj = (jonj_interval_obj *) zend_object_store_get_object(return_value TSRMLS_CC);
	jonj_date_interval_initialize_from_hash(&return_value, &intobj, myht TSRMLS_CC);
}
/* }}} */
...
JONJ_METHOD(DateInterval, __wakeup)
{
	...
	intobj = (jonj_interval_obj *) zend_object_store_get_object(object TSRMLS_CC);
...
JONJ_FUNCTION(date_interval_create_from_date_string)
{
	...
	time = timelib_strtotime(time_str, time_str_len, &err, DATE_TIMEZONEDB, jonj_date_parse_tzfile_wrapper);
	diobj = (jonj_interval_obj *) zend_object_store_get_object(return_value TSRMLS_CC);
...
JONJ_FUNCTION(date_interval_format)
{
	...
	diobj = (jonj_interval_obj *) zend_object_store_get_object(object TSRMLS_CC);
...
JONJ_METHOD(DatePeriod, __construct)
{
	...
	if (zend_parse_parameters_ex(ZEND_PARSE_PARAMS_QUIET, ZEND_NUM_ARGS() TSRMLS_CC, "OOl|l", &start, date_ce_interface, &interval, date_ce_interval, &recurrences, &options) == FAILURE) {
		if (zend_parse_parameters_ex(ZEND_PARSE_PARAMS_QUIET, ZEND_NUM_ARGS() TSRMLS_CC, "OOO|l", &start, date_ce_interface, &interval, date_ce_interval, &end, date_ce_interface, &options) == FAILURE) {
			if (zend_parse_parameters_ex(ZEND_PARSE_PARAMS_QUIET, ZEND_NUM_ARGS() TSRMLS_CC, "s|l", &isostr, &isostr_len, &options) == FAILURE) {
				jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "This constructor accepts either (DateTimeInterface, DateInterval, int) OR (DateTimeInterface, DateInterval, DateTime) OR (string) as arguments.");
				zend_restore_error_handling(&error_handling TSRMLS_CC);
				return;
			}
		}
	...
	if (isostr) {
		...
		if (dpobj->start == NULL) {
			jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "The ISO interval '%s' did not contain a start date.", isostr);
		}
		if (dpobj->interval == NULL) {
			jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "The ISO interval '%s' did not contain an interval.", isostr);
		}
		if (dpobj->end == NULL && recurrences == 0) {
			jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "The ISO interval '%s' did not contain an end date or a recurrence count.", isostr);
		}
		...
		/* start date */
		dateobj = (jonj_date_obj *) zend_object_store_get_object(start TSRMLS_CC);
		...
		/* end date */
		if (end) {
			dateobj = (jonj_date_obj *) zend_object_store_get_object(end TSRMLS_CC);
	...
	/* options */
	dpobj->include_start_date = !(options & JONJ_DATE_PERIOD_EXCLUDE_START_DATE);
...
JONJ_METHOD(DatePeriod, getStartDate)
{
	...
	dpobj = (jonj_period_obj *)zend_object_store_get_object(getThis() TSRMLS_CC);

	jonj_date_instantiate(dpobj->start_ce, return_value TSRMLS_CC);
	dateobj = (jonj_date_obj *)zend_object_store_get_object(return_value TSRMLS_CC);
...
{
	if (what & JONJ_DATE_TIMEZONE_GROUP_AFRICA     && strncasecmp(id, "Africa/",      7) == 0) return 1;
	if (what & JONJ_DATE_TIMEZONE_GROUP_AMERICA    && strncasecmp(id, "America/",     8) == 0) return 1;
	if (what & JONJ_DATE_TIMEZONE_GROUP_ANTARCTICA && strncasecmp(id, "Antarctica/", 11) == 0) return 1;
	if (what & JONJ_DATE_TIMEZONE_GROUP_ARCTIC     && strncasecmp(id, "Arctic/",      7) == 0) return 1;
	if (what & JONJ_DATE_TIMEZONE_GROUP_ASIA       && strncasecmp(id, "Asia/",        5) == 0) return 1;
	if (what & JONJ_DATE_TIMEZONE_GROUP_ATLANTIC   && strncasecmp(id, "Atlantic/",    9) == 0) return 1;
	if (what & JONJ_DATE_TIMEZONE_GROUP_AUSTRALIA  && strncasecmp(id, "Australia/",  10) == 0) return 1;
	if (what & JONJ_DATE_TIMEZONE_GROUP_EUROPE     && strncasecmp(id, "Europe/",      7) == 0) return 1;
	if (what & JONJ_DATE_TIMEZONE_GROUP_INDIAN     && strncasecmp(id, "Indian/",      7) == 0) return 1;
	if (what & JONJ_DATE_TIMEZONE_GROUP_PACIFIC    && strncasecmp(id, "Pacific/",     8) == 0) return 1;
	if (what & JONJ_DATE_TIMEZONE_GROUP_UTC        && strncasecmp(id, "UTC",          3) == 0) return 1;
	return 0;
}
...
JONJ_FUNCTION(timezone_identifiers_list)
{
	...
	int                             i, item_count;
	long                            what = JONJ_DATE_TIMEZONE_GROUP_ALL;
	char                           *option = NULL;
	int                             option_len = 0;
	...
	/* Extra validation */
	if (what == JONJ_DATE_TIMEZONE_PER_COUNTRY && option_len != 2) {
		jonj_error_docref(NULL TSRMLS_CC, E_NOTICE, "A two-letter ISO 3166-1 compatible country code is expected");
		RETURN_FALSE;
	}
	...
	for (i = 0; i < item_count; ++i) {
		if (what == JONJ_DATE_TIMEZONE_PER_COUNTRY) {
			if (tzdb->data[table[i].pos + 5] == option[0] && tzdb->data[table[i].pos + 6] == option[1]) {
				add_next_index_string(return_value, table[i].id, 1);
			}
		} else if (what == JONJ_DATE_TIMEZONE_GROUP_ALL_W_BC || (check_id_allowed(table[i].id, what) && (tzdb->data[table[i].pos + 4] == '\1'))) {
			add_next_index_string(return_value, table[i].id, 1);
		}
	};
}
...
JONJ_FUNCTION(date_default_timezone_set)
{
	...
	if (!timelib_timezone_id_is_valid(zone, DATE_TIMEZONEDB)) {
		jonj_error_docref(NULL TSRMLS_CC, E_NOTICE, "Timezone ID '%s' is invalid", zone);
		RETURN_FALSE;
	}
	if (DATEG(timezone)) {
		efree(DATEG(timezone));
...
/* {{{ jonj_do_date_sunrise_sunset
 *  Common for date_sunrise() and date_sunset() functions
 */
static void jonj_do_date_sunrise_sunset(INTERNAL_FUNCTION_PARAMETERS, int calc_sunset)
{
	...
	switch (ZEND_NUM_ARGS()) {
		...
		case 6:
			break;
		default:
			jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "invalid format");
			RETURN_FALSE;
			break;
	}
	...
	{
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Wrong return format given, pick one of SUNFUNCS_RET_TIMESTAMP, SUNFUNCS_RET_STRING or SUNFUNCS_RET_DOUBLE");
		RETURN_FALSE;
	}
	altitude = 90 - zenith;
...
{
	jonj_do_date_sunrise_sunset(INTERNAL_FUNCTION_PARAM_PASSTHRU, 0);
}
/* }}} */
...
{
	jonj_do_date_sunrise_sunset(INTERNAL_FUNCTION_PARAM_PASSTHRU, 1);
}
/* }}} */
...
static HashTable *date_object_get_properties_period(zval *object TSRMLS_DC)
{
	...
	if (period_obj->interval) {
		jonj_interval_obj *interval_obj;
...
static int jonj_date_period_initialize_from_hash(jonj_period_obj *period_obj, HashTable *myht TSRMLS_DC)
{
	zval **ht_entry;
...
JONJ_METHOD(DatePeriod, __set_state)
{
	...
	if (!jonj_date_period_initialize_from_hash(period_obj, myht TSRMLS_CC)) {
		jonj_error(E_ERROR, "Invalid serialization data for DatePeriod object");
	}
}
/* }}} */
...
static zval *date_period_read_property(zval *object, zval *member, int type, const zend_literal *key TSRMLS_DC)
{
	...
	if (type != BP_VAR_IS && type != BP_VAR_R) {
		jonj_error_docref(NULL TSRMLS_CC, E_ERROR, "Retrieval of DatePeriod properties for modification is unsupported");
	}
...
static void date_period_write_property(zval *object, zval *member, zval *value, const zend_literal *key TSRMLS_DC)
{
	jonj_error_docref(NULL TSRMLS_CC, E_ERROR, "Writing to DatePeriod properties is unsupported");
}
/* }}} */
