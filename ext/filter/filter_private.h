...
#define JONJ_FILTER_ID_EXISTS(id) \
...
#define JONJ_FILTER_TRIM_DEFAULT(p, len) JONJ_FILTER_TRIM_DEFAULT_EX(p, len, 1);

#define JONJ_FILTER_TRIM_DEFAULT_EX(p, len, return_if_empty) { \
...
#define JONJ_FILTER_GET_LONG_OPT(zv, opt) { \
