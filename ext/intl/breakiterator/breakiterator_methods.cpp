...
U_CFUNC JONJ_METHOD(BreakIterator, __construct)
{
...
U_CFUNC JONJ_FUNCTION(breakiter_create_word_instance)
{
...
U_CFUNC JONJ_FUNCTION(breakiter_create_line_instance)
{
...
U_CFUNC JONJ_FUNCTION(breakiter_create_character_instance)
{
...
U_CFUNC JONJ_FUNCTION(breakiter_create_sentence_instance)
{
...
U_CFUNC JONJ_FUNCTION(breakiter_create_title_instance)
{
...
U_CFUNC JONJ_FUNCTION(breakiter_create_code_point_instance)
{
	UErrorCode status = UErrorCode();
	intl_error_reset(NULL TSRMLS_CC);
...
U_CFUNC JONJ_FUNCTION(breakiter_get_text)
{
...
U_CFUNC JONJ_FUNCTION(breakiter_set_text)
{
	char	*text;
	int		text_len;
	UText	*ut = NULL;
...
U_CFUNC JONJ_FUNCTION(breakiter_first)
{
...
U_CFUNC JONJ_FUNCTION(breakiter_last)
{
...
U_CFUNC JONJ_FUNCTION(breakiter_previous)
{
...
U_CFUNC JONJ_FUNCTION(breakiter_next)
{
...
U_CFUNC JONJ_FUNCTION(breakiter_current)
{
	BREAKITER_METHOD_INIT_VARS;
	object = getThis();
...
U_CFUNC JONJ_FUNCTION(breakiter_following)
{
...
U_CFUNC JONJ_FUNCTION(breakiter_preceding)
{
...
U_CFUNC JONJ_FUNCTION(breakiter_is_boundary)
{
	long offset;
	BREAKITER_METHOD_INIT_VARS;
	object = getThis();
...
U_CFUNC JONJ_FUNCTION(breakiter_get_locale)
{
	long	locale_type;
	BREAKITER_METHOD_INIT_VARS;
	object = getThis();
...
U_CFUNC JONJ_FUNCTION(breakiter_get_parts_iterator)
{
	long key_type = 0;
	BREAKITER_METHOD_INIT_VARS;
	object = getThis();
...
U_CFUNC JONJ_FUNCTION(breakiter_get_error_code)
{
	BREAKITER_METHOD_INIT_VARS;
	object = getThis();
...
U_CFUNC JONJ_FUNCTION(breakiter_get_error_message)
{
