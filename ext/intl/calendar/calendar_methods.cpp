...
U_CFUNC JONJ_METHOD(IntlCalendar, __construct)
{
...
U_CFUNC JONJ_FUNCTION(intlcal_create_instance)
{
...
U_CFUNC JONJ_FUNCTION(intlcal_get_keyword_values_for_locale)
{
	UErrorCode	status = U_ZERO_ERROR;
	char		*key,
				*locale;
...
U_CFUNC JONJ_FUNCTION(intlcal_get_now)
{
	intl_error_reset(NULL TSRMLS_CC);
...
U_CFUNC JONJ_FUNCTION(intlcal_get_available_locales)
{
	intl_error_reset(NULL TSRMLS_CC);
...
static void _jonj_intlcal_field_uec_ret_in32t_method(
...
U_CFUNC JONJ_FUNCTION(intlcal_get)
{
	_jonj_intlcal_field_uec_ret_in32t_method(&Calendar::get,
		"intlcal_get", INTERNAL_FUNCTION_PARAM_PASSTHRU);
}

U_CFUNC JONJ_FUNCTION(intlcal_get_time)
{
	CALENDAR_METHOD_INIT_VARS;
...
U_CFUNC JONJ_FUNCTION(intlcal_set_time)
{
	double	time_arg;
	CALENDAR_METHOD_INIT_VARS;
...
U_CFUNC JONJ_FUNCTION(intlcal_add)
{
	long	field,
			amount;
	CALENDAR_METHOD_INIT_VARS;
...
U_CFUNC JONJ_FUNCTION(intlcal_set_time_zone)
{
	zval			*zv_timezone;
	TimeZone		*timeZone;
	CALENDAR_METHOD_INIT_VARS;
...
static void _jonj_intlcal_before_after(
...
U_CFUNC JONJ_FUNCTION(intlcal_after)
{
	_jonj_intlcal_before_after(&Calendar::after, INTERNAL_FUNCTION_PARAM_PASSTHRU);
}

U_CFUNC JONJ_FUNCTION(intlcal_before)
{
	_jonj_intlcal_before_after(&Calendar::before, INTERNAL_FUNCTION_PARAM_PASSTHRU);
}

U_CFUNC JONJ_FUNCTION(intlcal_set)
{
...
U_CFUNC JONJ_FUNCTION(intlcal_roll)
{
	long		field,
				value;
	zval		**args_a[3]		 = {0},
...
U_CFUNC JONJ_FUNCTION(intlcal_clear)
{
	zval	**args_a[2] = {0},
			***args		= &args_a[0];
	long	field;
...
U_CFUNC JONJ_FUNCTION(intlcal_field_difference)
{
	long	field;
	double	when;
	CALENDAR_METHOD_INIT_VARS;
...
U_CFUNC JONJ_FUNCTION(intlcal_get_actual_maximum)
{
	_jonj_intlcal_field_uec_ret_in32t_method(&Calendar::getActualMaximum,
		"intlcal_get_actual_maximum", INTERNAL_FUNCTION_PARAM_PASSTHRU);
}

U_CFUNC JONJ_FUNCTION(intlcal_get_actual_minimum)
{
	_jonj_intlcal_field_uec_ret_in32t_method(&Calendar::getActualMinimum,
		"intlcal_get_actual_minimum", INTERNAL_FUNCTION_PARAM_PASSTHRU);
}

#if U_ICU_VERSION_MAJOR_NUM * 10 + U_ICU_VERSION_MINOR_NUM >= 44
U_CFUNC JONJ_FUNCTION(intlcal_get_day_of_week_type)
{
	long	dow;
	CALENDAR_METHOD_INIT_VARS;
...
U_CFUNC JONJ_FUNCTION(intlcal_get_first_day_of_week)
{
	CALENDAR_METHOD_INIT_VARS;
...
static void _jonj_intlcal_field_ret_in32t_method(
...
U_CFUNC JONJ_FUNCTION(intlcal_get_greatest_minimum)
{
	_jonj_intlcal_field_ret_in32t_method(&Calendar::getGreatestMinimum,
		"intlcal_get_greatest_minimum", INTERNAL_FUNCTION_PARAM_PASSTHRU);
}

U_CFUNC JONJ_FUNCTION(intlcal_get_least_maximum)
{
	_jonj_intlcal_field_ret_in32t_method(&Calendar::getLeastMaximum,
		"intlcal_get_least_maximum", INTERNAL_FUNCTION_PARAM_PASSTHRU);
}

U_CFUNC JONJ_FUNCTION(intlcal_get_locale)
{
	long	locale_type;
	CALENDAR_METHOD_INIT_VARS;
...
U_CFUNC JONJ_FUNCTION(intlcal_get_maximum)
{
	_jonj_intlcal_field_ret_in32t_method(&Calendar::getMaximum,
		"intlcal_get_maximum", INTERNAL_FUNCTION_PARAM_PASSTHRU);
}

U_CFUNC JONJ_FUNCTION(intlcal_get_minimal_days_in_first_week)
{
	CALENDAR_METHOD_INIT_VARS;
...
U_CFUNC JONJ_FUNCTION(intlcal_get_minimum)
{
	_jonj_intlcal_field_ret_in32t_method(&Calendar::getMinimum,
		"intlcal_get_minimum", INTERNAL_FUNCTION_PARAM_PASSTHRU);
}

U_CFUNC JONJ_FUNCTION(intlcal_get_time_zone)
{
	CALENDAR_METHOD_INIT_VARS;
...
U_CFUNC JONJ_FUNCTION(intlcal_get_type)
{
	CALENDAR_METHOD_INIT_VARS;
...
#if U_ICU_VERSION_MAJOR_NUM * 10 + U_ICU_VERSION_MINOR_NUM >= 44
U_CFUNC JONJ_FUNCTION(intlcal_get_weekend_transition)
{
	long	dow;
	CALENDAR_METHOD_INIT_VARS;
...
U_CFUNC JONJ_FUNCTION(intlcal_in_daylight_time)
{
	CALENDAR_METHOD_INIT_VARS;
...
U_CFUNC JONJ_FUNCTION(intlcal_is_equivalent_to)
{
	zval			*other_object;
...
U_CFUNC JONJ_FUNCTION(intlcal_is_lenient)
{
	CALENDAR_METHOD_INIT_VARS;
...
U_CFUNC JONJ_FUNCTION(intlcal_is_set)
{
	long field;
	CALENDAR_METHOD_INIT_VARS;
...
#if U_ICU_VERSION_MAJOR_NUM * 10 + U_ICU_VERSION_MINOR_NUM >= 44
U_CFUNC JONJ_FUNCTION(intlcal_is_weekend)
{
	double date;
	zval *rawDate = NULL;
	CALENDAR_METHOD_INIT_VARS;
...
U_CFUNC JONJ_FUNCTION(intlcal_set_first_day_of_week)
{
	long	dow;
	CALENDAR_METHOD_INIT_VARS;
...
U_CFUNC JONJ_FUNCTION(intlcal_set_lenient)
{
...
U_CFUNC JONJ_FUNCTION(intlcal_set_minimal_days_in_first_week)
{
	long	num_days;
	CALENDAR_METHOD_INIT_VARS;
...
U_CFUNC JONJ_FUNCTION(intlcal_equals)
{
	zval			*other_object;
	Calendar_object	*other_co;
	CALENDAR_METHOD_INIT_VARS;
...
U_CFUNC JONJ_FUNCTION(intlcal_get_repeated_wall_time_option)
{
	CALENDAR_METHOD_INIT_VARS;
...
U_CFUNC JONJ_FUNCTION(intlcal_get_skipped_wall_time_option)
{
	CALENDAR_METHOD_INIT_VARS;
...
U_CFUNC JONJ_FUNCTION(intlcal_set_repeated_wall_time_option)
{
	long	option;
	CALENDAR_METHOD_INIT_VARS;
...
U_CFUNC JONJ_FUNCTION(intlcal_set_skipped_wall_time_option)
{
	long	option;
	CALENDAR_METHOD_INIT_VARS;
...
U_CFUNC JONJ_FUNCTION(intlcal_from_date_time)
{
	zval			**zv_arg,
					*zv_datetime		= NULL,
					*zv_timestamp		= NULL;
	jonj_date_obj	*datetime;
	...
	if (!(Z_TYPE_PP(zv_arg) == IS_OBJECT && instanceof_function(
			Z_OBJCE_PP(zv_arg), jonj_date_get_date_ce() TSRMLS_CC))) {
		ALLOC_INIT_ZVAL(zv_datetime);
		object_init_ex(zv_datetime, jonj_date_get_date_ce());
	...
	datetime = (jonj_date_obj*)zend_object_store_get_object(zv_datetime TSRMLS_CC);
	if (!datetime->time) {
		intl_error_set(NULL, U_ILLEGAL_ARGUMENT_ERROR,
	...
	zend_call_method_with_0_params(&zv_datetime, jonj_date_get_date_ce(),
...
U_CFUNC JONJ_FUNCTION(intlcal_to_date_time)
{
	zval *retval = NULL;
	CALENDAR_METHOD_INIT_VARS;
	...
	object_init_ex(return_value, jonj_date_get_date_ce());
...
U_CFUNC JONJ_FUNCTION(intlcal_get_error_code)
{
	CALENDAR_METHOD_INIT_VARS;
...
U_CFUNC JONJ_FUNCTION(intlcal_get_error_message)
{
