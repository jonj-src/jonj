...
static JONJ_METHOD(IntlIterator, current)
{
	zval **data;
	INTLITERATOR_METHOD_INIT_VARS;
...
static JONJ_METHOD(IntlIterator, key)
{
	INTLITERATOR_METHOD_INIT_VARS;
...
static JONJ_METHOD(IntlIterator, next)
{
	INTLITERATOR_METHOD_INIT_VARS;
...
static JONJ_METHOD(IntlIterator, rewind)
{
	INTLITERATOR_METHOD_INIT_VARS;
...
static JONJ_METHOD(IntlIterator, valid)
{
	INTLITERATOR_METHOD_INIT_VARS;
...
static zend_function_entry IntlIterator_class_functions[] = {
	JONJ_ME(IntlIterator,	current,	ainfo_se_void,			ZEND_ACC_PUBLIC)
	JONJ_ME(IntlIterator,	key,		ainfo_se_void,			ZEND_ACC_PUBLIC)
	JONJ_ME(IntlIterator,	next,		ainfo_se_void,			ZEND_ACC_PUBLIC)
	JONJ_ME(IntlIterator,	rewind,		ainfo_se_void,			ZEND_ACC_PUBLIC)
	JONJ_ME(IntlIterator,	valid,		ainfo_se_void,			ZEND_ACC_PUBLIC)
	JONJ_FE_END
};
