...
U_CFUNC JONJ_METHOD(IntlTimeZone, __construct)
{
...
U_CFUNC JONJ_FUNCTION(intltz_create_time_zone)
{
	char	*str_id;
	int		str_id_len;
...
U_CFUNC JONJ_FUNCTION(intltz_from_date_time_zone)
{
	zval				*zv_timezone;
	TimeZone			*tz;
	...
	if (zend_parse_parameters(ZEND_NUM_ARGS() TSRMLS_CC, "O",
			&zv_timezone, jonj_date_get_timezone_ce()) == FAILURE) {
		intl_error_set(NULL, U_ILLEGAL_ARGUMENT_ERROR,
			"intltz_from_date_time_zone: bad arguments", 0 TSRMLS_CC);
		RETURN_NULL();
	}

	tzobj = (jonj_timezone_obj *)zend_objects_get_address(zv_timezone TSRMLS_CC);
...
U_CFUNC JONJ_FUNCTION(intltz_create_default)
{
	intl_error_reset(NULL TSRMLS_CC);
...
U_CFUNC JONJ_FUNCTION(intltz_get_gmt)
{
	intl_error_reset(NULL TSRMLS_CC);
...
U_CFUNC JONJ_FUNCTION(intltz_get_unknown)
{
	intl_error_reset(NULL TSRMLS_CC);
...
U_CFUNC JONJ_FUNCTION(intltz_create_enumeration)
{
	zval				**arg = NULL;
...
U_CFUNC JONJ_FUNCTION(intltz_count_equivalent_ids)
{
	char	*str_id;
	int		str_id_len;
	intl_error_reset(NULL TSRMLS_CC);
...
U_CFUNC JONJ_FUNCTION(intltz_create_time_zone_id_enumeration)
{
	long	zoneType,
			offset_arg;
	char	*region		= NULL;
...
U_CFUNC JONJ_FUNCTION(intltz_get_canonical_id)
{
	char	*str_id;
	int		str_id_len;
...
#if U_ICU_VERSION_MAJOR_NUM * 10 + U_ICU_VERSION_MINOR_NUM >= 48
U_CFUNC JONJ_FUNCTION(intltz_get_region)
{
	char	*str_id;
	int		str_id_len;
	char	outbuf[3];
...
U_CFUNC JONJ_FUNCTION(intltz_get_tz_data_version)
{
	intl_error_reset(NULL TSRMLS_CC);
...
U_CFUNC JONJ_FUNCTION(intltz_get_equivalent_id)
{
	char	*str_id;
	int		str_id_len;
	long	index;
...
U_CFUNC JONJ_FUNCTION(intltz_get_id)
{
...
U_CFUNC JONJ_FUNCTION(intltz_use_daylight_time)
{
	TIMEZONE_METHOD_INIT_VARS;
...
U_CFUNC JONJ_FUNCTION(intltz_get_offset)
{
	UDate		date;
	zend_bool	local;
	zval		*rawOffsetArg,
...
U_CFUNC JONJ_FUNCTION(intltz_get_raw_offset)
{
	TIMEZONE_METHOD_INIT_VARS;
...
U_CFUNC JONJ_FUNCTION(intltz_has_same_rules)
{
	zval			*other_object;
...
U_CFUNC JONJ_FUNCTION(intltz_get_display_name)
{
...
U_CFUNC JONJ_FUNCTION(intltz_get_dst_savings)
{
	TIMEZONE_METHOD_INIT_VARS;
...
U_CFUNC JONJ_FUNCTION(intltz_to_date_time_zone)
{
	TIMEZONE_METHOD_INIT_VARS;
...
U_CFUNC JONJ_FUNCTION(intltz_get_error_code)
{
	TIMEZONE_METHOD_INIT_VARS
...
U_CFUNC JONJ_FUNCTION(intltz_get_error_message)
{
