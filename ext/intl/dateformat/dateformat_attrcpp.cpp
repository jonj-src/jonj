 ...
 * Get formatter timezone_id.
 */
U_CFUNC JONJ_FUNCTION(datefmt_get_timezone_id)
{
 ...
 * Get formatter timezone.
 */
U_CFUNC JONJ_FUNCTION(datefmt_get_timezone)
{
	DATE_FORMAT_METHOD_INIT_VARS;
...
U_CFUNC JONJ_FUNCTION(datefmt_set_timezone_id)
{
	jonj_error_docref0(NULL TSRMLS_CC, E_DEPRECATED,
			"Use datefmt_set_timezone() instead, which also accepts a plain "
			"time zone identifier and for which this function is now an "
			"alias");
	JONJ_FN(datefmt_set_timezone)(INTERNAL_FUNCTION_PARAM_PASSTHRU);
}
 ...
 */
U_CFUNC JONJ_FUNCTION(datefmt_set_timezone)
{
	zval		**timezone_zv;
	TimeZone	*timezone;
 ...
 * Get formatter calendar type.
 */
U_CFUNC JONJ_FUNCTION(datefmt_get_calendar)
{
	DATE_FORMAT_METHOD_INIT_VARS;
 ...
 * Get formatter calendar.
 */
U_CFUNC JONJ_FUNCTION(datefmt_get_calendar_object)
{
	DATE_FORMAT_METHOD_INIT_VARS;
 ...
 * Set formatter's calendar.
 */
U_CFUNC JONJ_FUNCTION(datefmt_set_calendar)
{
	zval	*calendar_zv;
	DATE_FORMAT_METHOD_INIT_VARS;
