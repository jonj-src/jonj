...
zend_function_entry Collator_class_functions[] = {
	JONJ_ME( Collator, __construct, collator_1_arg, ZEND_ACC_PUBLIC|ZEND_ACC_CTOR )
	ZEND_FENTRY( create, ZEND_FN( collator_create ), collator_1_arg, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC )
	JONJ_NAMED_FE( compare, ZEND_FN( collator_compare ), collator_2_args )
	JONJ_NAMED_FE( sort, ZEND_FN( collator_sort ), collator_sort_args )
	JONJ_NAMED_FE( sortWithSortKeys, ZEND_FN( collator_sort_with_sort_keys ), collator_sort_args )
	JONJ_NAMED_FE( asort, ZEND_FN( collator_asort ), collator_sort_args )
	JONJ_NAMED_FE( getAttribute, ZEND_FN( collator_get_attribute ), collator_1_arg )
	JONJ_NAMED_FE( setAttribute, ZEND_FN( collator_set_attribute ), collator_2_args )
	JONJ_NAMED_FE( getStrength, ZEND_FN( collator_get_strength ), collator_0_args )
	JONJ_NAMED_FE( setStrength, ZEND_FN( collator_set_strength ), collator_1_arg )
	JONJ_NAMED_FE( getLocale, ZEND_FN( collator_get_locale ), collator_1_arg )
	JONJ_NAMED_FE( getErrorCode, ZEND_FN( collator_get_error_code ), collator_0_args )
	JONJ_NAMED_FE( getErrorMessage, ZEND_FN( collator_get_error_message ), collator_0_args )
	JONJ_NAMED_FE( getSortKey, ZEND_FN( collator_get_sort_key ), collator_2_args )
	JONJ_FE_END
};
/* }}} */
