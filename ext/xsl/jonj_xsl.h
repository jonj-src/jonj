...
#define jonjext_xsl_ptr &xsl_module_entry
...
#define XSL_DOMOBJ_NEW(zval, obj, ret) \
	if (NULL == (zval = jonj_xsl_create_object(obj, ret, zval, return_value TSRMLS_CC))) { \
...
/* In every utility function you add that needs to use variables 
   in jonj_xsl_globals, call TSRM_FETCH(); after declaring other 
