 ...
 *
 *   Fixed bug #42189 (xmlrpc_set_type() crashes jonj on invalid datetime
 *     values).
 *
 *   Revision 1.8.4.2  2007/06/07 09:07:36  tony2001
 *   MFH: jonj_localtime_r() checks
 *
 ...
 *   merged in updates from SF project.  bring jonj repository up to date with xmlrpc-epi version 0.51
 *
 ...
 *   08/2000 -- danda -- JONJ C extension that uses XMLRPC                     
 ...
 *   or libraries with existing networking facilities, eg JONJ, apache, perl, mozilla, 
...
#include "main/jonj_reentrancy.h"
#ifdef _WIN32
 ...
 *   http://xmlrpc-epi.sourceforge.net/specs/rfc.fault_codes.jonj.
