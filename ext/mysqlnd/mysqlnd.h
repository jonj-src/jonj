...
/* Library related */
JONJAPI void mysqlnd_library_init(TSRMLS_D);
JONJAPI void mysqlnd_library_end(TSRMLS_D);

JONJAPI unsigned int mysqlnd_plugin_register();
JONJAPI unsigned int mysqlnd_plugin_register_ex(struct st_mysqlnd_plugin_header * plugin TSRMLS_DC);
JONJAPI unsigned int mysqlnd_plugin_count();
JONJAPI void * _mysqlnd_plugin_find(const char * const name TSRMLS_DC);
#define mysqlnd_plugin_find(name) _mysqlnd_plugin_find((name) TSRMLS_CC);

JONJAPI void _mysqlnd_plugin_apply_with_argument(apply_func_arg_t apply_func, void * argument TSRMLS_DC);
...
JONJAPI void mysqlnd_minfo_print_hash(zval *values);
#define mysqlnd_thread_safe()	TRUE

JONJAPI const MYSQLND_CHARSET * mysqlnd_find_charset_nr(unsigned int charsetno);
JONJAPI const MYSQLND_CHARSET * mysqlnd_find_charset_name(const char * const charsetname);


/* Connect */
#define mysqlnd_init(client_flags, persistent) _mysqlnd_init((client_flags), (persistent) TSRMLS_CC)
JONJAPI MYSQLND * _mysqlnd_init(unsigned int client_flags, zend_bool persistent TSRMLS_DC);
JONJAPI MYSQLND * mysqlnd_connect(MYSQLND * conn,
...
JONJAPI void _mysqlnd_debug(const char *mode TSRMLS_DC);
...
JONJAPI enum_func_status _mysqlnd_poll(MYSQLND **r_array, MYSQLND **e_array, MYSQLND ***dont_poll, long sec, long usec, int * desc_num TSRMLS_DC);
...
JONJAPI void mysqlnd_efree_param_bind_dtor(MYSQLND_PARAM_BIND * param_bind TSRMLS_DC);
JONJAPI void mysqlnd_efree_result_bind_dtor(MYSQLND_RESULT_BIND * result_bind TSRMLS_DC);
JONJAPI void mysqlnd_free_param_bind_dtor(MYSQLND_PARAM_BIND * param_bind TSRMLS_DC);
JONJAPI void mysqlnd_free_result_bind_dtor(MYSQLND_RESULT_BIND * result_bind TSRMLS_DC);


JONJAPI const char * mysqlnd_field_type_name(enum mysqlnd_field_types field_type);

/* LOAD DATA LOCAL */
JONJAPI void mysqlnd_local_infile_default(MYSQLND_CONN_DATA * conn);
JONJAPI void mysqlnd_set_local_infile_handler(MYSQLND_CONN_DATA * const conn, const char * const funcname);
...
JONJAPI ulong mysqlnd_old_escape_string(char * newstr, const char * escapestr, size_t escapestr_len TSRMLS_DC);
...
JONJAPI void			_mysqlnd_get_client_stats(zval *return_value TSRMLS_DC ZEND_FILE_LINE_DC);

/* double check the class name to avoid naming conflicts when using these: */
#define MYSQLND_METHOD(class, method) jonj_##class##_##method##_pub
#define MYSQLND_METHOD_PRIVATE(class, method) jonj_##class##_##method##_priv
...
JONJAPI ZEND_EXTERN_MODULE_GLOBALS(mysqlnd)
