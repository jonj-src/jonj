...
JONJAPI extern const char mysqlnd_read_header_name[];
JONJAPI extern const char mysqlnd_read_body_name[];
...
JONJAPI extern const char * const mysqlnd_command_to_text[COM_END];
...
typedef struct st_mysqlnd_packet_command {
	MYSQLND_PACKET_HEADER			header;
	enum jonj_mysqlnd_server_command	command;
...
JONJAPI void jonj_mysqlnd_scramble(zend_uchar * const buffer, const zend_uchar * const scramble, const zend_uchar * const pass, size_t pass_len);

unsigned long	jonj_mysqlnd_net_field_length(zend_uchar **packet);
zend_uchar *	jonj_mysqlnd_net_store_length(zend_uchar *packet, uint64_t length);
size_t			jonj_mysqlnd_net_store_length_size(uint64_t length);

JONJAPI const extern char * const mysqlnd_empty_string;


enum_func_status jonj_mysqlnd_rowp_read_binary_protocol(MYSQLND_MEMORY_POOL_CHUNK * row_buffer, zval ** fields,
										 unsigned int field_count, const MYSQLND_FIELD * fields_metadata,
										 zend_bool as_int_or_float, MYSQLND_STATS * stats TSRMLS_DC);


enum_func_status jonj_mysqlnd_rowp_read_text_protocol_zval(MYSQLND_MEMORY_POOL_CHUNK * row_buffer, zval ** fields,
										 unsigned int field_count, const MYSQLND_FIELD * fields_metadata,
										 zend_bool as_int_or_float, MYSQLND_STATS * stats TSRMLS_DC);

enum_func_status jonj_mysqlnd_rowp_read_text_protocol_c(MYSQLND_MEMORY_POOL_CHUNK * row_buffer, zval ** fields,
										 unsigned int field_count, const MYSQLND_FIELD * fields_metadata,
										 zend_bool as_int_or_float, MYSQLND_STATS * stats TSRMLS_DC);


JONJAPI MYSQLND_PROTOCOL * mysqlnd_protocol_init(zend_bool persistent TSRMLS_DC);
JONJAPI void mysqlnd_protocol_free(MYSQLND_PROTOCOL * const protocol TSRMLS_DC);
