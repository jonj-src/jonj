...
JONJAPI extern MYSQLND_STATS * mysqlnd_global_stats;
...
JONJAPI void mysqlnd_fill_stats_hash(const MYSQLND_STATS * const stats, const MYSQLND_STRING * names, zval *return_value TSRMLS_DC ZEND_FILE_LINE_DC);

JONJAPI void mysqlnd_stats_init(MYSQLND_STATS ** stats, size_t statistic_count);
JONJAPI void mysqlnd_stats_end(MYSQLND_STATS * stats);

JONJAPI mysqlnd_stat_trigger mysqlnd_stats_set_trigger(MYSQLND_STATS * const stats, enum_mysqlnd_collected_stats stat, mysqlnd_stat_trigger trigger TSRMLS_DC);
JONJAPI mysqlnd_stat_trigger mysqlnd_stats_reset_triggers(MYSQLND_STATS * const stats TSRMLS_DC);
