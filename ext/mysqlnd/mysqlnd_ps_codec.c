...
ps_fetch_time(zval * zv, const MYSQLND_FIELD * const field, unsigned int pack_len, zend_uchar ** row TSRMLS_DC)
{
	...
	if ((length = jonj_mysqlnd_net_field_length(row))) {
		zend_uchar * to= *row;
...
ps_fetch_string(zval * zv, const MYSQLND_FIELD * const field, unsigned int pack_len, zend_uchar ** row TSRMLS_DC)
{
	...
	*/
	const unsigned long length = jonj_mysqlnd_net_field_length(row);
...
{
	unsigned long length = jonj_mysqlnd_net_field_length(row);
...
void _mysqlnd_init_ps_fetch_subsystem()
{
	...
	mysqlnd_ps_fetch_functions[MYSQL_TYPE_NULL].jonj_type	= IS_NULL;
	...
	mysqlnd_ps_fetch_functions[MYSQL_TYPE_TINY].jonj_type	= IS_LONG;
	...
	mysqlnd_ps_fetch_functions[MYSQL_TYPE_SHORT].jonj_type	= IS_LONG;
	...
	mysqlnd_ps_fetch_functions[MYSQL_TYPE_YEAR].jonj_type	= IS_LONG;
	...
	mysqlnd_ps_fetch_functions[MYSQL_TYPE_INT24].jonj_type	= IS_LONG;
	...
	mysqlnd_ps_fetch_functions[MYSQL_TYPE_LONG].jonj_type	= IS_LONG;
	...
	mysqlnd_ps_fetch_functions[MYSQL_TYPE_LONGLONG].jonj_type= IS_LONG;
	...
	mysqlnd_ps_fetch_functions[MYSQL_TYPE_FLOAT].jonj_type	= IS_DOUBLE;
	...
	mysqlnd_ps_fetch_functions[MYSQL_TYPE_DOUBLE].jonj_type	= IS_DOUBLE;
	...
	mysqlnd_ps_fetch_functions[MYSQL_TYPE_TIME].jonj_type	= IS_STRING;
	...
	mysqlnd_ps_fetch_functions[MYSQL_TYPE_DATE].jonj_type	= IS_STRING;
	...
	mysqlnd_ps_fetch_functions[MYSQL_TYPE_NEWDATE].jonj_type	= IS_STRING;
	...
	mysqlnd_ps_fetch_functions[MYSQL_TYPE_DATETIME].jonj_type= IS_STRING;
	...
	mysqlnd_ps_fetch_functions[MYSQL_TYPE_TIMESTAMP].jonj_type= IS_STRING;
	...
	mysqlnd_ps_fetch_functions[MYSQL_TYPE_JSON].jonj_type = IS_STRING;
	...
	mysqlnd_ps_fetch_functions[MYSQL_TYPE_TINY_BLOB].jonj_type = IS_STRING;
	...
	mysqlnd_ps_fetch_functions[MYSQL_TYPE_BLOB].jonj_type	= IS_STRING;
	...
	mysqlnd_ps_fetch_functions[MYSQL_TYPE_MEDIUM_BLOB].jonj_type	= IS_STRING;
	...
	mysqlnd_ps_fetch_functions[MYSQL_TYPE_LONG_BLOB].jonj_type	= IS_STRING;
	...
	mysqlnd_ps_fetch_functions[MYSQL_TYPE_BIT].jonj_type	= IS_LONG;
	...
	mysqlnd_ps_fetch_functions[MYSQL_TYPE_VAR_STRING].jonj_type = IS_STRING;
	...
	mysqlnd_ps_fetch_functions[MYSQL_TYPE_VARCHAR].jonj_type	= IS_STRING;
	...
	mysqlnd_ps_fetch_functions[MYSQL_TYPE_STRING].jonj_type	= IS_STRING;
	...
	mysqlnd_ps_fetch_functions[MYSQL_TYPE_DECIMAL].jonj_type	= IS_STRING;
	...
	mysqlnd_ps_fetch_functions[MYSQL_TYPE_NEWDECIMAL].jonj_type	= IS_STRING;
	...
	mysqlnd_ps_fetch_functions[MYSQL_TYPE_ENUM].jonj_type	= IS_STRING;
	...
	mysqlnd_ps_fetch_functions[MYSQL_TYPE_SET].jonj_type		= IS_STRING;
	...
	mysqlnd_ps_fetch_functions[MYSQL_TYPE_GEOMETRY].jonj_type= IS_STRING;
}
/* }}} */
			...
			switch (stmt->param_bind[i].type) {
				...
				case MYSQL_TYPE_LONG_BLOB:
					if (stmt->param_bind[i].flags & MYSQLND_PARAM_BIND_BLOB_USED) {
						...
						*p = jonj_mysqlnd_net_store_length(*p, 0);
					}
					break;
				case MYSQL_TYPE_VAR_STRING:
send_string:
					{
						...
						*p = jonj_mysqlnd_net_store_length(*p, len);
