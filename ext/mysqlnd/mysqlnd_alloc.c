...
JONJAPI const char * mysqlnd_debug_std_no_trace_funcs[] =
{
...
#if JONJ_DEBUG
	{
		char * fn = strrchr(__zend_orig_filename, JONJ_DIR_SEPARATOR); 
...
JONJAPI struct st_mysqlnd_allocator_methods mysqlnd_allocator = 
{
