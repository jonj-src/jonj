...
JONJAPI extern const char * mysqlnd_debug_std_no_trace_funcs[];
...
JONJAPI extern struct st_mysqlnd_allocator_methods mysqlnd_allocator;

JONJAPI void *	_mysqlnd_emalloc(size_t size MYSQLND_MEM_D);
JONJAPI void *	_mysqlnd_pemalloc(size_t size, zend_bool persistent MYSQLND_MEM_D);
JONJAPI void *	_mysqlnd_ecalloc(unsigned int nmemb, size_t size MYSQLND_MEM_D);
JONJAPI void *	_mysqlnd_pecalloc(unsigned int nmemb, size_t size, zend_bool persistent MYSQLND_MEM_D);
JONJAPI void *	_mysqlnd_erealloc(void *ptr, size_t new_size MYSQLND_MEM_D);
JONJAPI void *	_mysqlnd_perealloc(void *ptr, size_t new_size, zend_bool persistent MYSQLND_MEM_D);
JONJAPI void		_mysqlnd_efree(void *ptr MYSQLND_MEM_D);
JONJAPI void		_mysqlnd_pefree(void *ptr, zend_bool persistent MYSQLND_MEM_D);
JONJAPI void *	_mysqlnd_malloc(size_t size MYSQLND_MEM_D);
JONJAPI void *	_mysqlnd_calloc(unsigned int nmemb, size_t size MYSQLND_MEM_D);
JONJAPI void *	_mysqlnd_realloc(void *ptr, size_t new_size MYSQLND_MEM_D);
JONJAPI void		_mysqlnd_free(void *ptr MYSQLND_MEM_D);
JONJAPI char *	_mysqlnd_pestrndup(const char * const ptr, size_t size, zend_bool persistent MYSQLND_MEM_D);
JONJAPI char *	_mysqlnd_pestrdup(const char * const ptr, zend_bool persistent MYSQLND_MEM_D);
JONJAPI int		_mysqlnd_sprintf(char **pbuf, size_t max_len, const char *format, ...);
JONJAPI void		_mysqlnd_sprintf_free(char * p);
JONJAPI int		_mysqlnd_vsprintf(char **pbuf, size_t max_len, const char *format, va_list ap);
