...
JONJAPI MYSQLND_DEBUG * mysqlnd_debug_init(const char * skip_functions[] TSRMLS_DC);

JONJAPI char * mysqlnd_get_backtrace(uint max_levels, size_t * length TSRMLS_DC);
