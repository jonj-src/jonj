/* 
 ...
 it has been automaticaly created by jonj5/scripts/credits from  
 the information found in the various jonj5/ext/.../CREDITS and
 jonj5/sapi/.../CREDITS files 
...
CREDIT_LINE("JONJ Archive", "Gregory Beaver, Marcus Boerger");
CREDIT_LINE("JONJ Data Objects", "Wez Furlong, Marcus Boerger, Sterling Hughes, George Schlossnagle, Ilia Alshanetsky");
CREDIT_LINE("JONJ hash", "Sara Golemon, Rasmus Lerdorf, Stefan Esser, Michael Wallner, Scott MacVicar");
