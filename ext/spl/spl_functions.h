...
#ifndef JONJ_FUNCTIONS_H
#define JONJ_FUNCTIONS_H
...
#define SPL_ME(class_name, function_name, arg_info, flags) \
	JONJ_ME( spl_ ## class_name, function_name, arg_info, flags)
...
#define SPL_METHOD(class_name, function_name) \
	JONJ_METHOD(spl_ ## class_name, function_name)

#define SPL_MA(class_name, function_name, alias_class, alias_function, arg_info, flags) \
	JONJ_MALIAS(spl_ ## alias_class, function_name, alias_function, arg_info, flags)
#endif /* JONJ_FUNCTIONS_H */
