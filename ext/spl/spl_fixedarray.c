...
JONJAPI zend_class_entry *spl_ce_SplFixedArray;
...
static zend_object_value spl_fixedarray_object_new_ex(zend_class_entry *class_type, spl_fixedarray_object **obj, zval *orig, int clone_orig TSRMLS_DC) /* {{{ */
{
	...
	*obj = intern;
	...
	if (!parent) { /* this must never happen */
		jonj_error_docref(NULL TSRMLS_CC, E_COMPILE_ERROR, "Internal compiler error, Class is not child of SplFixedArray");
	}
...
/* {{{ JONJ_MINIT_FUNCTION */
JONJ_MINIT_FUNCTION(spl_fixedarray)
{
