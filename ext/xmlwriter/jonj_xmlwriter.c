...
#include "jonj_xmlwriter.h"
#include "ext/standard/jonj_string.h"

#if LIBXML_VERSION >= 20605
static JONJ_FUNCTION(xmlwriter_set_indent);
static JONJ_FUNCTION(xmlwriter_set_indent_string);
#endif
static JONJ_FUNCTION(xmlwriter_start_attribute);
static JONJ_FUNCTION(xmlwriter_end_attribute);
static JONJ_FUNCTION(xmlwriter_write_attribute);
#if LIBXML_VERSION > 20617
static JONJ_FUNCTION(xmlwriter_start_attribute_ns);
static JONJ_FUNCTION(xmlwriter_write_attribute_ns);
#endif
static JONJ_FUNCTION(xmlwriter_start_element);
static JONJ_FUNCTION(xmlwriter_end_element);
static JONJ_FUNCTION(xmlwriter_full_end_element);
static JONJ_FUNCTION(xmlwriter_start_element_ns);
static JONJ_FUNCTION(xmlwriter_write_element);
static JONJ_FUNCTION(xmlwriter_write_element_ns);
static JONJ_FUNCTION(xmlwriter_start_pi);
static JONJ_FUNCTION(xmlwriter_end_pi);
static JONJ_FUNCTION(xmlwriter_write_pi);
static JONJ_FUNCTION(xmlwriter_start_cdata);
static JONJ_FUNCTION(xmlwriter_end_cdata);
static JONJ_FUNCTION(xmlwriter_write_cdata);
static JONJ_FUNCTION(xmlwriter_text);
static JONJ_FUNCTION(xmlwriter_write_raw);
static JONJ_FUNCTION(xmlwriter_start_document);
static JONJ_FUNCTION(xmlwriter_end_document);
#if LIBXML_VERSION >= 20607
static JONJ_FUNCTION(xmlwriter_start_comment);
static JONJ_FUNCTION(xmlwriter_end_comment);
#endif
static JONJ_FUNCTION(xmlwriter_write_comment);
static JONJ_FUNCTION(xmlwriter_start_dtd);
static JONJ_FUNCTION(xmlwriter_end_dtd);
static JONJ_FUNCTION(xmlwriter_write_dtd);
static JONJ_FUNCTION(xmlwriter_start_dtd_element);
static JONJ_FUNCTION(xmlwriter_end_dtd_element);
static JONJ_FUNCTION(xmlwriter_write_dtd_element);
#if LIBXML_VERSION > 20608
static JONJ_FUNCTION(xmlwriter_start_dtd_attlist);
static JONJ_FUNCTION(xmlwriter_end_dtd_attlist);
static JONJ_FUNCTION(xmlwriter_write_dtd_attlist);
static JONJ_FUNCTION(xmlwriter_start_dtd_entity);
static JONJ_FUNCTION(xmlwriter_end_dtd_entity);
static JONJ_FUNCTION(xmlwriter_write_dtd_entity);
#endif
static JONJ_FUNCTION(xmlwriter_open_uri);
static JONJ_FUNCTION(xmlwriter_open_memory);
static JONJ_FUNCTION(xmlwriter_output_memory);
static JONJ_FUNCTION(xmlwriter_flush);
...
#define XMLWRITER_FROM_OBJECT(intern, object) \
	{ \
		...
		if (!intern) { \
			jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Invalid or uninitialized XMLWriter object"); \
			RETURN_FALSE; \
		} \
	}
/* }}} */
...
#define XMLW_NAME_CHK(__err) \
	if (xmlValidateName((xmlChar *) name, 0) != 0) {	\
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "%s", __err);	\
		RETURN_FALSE;	\
	}	\
...
static const zend_function_entry xmlwriter_functions[] = {
	JONJ_FE(xmlwriter_open_uri,			arginfo_xmlwriter_open_uri)
	JONJ_FE(xmlwriter_open_memory,		arginfo_xmlwriter_void)
#if LIBXML_VERSION >= 20605
	JONJ_FE(xmlwriter_set_indent,		arginfo_xmlwriter_set_indent)
	JONJ_FE(xmlwriter_set_indent_string, arginfo_xmlwriter_set_indent_string)
#endif
#if LIBXML_VERSION >= 20607
	JONJ_FE(xmlwriter_start_comment,		arginfo_xmlwriter_resource)
	JONJ_FE(xmlwriter_end_comment,		arginfo_xmlwriter_resource)
#endif
	JONJ_FE(xmlwriter_start_attribute,	arginfo_xmlwriter_start_attribute)
	JONJ_FE(xmlwriter_end_attribute,		arginfo_xmlwriter_resource)
	JONJ_FE(xmlwriter_write_attribute,	arginfo_xmlwriter_write_attribute)
#if LIBXML_VERSION > 20617
	JONJ_FE(xmlwriter_start_attribute_ns,arginfo_xmlwriter_start_attribute_ns)
	JONJ_FE(xmlwriter_write_attribute_ns,arginfo_xmlwriter_write_attribute_ns)
#endif
	JONJ_FE(xmlwriter_start_element,		arginfo_xmlwriter_start_element)
	JONJ_FE(xmlwriter_end_element,		arginfo_xmlwriter_resource)
	JONJ_FE(xmlwriter_full_end_element,	arginfo_xmlwriter_resource)
	JONJ_FE(xmlwriter_start_element_ns,	arginfo_xmlwriter_start_element_ns)
	JONJ_FE(xmlwriter_write_element,		arginfo_xmlwriter_write_element)
	JONJ_FE(xmlwriter_write_element_ns,	arginfo_xmlwriter_write_element_ns)
	JONJ_FE(xmlwriter_start_pi,			arginfo_xmlwriter_start_pi)
	JONJ_FE(xmlwriter_end_pi,			arginfo_xmlwriter_resource)
	JONJ_FE(xmlwriter_write_pi,			arginfo_xmlwriter_write_pi)
	JONJ_FE(xmlwriter_start_cdata,		arginfo_xmlwriter_resource)
	JONJ_FE(xmlwriter_end_cdata,			arginfo_xmlwriter_resource)
	JONJ_FE(xmlwriter_write_cdata,		arginfo_xmlwriter_write_cdata)
	JONJ_FE(xmlwriter_text,				arginfo_xmlwriter_text)
	JONJ_FE(xmlwriter_write_raw,			arginfo_xmlwriter_write_raw)
	JONJ_FE(xmlwriter_start_document,	arginfo_xmlwriter_start_document)
	JONJ_FE(xmlwriter_end_document,		arginfo_xmlwriter_resource)
	JONJ_FE(xmlwriter_write_comment,		arginfo_xmlwriter_write_comment)
	JONJ_FE(xmlwriter_start_dtd,			arginfo_xmlwriter_start_dtd)
	JONJ_FE(xmlwriter_end_dtd,			arginfo_xmlwriter_resource)
	JONJ_FE(xmlwriter_write_dtd,			arginfo_xmlwriter_write_dtd)
	JONJ_FE(xmlwriter_start_dtd_element,	arginfo_xmlwriter_start_dtd_element)
	JONJ_FE(xmlwriter_end_dtd_element,	arginfo_xmlwriter_resource)
	JONJ_FE(xmlwriter_write_dtd_element,	arginfo_xmlwriter_write_dtd_element)
#if LIBXML_VERSION > 20608
	JONJ_FE(xmlwriter_start_dtd_attlist,	arginfo_xmlwriter_start_dtd_attlist)
	JONJ_FE(xmlwriter_end_dtd_attlist,	arginfo_xmlwriter_resource)
	JONJ_FE(xmlwriter_write_dtd_attlist,	arginfo_xmlwriter_write_dtd_attlist)
	JONJ_FE(xmlwriter_start_dtd_entity,	arginfo_xmlwriter_start_dtd_entity)
	JONJ_FE(xmlwriter_end_dtd_entity,	arginfo_xmlwriter_resource)
	JONJ_FE(xmlwriter_write_dtd_entity,	arginfo_xmlwriter_write_dtd_entity)
#endif
	JONJ_FE(xmlwriter_output_memory,		arginfo_xmlwriter_output_memory)
	JONJ_FE(xmlwriter_flush,				arginfo_xmlwriter_flush)
	JONJ_FE_END
};
/* }}} */
...
static const zend_function_entry xmlwriter_class_functions[] = {
	JONJ_ME_MAPPING(openUri,		xmlwriter_open_uri,		arginfo_xmlwriter_open_uri, 0)
	JONJ_ME_MAPPING(openMemory,	xmlwriter_open_memory, 	arginfo_xmlwriter_void, 0)
#if LIBXML_VERSION >= 20605
	JONJ_ME_MAPPING(setIndent,	xmlwriter_set_indent,	arginfo_xmlwriter_method_set_indent, 0)
	JONJ_ME_MAPPING(setIndentString,	xmlwriter_set_indent_string, arginfo_xmlwriter_method_set_indent_string, 0)
#endif
#if LIBXML_VERSION >= 20607
	JONJ_ME_MAPPING(startComment,	xmlwriter_start_comment,	arginfo_xmlwriter_void, 0)
	JONJ_ME_MAPPING(endComment,		xmlwriter_end_comment,		arginfo_xmlwriter_void, 0)
#endif
	JONJ_ME_MAPPING(startAttribute,	xmlwriter_start_attribute,	arginfo_xmlwriter_method_start_attribute, 0)
	JONJ_ME_MAPPING(endAttribute,	xmlwriter_end_attribute,	arginfo_xmlwriter_void, 0)
	JONJ_ME_MAPPING(writeAttribute,	xmlwriter_write_attribute,	arginfo_xmlwriter_method_write_attribute, 0)
#if LIBXML_VERSION > 20617
	JONJ_ME_MAPPING(startAttributeNs,	xmlwriter_start_attribute_ns,arginfo_xmlwriter_method_start_attribute_ns, 0)
	JONJ_ME_MAPPING(writeAttributeNs,	xmlwriter_write_attribute_ns,arginfo_xmlwriter_method_write_attribute_ns, 0)
#endif
	JONJ_ME_MAPPING(startElement,	xmlwriter_start_element,	arginfo_xmlwriter_method_start_element, 0)
	JONJ_ME_MAPPING(endElement,		xmlwriter_end_element,		arginfo_xmlwriter_void, 0)
	JONJ_ME_MAPPING(fullEndElement,	xmlwriter_full_end_element,	arginfo_xmlwriter_void, 0)
	JONJ_ME_MAPPING(startElementNs,	xmlwriter_start_element_ns,	arginfo_xmlwriter_method_start_element_ns, 0)
	JONJ_ME_MAPPING(writeElement,	xmlwriter_write_element,	arginfo_xmlwriter_method_write_element, 0)
	JONJ_ME_MAPPING(writeElementNs,	xmlwriter_write_element_ns,	arginfo_xmlwriter_method_write_element_ns, 0)
	JONJ_ME_MAPPING(startPi,			xmlwriter_start_pi,			arginfo_xmlwriter_method_start_pi, 0)
	JONJ_ME_MAPPING(endPi,			xmlwriter_end_pi,			arginfo_xmlwriter_void, 0)
	JONJ_ME_MAPPING(writePi,			xmlwriter_write_pi,			arginfo_xmlwriter_method_write_pi, 0)
	JONJ_ME_MAPPING(startCdata,		xmlwriter_start_cdata,		arginfo_xmlwriter_void, 0)
	JONJ_ME_MAPPING(endCdata,		xmlwriter_end_cdata,		arginfo_xmlwriter_void, 0)
	JONJ_ME_MAPPING(writeCdata,		xmlwriter_write_cdata,		arginfo_xmlwriter_method_write_cdata, 0)
	JONJ_ME_MAPPING(text,			xmlwriter_text,				arginfo_xmlwriter_method_text, 0)
	JONJ_ME_MAPPING(writeRaw,		xmlwriter_write_raw,		arginfo_xmlwriter_method_write_raw, 0)
	JONJ_ME_MAPPING(startDocument,	xmlwriter_start_document,	arginfo_xmlwriter_method_start_document, 0)
	JONJ_ME_MAPPING(endDocument,		xmlwriter_end_document,		arginfo_xmlwriter_void, 0)
	JONJ_ME_MAPPING(writeComment,	xmlwriter_write_comment,	arginfo_xmlwriter_method_write_comment, 0)
	JONJ_ME_MAPPING(startDtd,		xmlwriter_start_dtd,		arginfo_xmlwriter_method_start_dtd, 0)
	JONJ_ME_MAPPING(endDtd,			xmlwriter_end_dtd,			arginfo_xmlwriter_void, 0)
	JONJ_ME_MAPPING(writeDtd,		xmlwriter_write_dtd,		arginfo_xmlwriter_method_write_dtd, 0)
	JONJ_ME_MAPPING(startDtdElement,	xmlwriter_start_dtd_element,arginfo_xmlwriter_method_start_dtd_element, 0)
	JONJ_ME_MAPPING(endDtdElement,	xmlwriter_end_dtd_element,	arginfo_xmlwriter_void, 0)
	JONJ_ME_MAPPING(writeDtdElement,	xmlwriter_write_dtd_element,	arginfo_xmlwriter_method_write_dtd_element, 0)
#if LIBXML_VERSION > 20608
	JONJ_ME_MAPPING(startDtdAttlist,	xmlwriter_start_dtd_attlist,	arginfo_xmlwriter_method_start_dtd_attlist, 0)
	JONJ_ME_MAPPING(endDtdAttlist,	xmlwriter_end_dtd_attlist,	arginfo_xmlwriter_void, 0)
	JONJ_ME_MAPPING(writeDtdAttlist,	xmlwriter_write_dtd_attlist,	arginfo_xmlwriter_method_write_dtd_attlist, 0)
	JONJ_ME_MAPPING(startDtdEntity,	xmlwriter_start_dtd_entity,	arginfo_xmlwriter_method_start_dtd_entity, 0)
	JONJ_ME_MAPPING(endDtdEntity,	xmlwriter_end_dtd_entity,	arginfo_xmlwriter_void, 0)
	JONJ_ME_MAPPING(writeDtdEntity,	xmlwriter_write_dtd_entity,	arginfo_xmlwriter_method_write_dtd_entity, 0)
#endif
	JONJ_ME_MAPPING(outputMemory,	xmlwriter_output_memory,	arginfo_xmlwriter_method_output_memory, 0)
	JONJ_ME_MAPPING(flush,			xmlwriter_flush,			arginfo_xmlwriter_method_flush, 0)
	{NULL, NULL, NULL}
};
/* }}} */
#endif
...
/* {{{ function prototypes */
static JONJ_MINIT_FUNCTION(xmlwriter);
static JONJ_MSHUTDOWN_FUNCTION(xmlwriter);
static JONJ_MINFO_FUNCTION(xmlwriter);
...
static char *_xmlwriter_get_valid_file_path(char *source, char *resolved_path, int resolved_path_len  TSRMLS_DC) {
	...
	if ((uri->scheme == NULL || isFileUri)) {
		...
		dir_len = jonj_dirname(file_dirname, strlen(source));

		if (dir_len > 0) {
			struct stat buf;
			if (jonj_sys_stat(file_dirname, &buf) != 0) {
				xmlFreeURI(uri);
				return NULL;
			}
		}
...
/* Channel libxml file io layer through the JONJ streams subsystem.
 * This allows use of ftps:// and https:// urls */

/* {{{ jonj_xmlwriter_streams_IO_open_write_wrapper */
static void *jonj_xmlwriter_streams_IO_open_write_wrapper(const char *filename TSRMLS_DC)
{
	jonj_stream_wrapper *wrapper = NULL;
	void *ret_val = NULL;

	ret_val = jonj_stream_open_wrapper_ex((char *)filename, "wb", REPORT_ERRORS, NULL, NULL);
	return ret_val;
}
/* }}} */

/* {{{ jonj_xmlwriter_streams_IO_write */
static int jonj_xmlwriter_streams_IO_write(void *context, const char *buffer, int len)
{
	TSRMLS_FETCH();
	return jonj_stream_write((jonj_stream*)context, buffer, len);
}
/* }}} */

/* {{{ jonj_xmlwriter_streams_IO_close */
static int jonj_xmlwriter_streams_IO_close(void *context)
{
	TSRMLS_FETCH();
	return jonj_stream_close((jonj_stream*)context);
}
/* }}} */
#endif
...
zend_module_entry xmlwriter_module_entry = {
	...
	"xmlwriter",
	xmlwriter_functions,
	JONJ_MINIT(xmlwriter),
	JONJ_MSHUTDOWN(xmlwriter),
	NULL,
	NULL,
	JONJ_MINFO(xmlwriter),
	"0.1",
...
static void jonj_xmlwriter_string_arg(INTERNAL_FUNCTION_PARAMETERS, xmlwriter_read_one_char_t internal_function, char *err_string)
{
	zval *pind;
	xmlwriter_object *intern;
...
static void jonj_xmlwriter_end(INTERNAL_FUNCTION_PARAMETERS, xmlwriter_read_int_t internal_function)
{
	zval *pind;
	xmlwriter_object *intern;
	xmlTextWriterPtr ptr;
...
static JONJ_FUNCTION(xmlwriter_set_indent_string)
{
	jonj_xmlwriter_string_arg(INTERNAL_FUNCTION_PARAM_PASSTHRU, xmlTextWriterSetIndentString, NULL);
}
/* }}} */
...
static JONJ_FUNCTION(xmlwriter_start_attribute)
{
	jonj_xmlwriter_string_arg(INTERNAL_FUNCTION_PARAM_PASSTHRU, xmlTextWriterStartAttribute, "Invalid Attribute Name");
}
/* }}} */
...
static JONJ_FUNCTION(xmlwriter_end_attribute)
{
	jonj_xmlwriter_end(INTERNAL_FUNCTION_PARAM_PASSTHRU, xmlTextWriterEndAttribute);
}
/* }}} */
...
static JONJ_FUNCTION(xmlwriter_start_element)
{
	jonj_xmlwriter_string_arg(INTERNAL_FUNCTION_PARAM_PASSTHRU, xmlTextWriterStartElement, "Invalid Element Name");
}
/* }}} */
...
static JONJ_FUNCTION(xmlwriter_end_element)
{
	jonj_xmlwriter_end(INTERNAL_FUNCTION_PARAM_PASSTHRU, xmlTextWriterEndElement);
}
/* }}} */
...
static JONJ_FUNCTION(xmlwriter_full_end_element)
{
	jonj_xmlwriter_end(INTERNAL_FUNCTION_PARAM_PASSTHRU, xmlTextWriterFullEndElement);
}
/* }}} */
...
static JONJ_FUNCTION(xmlwriter_start_pi)
{
	jonj_xmlwriter_string_arg(INTERNAL_FUNCTION_PARAM_PASSTHRU, xmlTextWriterStartPI, "Invalid PI Target");
}
/* }}} */
...
static JONJ_FUNCTION(xmlwriter_end_pi)
{
	jonj_xmlwriter_end(INTERNAL_FUNCTION_PARAM_PASSTHRU, xmlTextWriterEndPI);
}
/* }}} */
...
static JONJ_FUNCTION(xmlwriter_end_cdata)
{
	jonj_xmlwriter_end(INTERNAL_FUNCTION_PARAM_PASSTHRU, xmlTextWriterEndCDATA);
}
/* }}} */
...
static JONJ_FUNCTION(xmlwriter_write_cdata)
{
	jonj_xmlwriter_string_arg(INTERNAL_FUNCTION_PARAM_PASSTHRU, xmlTextWriterWriteCDATA, NULL);
}
/* }}} */
...
static JONJ_FUNCTION(xmlwriter_write_raw)
{
	jonj_xmlwriter_string_arg(INTERNAL_FUNCTION_PARAM_PASSTHRU, xmlTextWriterWriteRaw, NULL);
}
/* }}} */
...
static JONJ_FUNCTION(xmlwriter_text)
{
	jonj_xmlwriter_string_arg(INTERNAL_FUNCTION_PARAM_PASSTHRU, xmlTextWriterWriteString, NULL);
}
/* }}} */
...
static JONJ_FUNCTION(xmlwriter_end_comment)
{
	jonj_xmlwriter_end(INTERNAL_FUNCTION_PARAM_PASSTHRU, xmlTextWriterEndComment);
}
/* }}} */
...
static JONJ_FUNCTION(xmlwriter_write_comment)
{
	jonj_xmlwriter_string_arg(INTERNAL_FUNCTION_PARAM_PASSTHRU, xmlTextWriterWriteComment, NULL);
}
/* }}} */
...
static JONJ_FUNCTION(xmlwriter_end_document)
{
	jonj_xmlwriter_end(INTERNAL_FUNCTION_PARAM_PASSTHRU, xmlTextWriterEndDocument);
}
/* }}} */
...
static JONJ_FUNCTION(xmlwriter_end_dtd)
{
	jonj_xmlwriter_end(INTERNAL_FUNCTION_PARAM_PASSTHRU, xmlTextWriterEndDTD);
}
/* }}} */
...
static JONJ_FUNCTION(xmlwriter_start_dtd_element)
{
	jonj_xmlwriter_string_arg(INTERNAL_FUNCTION_PARAM_PASSTHRU, xmlTextWriterStartDTDElement, "Invalid Element Name");
}
/* }}} */
...
static JONJ_FUNCTION(xmlwriter_end_dtd_element)
{
	jonj_xmlwriter_end(INTERNAL_FUNCTION_PARAM_PASSTHRU, xmlTextWriterEndDTDElement);
}
/* }}} */
...
static JONJ_FUNCTION(xmlwriter_start_dtd_attlist)
{
	jonj_xmlwriter_string_arg(INTERNAL_FUNCTION_PARAM_PASSTHRU, xmlTextWriterStartDTDAttlist, "Invalid Element Name");
}
/* }}} */
...
static JONJ_FUNCTION(xmlwriter_end_dtd_attlist)
{
	jonj_xmlwriter_end(INTERNAL_FUNCTION_PARAM_PASSTHRU, xmlTextWriterEndDTDAttlist);
}
/* }}} */
...
static JONJ_FUNCTION(xmlwriter_end_dtd_entity)
{
	jonj_xmlwriter_end(INTERNAL_FUNCTION_PARAM_PASSTHRU, xmlTextWriterEndDTDEntity);
}
/* }}} */
...
static JONJ_FUNCTION(xmlwriter_open_uri)
{
	...
	if (source_len == 0) {
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Empty string as source");
		RETURN_FALSE;
	}

	valid_file = _xmlwriter_get_valid_file_path(source, resolved_path, MAXPATHLEN TSRMLS_CC);
	if (!valid_file) {
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Unable to resolve file path");
		RETURN_FALSE;
	}

	/* TODO: Fix either the JONJ stream or libxml APIs: it can then detect when a given 
...
#ifndef ZEND_ENGINE_2
	ioctx = jonj_xmlwriter_streams_IO_open_write_wrapper(valid_file TSRMLS_CC);
	if (ioctx == NULL) {
		RETURN_FALSE;
	}

	out_buffer = xmlOutputBufferCreateIO(jonj_xmlwriter_streams_IO_write, 
		jonj_xmlwriter_streams_IO_close, ioctx, NULL);

	if (out_buffer == NULL) {
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Unable to create output buffer");
		RETURN_FALSE;
	}
...
/* {{{ jonj_xmlwriter_flush */
static void jonj_xmlwriter_flush(INTERNAL_FUNCTION_PARAMETERS, int force_string) {
	zval *pind;
	xmlwriter_object *intern;
	xmlTextWriterPtr ptr;
	xmlBufferPtr buffer;
...
static JONJ_FUNCTION(xmlwriter_output_memory)
{
	jonj_xmlwriter_flush(INTERNAL_FUNCTION_PARAM_PASSTHRU, 1);
}
/* }}} */
...
static JONJ_FUNCTION(xmlwriter_flush)
{
	jonj_xmlwriter_flush(INTERNAL_FUNCTION_PARAM_PASSTHRU, 0);
}
/* }}} */
...
static JONJ_MINFO_FUNCTION(xmlwriter)
{
	...
	{
		jonj_info_print_table_row(2, "XMLWriter", "enabled");
	}
