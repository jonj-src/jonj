...
#define JONJ_EXPUNGE 32768
#define JONJ_IMAP_ADDRESS_SIZE_BUF 10
#ifndef SENDBUFLEN
...
static void _jonj_make_header_object(zval *myzvalue, ENVELOPE *en TSRMLS_DC);
static void _jonj_imap_add_body(zval *arg, BODY *body TSRMLS_DC);
static char* _jonj_imap_parse_address(ADDRESS *addresslist, zval *paddress TSRMLS_DC);
static char* _jonj_rfc822_write_address(ADDRESS *addresslist TSRMLS_DC);

/* the gets we use */
static char *jonj_mail_gets(readfn_t f, void *stream, unsigned long size, GETS_DATA *md);
...
static JONJ_GINIT_FUNCTION(imap);
...
const zend_function_entry imap_functions[] = {
	JONJ_FE(imap_open,								arginfo_imap_open)
	JONJ_FE(imap_reopen,								arginfo_imap_reopen)
	JONJ_FE(imap_close,								arginfo_imap_close)
	JONJ_FE(imap_num_msg,							arginfo_imap_num_msg)
	JONJ_FE(imap_num_recent,							arginfo_imap_num_recent)
	JONJ_FE(imap_headers,							arginfo_imap_headers)
	JONJ_FE(imap_headerinfo,							arginfo_imap_headerinfo)
	JONJ_FE(imap_rfc822_parse_headers,				arginfo_imap_rfc822_parse_headers)
	JONJ_FE(imap_rfc822_write_address,				arginfo_imap_rfc822_write_address)
	JONJ_FE(imap_rfc822_parse_adrlist,				arginfo_imap_rfc822_parse_adrlist)
	JONJ_FE(imap_body,								arginfo_imap_body)
	JONJ_FE(imap_bodystruct,							arginfo_imap_bodystruct)
	JONJ_FE(imap_fetchbody,							arginfo_imap_fetchbody)
	JONJ_FE(imap_fetchmime,							arginfo_imap_fetchbody)
	JONJ_FE(imap_savebody,							arginfo_imap_savebody)
	JONJ_FE(imap_fetchheader,						arginfo_imap_fetchheader)
	JONJ_FE(imap_fetchstructure,						arginfo_imap_fetchstructure)
	JONJ_FE(imap_gc,										arginfo_imap_gc)
	JONJ_FE(imap_expunge,							arginfo_imap_expunge)
	JONJ_FE(imap_delete,								arginfo_imap_delete)
	JONJ_FE(imap_undelete,							arginfo_imap_undelete)
	JONJ_FE(imap_check,								arginfo_imap_check)
	JONJ_FE(imap_listscan,							arginfo_imap_listscan)
	JONJ_FE(imap_mail_copy,							arginfo_imap_mail_copy)
	JONJ_FE(imap_mail_move,							arginfo_imap_mail_move)
	JONJ_FE(imap_mail_compose,						arginfo_imap_mail_compose)
	JONJ_FE(imap_createmailbox,						arginfo_imap_createmailbox)
	JONJ_FE(imap_renamemailbox,						arginfo_imap_renamemailbox)
	JONJ_FE(imap_deletemailbox,						arginfo_imap_deletemailbox)
	JONJ_FE(imap_subscribe,							arginfo_imap_subscribe)
	JONJ_FE(imap_unsubscribe,						arginfo_imap_unsubscribe)
	JONJ_FE(imap_append,								arginfo_imap_append)
	JONJ_FE(imap_ping,								arginfo_imap_ping)
	JONJ_FE(imap_base64,								arginfo_imap_base64)
	JONJ_FE(imap_qprint,								arginfo_imap_qprint)
	JONJ_FE(imap_8bit,								arginfo_imap_8bit)
	JONJ_FE(imap_binary,								arginfo_imap_binary)
	JONJ_FE(imap_utf8,								arginfo_imap_utf8)
	JONJ_FE(imap_status,								arginfo_imap_status)
	JONJ_FE(imap_mailboxmsginfo,						arginfo_imap_mailboxmsginfo)
	JONJ_FE(imap_setflag_full,						arginfo_imap_setflag_full)
	JONJ_FE(imap_clearflag_full,						arginfo_imap_clearflag_full)
	JONJ_FE(imap_sort,								arginfo_imap_sort)
	JONJ_FE(imap_uid,								arginfo_imap_uid)
	JONJ_FE(imap_msgno,								arginfo_imap_msgno)
	JONJ_FE(imap_list,								arginfo_imap_list)
	JONJ_FE(imap_lsub,								arginfo_imap_lsub)
	JONJ_FE(imap_fetch_overview,						arginfo_imap_fetch_overview)
	JONJ_FE(imap_alerts,								arginfo_imap_alerts)
	JONJ_FE(imap_errors,								arginfo_imap_errors)
	JONJ_FE(imap_last_error,							arginfo_imap_last_error)
	JONJ_FE(imap_search,								arginfo_imap_search)
	JONJ_FE(imap_utf7_decode,						arginfo_imap_utf7_decode)
	JONJ_FE(imap_utf7_encode,						arginfo_imap_utf7_encode)
#ifdef HAVE_IMAP_MUTF7
	JONJ_FE(imap_utf8_to_mutf7,						arginfo_imap_utf8_to_mutf7)
	JONJ_FE(imap_mutf7_to_utf8,						arginfo_imap_mutf7_to_utf8)
#endif
	JONJ_FE(imap_mime_header_decode,					arginfo_imap_mime_header_decode)
	JONJ_FE(imap_thread,								arginfo_imap_thread)
	JONJ_FE(imap_timeout,								arginfo_imap_timeout)

#if defined(HAVE_IMAP2000) || defined(HAVE_IMAP2001)
	JONJ_FE(imap_get_quota,							arginfo_imap_get_quota)
	JONJ_FE(imap_get_quotaroot,						arginfo_imap_get_quotaroot)
	JONJ_FE(imap_set_quota,							arginfo_imap_set_quota)
	JONJ_FE(imap_setacl,								arginfo_imap_setacl)
	JONJ_FE(imap_getacl,								arginfo_imap_getacl)
#endif

	JONJ_FE(imap_mail,								arginfo_imap_mail)

	JONJ_FALIAS(imap_header,			imap_headerinfo,	arginfo_imap_headerinfo)
	JONJ_FALIAS(imap_listmailbox,	imap_list,			arginfo_imap_list)
	JONJ_FALIAS(imap_getmailboxes,	imap_list_full,		arginfo_imap_getmailboxes)
	JONJ_FALIAS(imap_scanmailbox,	imap_listscan,		arginfo_imap_listscan)
	JONJ_FALIAS(imap_listsubscribed,	imap_lsub,			arginfo_imap_lsub)
	JONJ_FALIAS(imap_getsubscribed,	imap_lsub_full,		arginfo_imap_getsubscribed)
	JONJ_FALIAS(imap_fetchtext,		imap_body,			arginfo_imap_body)
	JONJ_FALIAS(imap_scan,			imap_listscan,		arginfo_imap_listscan)
	JONJ_FALIAS(imap_create,			imap_createmailbox,	arginfo_imap_createmailbox)
	JONJ_FALIAS(imap_rename,			imap_renamemailbox,	arginfo_imap_renamemailbox)
	JONJ_FE_END
};
/* }}} */
...
#define JONJ_IMAP_CHECK_MSGNO(msgindex)	\
	if ((msgindex < 1) || ((unsigned) msgindex > imap_le_struct->imap_stream->nmsgs)) {	\
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Bad message number");	\
		RETURN_FALSE;	\
	}	\
...
JONJ_MINIT_FUNCTION(imap)
{
	...
	/*
	JONJ re-assigns CL_EXPUNGE a custom value that can be used as part of the imap_open() bitfield
	...
	options and the value for this one conflicts, simply make JONJ_EXPUNGE higher at the top of
	this file
	*/
	REGISTER_LONG_CONSTANT("CL_EXPUNGE", JONJ_EXPUNGE, CONST_PERSISTENT | CONST_CS);
	/* expunge silently */
...
JONJ_RSHUTDOWN_FUNCTION(imap)
{
	...
	if (IMAPG(imap_errorstack) != NIL) {
		...
		if (EG(error_reporting) & E_NOTICE) {
			...
			while (ecur != NIL) {
				jonj_error_docref(NULL TSRMLS_CC, E_NOTICE, "%s (errflg=%ld)", ecur->LTEXT, ecur->errflg);
				ecur = ecur->next;
			}
		}
	...
	if (IMAPG(imap_alertstack) != NIL) {
		...
		if (EG(error_reporting) & E_NOTICE) {
			...
			while (acur != NIL) {
				jonj_error_docref(NULL TSRMLS_CC, E_NOTICE, "%s", acur->LTEXT);
				acur = acur->next;
			}
		}
...
JONJ_MINFO_FUNCTION(imap)
{
	...
	jonj_info_print_table_row(2, "IMAP c-Client Version", CCLIENTVERSION);
#if HAVE_IMAP_SSL
	jonj_info_print_table_row(2, "SSL Support", "enabled");
#endif
#if HAVE_IMAP_KRB && HAVE_IMAP_AUTH_GSS
	jonj_info_print_table_row(2, "Kerberos Support", "enabled");
#endif
...
/* {{{ imap_do_open
 */
static void jonj_imap_do_open(INTERNAL_FUNCTION_PARAMETERS, int persistent)
{
						...
						for (i = 0; i < nelems; i++) {
							if (zend_hash_index_find(Z_ARRVAL_PP(disabled_auth_method), i, (void **) &z_auth_method) == SUCCESS) {
								if (Z_TYPE_PP(z_auth_method) == IS_STRING) {
									...
									jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Invalid argument, expect string or array of strings");
								}
							}
						}
					}
	...
	if (mailbox[0] != '{' && jonj_check_open_basedir(mailbox TSRMLS_CC)) {
		RETURN_FALSE;
	}
	...
	if (argc >= 5) {
		if (retries < 0) {
			jonj_error_docref(NULL TSRMLS_CC, E_WARNING ,"Retries must be greater or equal to 0");
		} else {
	...
	if (imap_stream == NIL) {
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Couldn't open stream %s", mailbox);
...
{
	jonj_imap_do_open(INTERNAL_FUNCTION_PARAM_PASSTHRU, 0);
}
/* }}} */
...
JONJ_FUNCTION(imap_reopen)
{
	...
	if (imap_le_struct->imap_stream == NIL) {
		...
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Couldn't re-open stream");
		RETURN_FALSE;
	}
	RETURN_TRUE;
}
...
JONJ_FUNCTION(imap_append)
{
	...
	if (internal_date) {
		...
		jonj_pcre_match_impl(pce, internal_date, internal_date_len, return_value, subpats, global,
			0, regex_flags, start_offset TSRMLS_CC);

		if (!Z_LVAL_P(return_value)) {
			jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "internal date not correctly formatted");
			internal_date = NULL;
		}
	}
...
JONJ_FUNCTION(imap_get_quota)
{
	...
	if (!imap_getquota(imap_le_struct->imap_stream, qroot)) {
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "c-client imap_getquota failed");
...
JONJ_FUNCTION(imap_get_quotaroot)
{
	...
	if (!imap_getquotaroot(imap_le_struct->imap_stream, mbox)) {
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "c-client imap_getquotaroot failed");
		zval_dtor(return_value);
		RETURN_FALSE;
	}
}
...
JONJ_FUNCTION(imap_getacl)
{
	...
	if (!imap_getacl(imap_le_struct->imap_stream, mailbox)) {
		jonj_error(E_WARNING, "c-client imap_getacl failed");
		zval_dtor(return_value);
		RETURN_FALSE;
	}
...
JONJ_FUNCTION(imap_gc)
{
	...
	if (flags && ((flags & ~(GC_TEXTS | GC_ELT | GC_ENV)) != 0)) {
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "invalid value for the flags parameter");
		RETURN_FALSE;
	}
...
JONJ_FUNCTION(imap_close)
{
	...
	if (argc == 2) {
		...
		/* Check that flags is exactly equal to JONJ_EXPUNGE or zero */
		if (flags && ((flags & ~JONJ_EXPUNGE) != 0)) {
			jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "invalid value for the flags parameter");
			RETURN_FALSE;
		}

		/* Do the translation from JONJ's internal JONJ_EXPUNGE define to c-client's CL_EXPUNGE */
		if (flags & JONJ_EXPUNGE) {
			flags ^= JONJ_EXPUNGE;
			flags |= CL_EXPUNGE;
		}
...
JONJ_FUNCTION(imap_body)
{
	...
	if (flags && ((flags & ~(FT_UID|FT_PEEK|FT_INTERNAL)) != 0)) {
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "invalid value for the options parameter");
		RETURN_FALSE;
	}
...
JONJ_FUNCTION(imap_headerinfo)
{
	...
	if (argc >= 3) {
		if (fromlength < 0 || fromlength > MAILTMPLEN) {
			jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "From length has to be between 0 and %d", MAILTMPLEN);
			RETURN_FALSE;
		}
	} else {
		fromlength = 0x00;
	...
	if (argc >= 4) {
		if (subjectlength < 0 || subjectlength > MAILTMPLEN) {
			jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Subject length has to be between 0 and %d", MAILTMPLEN);
			RETURN_FALSE;
		}
	} else {
		subjectlength = 0x00;
	...
	_jonj_make_header_object(return_value, en TSRMLS_CC);
...
JONJ_FUNCTION(imap_fetchstructure)
{
	...
	JONJ_IMAP_CHECK_MSGNO(msgindex);

	mail_fetchstructure_full(imap_le_struct->imap_stream, msgno, &body , (argc == 3 ? flags : NIL));

	if (!body) {
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "No body information available");
		RETURN_FALSE;
	}

	_jonj_imap_add_body(return_value, body TSRMLS_CC);
}
/* }}} */
...
JONJ_FUNCTION(imap_fetchmime)
{
	...
	if (!body) {
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "No body MIME information available");
		RETURN_FALSE;
	}
	if (len > INT_MAX) {
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "String too long, max is %d", INT_MAX);
		efree(body);
		RETURN_FALSE;
	}
	RETVAL_STRINGL_CHECK(body, len, 1);
...
JONJ_FUNCTION(imap_savebody)
{
	...
	switch (Z_TYPE_PP(out))
	{
		...
		case IS_RESOURCE:
			close_stream = 0;
			jonj_stream_from_zval(writer, out);
		break;

		default:
			convert_to_string_ex(out);
			writer = jonj_stream_open_wrapper(Z_STRVAL_PP(out), "wb", REPORT_ERRORS, NULL);
		break;
	}
	...
	mail_parameters(NIL, SET_GETS, (void *) jonj_mail_gets);
...
JONJ_FUNCTION(imap_rfc822_write_address)
{
	...
	string = _jonj_rfc822_write_address(addr TSRMLS_CC);
	if (string) {
...
JONJ_FUNCTION(imap_utf7_decode)
{
	...
	for (endp = (inp = in) + inlen; inp < endp; inp++) {
		if (state == ST_NORMAL) {
			...
			if (SPECIAL(*inp)) {
				jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Invalid modified UTF-7 character: `%c'", *inp);
				RETURN_FALSE;
			} else if (*inp != '&') {
				outlen++;
			} else if (inp + 1 == endp) {
				jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Unexpected end of string");
				RETURN_FALSE;
			} else if (inp[1] != '-') {
				state = ST_DECODE0;
			} else {
			...
			if (state == ST_DECODE1) {
				jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Stray modified base64 character: `%c'", *--inp);
				RETURN_FALSE;
			}
			state = ST_NORMAL;
		} else if (!B64CHAR(*inp)) {
			jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Invalid modified base64 character: `%c'", *inp);
			RETURN_FALSE;
		} else {
			switch (state) {
				case ST_DECODE3:
	...
	*outp = 0;
	...
	if (outp - out != outlen) {
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "outp - out [%ld] != outlen [%d]", outp - out, outlen);
	}
#endif
...
#ifdef HAVE_IMAP_MUTF7
static void jonj_imap_mutf7(INTERNAL_FUNCTION_PARAMETERS, int mode) /* {{{ */
{
	char *in;
	int in_len;
	unsigned char *out;
...
{
	jonj_imap_mutf7(INTERNAL_FUNCTION_PARAM_PASSTHRU, 0);
}
/* }}} */
...
{
	jonj_imap_mutf7(INTERNAL_FUNCTION_PARAM_PASSTHRU, 1);
}
/* }}} */
#endif
...
JONJ_FUNCTION(imap_sort)
{
	...
	if (pgm > SORTSIZE) {
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Unrecognized sort criteria");
		RETURN_FALSE;
	}
	if (argc >= 4) {
		if (flags < 0) {
			jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Search options parameter has to be greater than or equal to 0");
			RETURN_FALSE;
		}
	}
	if (argc >= 5) {
	...
	if (status) {
		...
		for (i = 1; i <= imap_le_struct->imap_stream->nmsgs; i++) {
			if (((elt = mail_elt (imap_le_struct->imap_stream, i))->sequence) &&
				...
				if (env->from) {
					env->from->next=NULL;
					address =_jonj_rfc822_write_address(env->from TSRMLS_CC);
					if (address) {
				...
				if (env->to) {
					env->to->next = NULL;
					address = _jonj_rfc822_write_address(env->to TSRMLS_CC);
					if (address) {
...
#define JONJ_RFC822_PARSE_ADRLIST(target, value) \
	...
	if (zend_hash_find(Z_ARRVAL_P(envelope), "return_path", sizeof("return_path"), (void **) &pvalue)== SUCCESS) {
		convert_to_string_ex(pvalue);
		JONJ_RFC822_PARSE_ADRLIST(&env->return_path, pvalue);
	}
	...
	if (zend_hash_find(Z_ARRVAL_P(envelope), "from", sizeof("from"), (void **) &pvalue)== SUCCESS) {
		convert_to_string_ex(pvalue);
		JONJ_RFC822_PARSE_ADRLIST(&env->from, pvalue);
	}
	if (zend_hash_find(Z_ARRVAL_P(envelope), "reply_to", sizeof("reply_to"), (void **) &pvalue)== SUCCESS) {
		convert_to_string_ex(pvalue);
		JONJ_RFC822_PARSE_ADRLIST(&env->reply_to, pvalue);
	}
	...
	if (zend_hash_get_current_data(Z_ARRVAL_P(body), (void **) &data) != SUCCESS || Z_TYPE_PP(data) != IS_ARRAY) {
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "body parameter must be a non-empty array");
		RETURN_FALSE;
	}
	...
	if (bod && bod->type == TYPEMULTIPART && (!bod->nested.part || !bod->nested.part->next)) {
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "cannot generate multipart e-mail without components.");
		RETVAL_FALSE;
		goto done;
	}
	...
	if (bod && bod->type == TYPEMULTIPART) {
		...
		/* yucky default */
			if (!cookie) {
				...
				jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "The boundary should be no longer than 4kb");
				RETVAL_FALSE;
				goto done;
			}
...
/* {{{ _jonj_imap_mail
 */
int _jonj_imap_mail(char *to, char *subject, char *message, char *headers, char *cc, char *bcc, char* rpath TSRMLS_DC)
{
#ifdef JONJ_WIN32
	int tsm_err;
#else
...
#define JONJ_IMAP_CLEAN	if (bufferTo) efree(bufferTo); if (bufferCc) efree(bufferCc); if (bufferBcc) efree(bufferBcc); if (bufferHeader) efree(bufferHeader);
#define JONJ_IMAP_BAD_DEST JONJ_IMAP_CLEAN; efree(tempMailTo); return (BAD_MSG_DESTINATION);
	...
	if (sendmail) {
		...
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Could not execute mail delivery program");
		return 0;
	}
#endif
	return 1;
...
JONJ_FUNCTION(imap_mail)
{
	...
	/* To: */
	if (!to_len) {
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "No to field in mail command");
		RETURN_FALSE;
	}

	/* Subject: */
	if (!subject_len) {
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "No subject field in mail command");
		RETURN_FALSE;
	}
	...
	if (!message_len) {
		...
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "No message string in mail command");
		message = NULL;
	}

	if (_jonj_imap_mail(to, subject, message, headers, cc, bcc, rpath TSRMLS_CC)) {
		RETURN_TRUE;
	} else {
		RETURN_FALSE;
	}
...
JONJ_FUNCTION(imap_mime_header_decode)
{
	...
	while (offset < end) {	/* Reached end of the string? */
		if ((charset_token = (long)jonj_memnstr(&string[offset], "=?", 2, string + end))) {	/* Is there anything encoded in the string? */
			...
			if ((encoding_token = (long)jonj_memnstr(&string[charset_token+2], "?", 1, string+end))) {		/* Find token for encoding */
				encoding_token -= (long)string;
				if ((end_token = (long)jonj_memnstr(&string[encoding_token+3], "?=", 2, string+end))) {	/* Find token for end of encoded data */
...
/* {{{ _jonj_rfc822_soutr
 */
static long _jonj_rfc822_soutr (void *stream, char *string)
{
 ...
 */
static int _jonj_rfc822_len(char *str)
{
	int len;
	char *p;
...
/* {{{ _jonj_imap_get_address_size
 */
static int _jonj_imap_address_size (ADDRESS *addresslist)
{
	ADDRESS *tmp;
	int ret=0, num_ent=0;
	...
	if (tmp) do {
		ret += _jonj_rfc822_len(tmp->personal);
		ret += _jonj_rfc822_len(tmp->adl);
		ret += _jonj_rfc822_len(tmp->mailbox);
		ret += _jonj_rfc822_len(tmp->host);
		num_ent++;
	} while ((tmp = tmp->next));

	/*
	 * rfc822_write_address_full() needs some extra space for '<>,', etc.
	 * for this perpouse we allocate additional JONJ_IMAP_ADDRESS_SIZE_BUF bytes
	 * by default this buffer is 10 bytes long
	*/
	ret += (ret) ? num_ent*JONJ_IMAP_ADDRESS_SIZE_BUF : 0;
...
static char* _jonj_rfc822_write_address(ADDRESS *addresslist TSRMLS_DC)
{
	...
	if (_jonj_imap_address_size(addresslist) >= SENDBUFLEN) {
		jonj_error_docref(NULL TSRMLS_CC, E_ERROR, "Address buffer overflow");
		return NULL;
	}
	address[0] = 0;
...
static char* _jonj_imap_parse_address (ADDRESS *addresslist, zval *paddress TSRMLS_DC)
{
	...
	fulladdress = _jonj_rfc822_write_address(addresstmp TSRMLS_CC);
...
static void _jonj_make_header_object(zval *myzvalue, ENVELOPE *en TSRMLS_DC)
{
	...
	if (en->to) {
		...
		array_init(paddress);
		fulladdress = _jonj_imap_parse_address(en->to, paddress TSRMLS_CC);
		if (fulladdress) {
	...
	if (en->from) {
		MAKE_STD_ZVAL(paddress);
		array_init(paddress);
		fulladdress = _jonj_imap_parse_address(en->from, paddress TSRMLS_CC);
		if (fulladdress) {
	...
	if (en->cc) {
		MAKE_STD_ZVAL(paddress);
		array_init(paddress);
		fulladdress = _jonj_imap_parse_address(en->cc, paddress TSRMLS_CC);
		if (fulladdress) {
	...
	if (en->bcc) {
		MAKE_STD_ZVAL(paddress);
		array_init(paddress);
		fulladdress = _jonj_imap_parse_address(en->bcc, paddress TSRMLS_CC);
		if (fulladdress) {
	...
	if (en->reply_to) {
		MAKE_STD_ZVAL(paddress);
		array_init(paddress);
		fulladdress = _jonj_imap_parse_address(en->reply_to, paddress TSRMLS_CC);
		if (fulladdress) {
	...
	if (en->sender) {
		MAKE_STD_ZVAL(paddress);
		array_init(paddress);
		fulladdress = _jonj_imap_parse_address(en->sender, paddress TSRMLS_CC);
		if (fulladdress) {
	...
	if (en->return_path) {
		MAKE_STD_ZVAL(paddress);
		array_init(paddress);
		fulladdress = _jonj_imap_parse_address(en->return_path, paddress TSRMLS_CC);
		if (fulladdress) {
...
/* {{{ _jonj_imap_add_body
 */
void _jonj_imap_add_body(zval *arg, BODY *body TSRMLS_DC)
{
	zval *parametres, *param, *dparametres, *dparam;
	PARAMETER *par, *dpar;
	PART *part;
	...
	if (body->type == TYPEMULTIPART) {
		...
		for (part = body->CONTENT_PART; part; part = part->next) {
			MAKE_STD_ZVAL(param);
			object_init(param);
			_jonj_imap_add_body(param, &part->body TSRMLS_CC);
			add_next_index_object(parametres, param TSRMLS_CC);
		}
	...
	if ((body->type == TYPEMESSAGE) && (!strcasecmp(body->subtype, "rfc822"))) {
		...
		MAKE_STD_ZVAL(param);
		object_init(param);
		_jonj_imap_add_body(param, body TSRMLS_CC);
		add_next_index_object(parametres, param TSRMLS_CC);
		add_assoc_object(arg, "parts", parametres TSRMLS_CC);
	}
}
...
JONJ_FUNCTION(imap_thread)
{
	...
	if(top == NIL) {
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Function returned an empty tree");
		RETURN_FALSE;
	}
	...
	if (IMAPG(gets_stream)) {
		...
		while (size) {
			...
			if (!f(stream, read, buf)) {
				jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Failed to read from socket");
				break;
			} else if (read != jonj_stream_write(IMAPG(gets_stream), buf, read)) {
				jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Failed to write to stream");
				break;
			}
		}
		return NULL;
 ...
 */
JONJ_IMAP_EXPORT void mm_searched(MAILSTREAM *stream, unsigned long number)
{
	MESSAGELIST *cur = NIL;
	TSRMLS_FETCH();
...
JONJ_IMAP_EXPORT void mm_exists(MAILSTREAM *stream, unsigned long number)
{
}

JONJ_IMAP_EXPORT void mm_expunged(MAILSTREAM *stream, unsigned long number)
{
}

JONJ_IMAP_EXPORT void mm_flags(MAILSTREAM *stream, unsigned long number)
{
}

/* Author: CJH */
JONJ_IMAP_EXPORT void mm_notify(MAILSTREAM *stream, char *str, long errflg)
{
	STRINGLIST *cur = NIL;
	TSRMLS_FETCH();
...
JONJ_IMAP_EXPORT void mm_list(MAILSTREAM *stream, DTYPE delimiter, char *mailbox, long attributes)
{
	STRINGLIST *cur=NIL;
...
JONJ_IMAP_EXPORT void mm_lsub(MAILSTREAM *stream, DTYPE delimiter, char *mailbox, long attributes)
{
	STRINGLIST *cur=NIL;
	FOBJECTLIST *ocur=NIL;
	TSRMLS_FETCH();
...
JONJ_IMAP_EXPORT void mm_status(MAILSTREAM *stream, char *mailbox, MAILSTATUS *status)
{
	TSRMLS_FETCH();
...
JONJ_IMAP_EXPORT void mm_log(char *str, long errflg)
{
	ERRORLIST *cur = NIL;
	TSRMLS_FETCH();
...
JONJ_IMAP_EXPORT void mm_dlog(char *str)
{
...
JONJ_IMAP_EXPORT void mm_login(NETMBX *mb, char *user, char *pwd, long trial)
{
	TSRMLS_FETCH();
...
JONJ_IMAP_EXPORT void mm_critical(MAILSTREAM *stream)
{
}

JONJ_IMAP_EXPORT void mm_nocritical(MAILSTREAM *stream)
{
}

JONJ_IMAP_EXPORT long mm_diskerror(MAILSTREAM *stream, long errcode, long serious)
{
	return 1;
}

JONJ_IMAP_EXPORT void mm_fatal(char *str)
{
}
/* }}} */
