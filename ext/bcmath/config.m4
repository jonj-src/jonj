...
JONJ_ARG_ENABLE(bcmath, whether to enable bc style precision math functions,
[  --enable-bcmath         Enable bc style precision math functions])

if test "$JONJ_BCMATH" != "no"; then
  JONJ_NEW_EXTENSION(bcmath, bcmath.c \
...
libbcmath/src/rmzero.c libbcmath/src/str2num.c,
  ...
  JONJ_ADD_BUILD_DIR($ext_builddir/libbcmath/src)
