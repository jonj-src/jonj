...
const zend_function_entry jonj_dom_domimplementationlist_class_functions[] = {
	JONJ_FALIAS(item, dom_domimplementationlist_item, arginfo_dom_implementationlist_item)
	{NULL, NULL, NULL}
};
