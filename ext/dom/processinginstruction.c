...
const zend_function_entry jonj_dom_processinginstruction_class_functions[] = {
	JONJ_ME(domprocessinginstruction, __construct, arginfo_dom_processinginstruction_construct, ZEND_ACC_PUBLIC)
	JONJ_FE_END
};
