...
const zend_function_entry jonj_dom_entityreference_class_functions[] = {
	JONJ_ME(domentityreference, __construct, arginfo_dom_entityreference_construct, ZEND_ACC_PUBLIC)
	JONJ_FE_END
};
...
JONJ_METHOD(domentityreference, __construct)
{
	...
	if (intern != NULL) {
		...
		jonj_libxml_increment_node_ptr((jonj_libxml_node_object *)intern, node, (void *)intern TSRMLS_CC);
	}
}
