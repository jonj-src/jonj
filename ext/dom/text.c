...
const zend_function_entry jonj_dom_text_class_functions[] = {
	JONJ_FALIAS(splitText, dom_text_split_text, arginfo_dom_text_split_text)
	JONJ_FALIAS(isWhitespaceInElementContent, dom_text_is_whitespace_in_element_content, arginfo_dom_text_is_whitespace_in_element_content)
	JONJ_FALIAS(isElementContentWhitespace, dom_text_is_whitespace_in_element_content, arginfo_dom_text_is_whitespace_in_element_content)
	JONJ_FALIAS(replaceWholeText, dom_text_replace_whole_text, arginfo_dom_text_replace_whole_text)
	JONJ_ME(domtext, __construct, arginfo_dom_text_construct, ZEND_ACC_PUBLIC)
	JONJ_FE_END
};
...
JONJ_FUNCTION(dom_text_split_text)
{
	...
	return_value = jonj_dom_create_object(nnode, &ret, return_value, intern TSRMLS_CC);
}
