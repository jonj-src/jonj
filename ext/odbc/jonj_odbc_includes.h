...
#ifndef JONJ_ODBC_INCLUDES_H
#define JONJ_ODBC_INCLUDES_H
...
#  include <sqlunix.h>
# endif		/* end: #if !defined(JONJ_WIN32) */
# include <sqltypes.h>
# include <sqlucode.h>
# include <sqlext.h>
# include <sql.h>
...
#define JONJ_ODBC_SQLCOLATTRIBUTE SQLColAttribute
#define JONJ_ODBC_SQLALLOCSTMT(hdbc, phstmt) SQLAllocHandle(SQL_HANDLE_STMT, hdbc, phstmt)

#define JONJ_ODBC_SQL_DESC_NAME SQL_DESC_NAME
#else
#define IS_SQL_LONG(x) (x == SQL_LONGVARBINARY || x == SQL_LONGVARCHAR)

#define JONJ_ODBC_SQLCOLATTRIBUTE SQLColAttributes
#define JONJ_ODBC_SQLALLOCSTMT SQLAllocStmt

#define JONJ_ODBC_SQL_DESC_NAME SQL_COLUMN_NAME
#endif
