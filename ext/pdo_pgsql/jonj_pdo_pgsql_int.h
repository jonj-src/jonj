...
#ifndef JONJ_PDO_PGSQL_INT_H
#define JONJ_PDO_PGSQL_INT_H

#include <libpq-fe.h>
#include <libpq/libpq-fs.h>
#include <jonj.h>

#define JONJ_PDO_PGSQL_CONNECTION_FAILURE_SQLSTATE "08006"
...
jonj_stream *pdo_pgsql_create_lob_stream(pdo_dbh_t *stmt, int lfd, Oid oid TSRMLS_DC);
extern jonj_stream_ops pdo_pgsql_lob_stream_ops;

#endif /* JONJ_PDO_PGSQL_INT_H */
