...
static const jonj_hash_uint32 D0[8] = {
	0x243F6A88, 0x85A308D3, 0x13198A2E, 0x03707344, 0xA4093822, 0x299F31D0, 0x082EFA98, 0xEC4E6C89 };

static const jonj_hash_uint32 K2[32] = {
	0x452821E6, 0x38D01377, 0xBE5466CF, 0x34E90C6C, 0xC0AC29B7, 0xC97C50DD, 0x3F84D5B5, 0xB5470917,
	0x9216D5D9, 0x8979FB1B, 0xD1310BA6, 0x98DFB5AC, 0x2FFD72DB, 0xD01ADFB7, 0xB8E1AFED, 0x6A267E96,
	0xBA7C9045, 0xF12C7F99, 0x24A19947, 0xB3916CF7, 0x0801F2E2, 0x858EFC16, 0x636920D8, 0x71574E69,
	0xA458FEA3, 0xF4933D7E, 0x0D95748F, 0x728EB658, 0x718BCD58, 0x82154AEE, 0x7B54A41D, 0xC25A59B5 };

static const jonj_hash_uint32 K3[32] = {
...
static const jonj_hash_uint32 K4[32] = {
...
static const jonj_hash_uint32 K5[32] = {
...
/* {{{ Encode
   ...
   a multiple of 4.
 */
static void Encode(unsigned char *output, jonj_hash_uint32 *input, unsigned int len)
{
	unsigned int i, j;
...
/* {{{ Decode
   ...
   a multiple of 4.
 */
static void Decode(jonj_hash_uint32 *output, const unsigned char *input, unsigned int len)
{
	unsigned int i, j;

	for (i = 0, j = 0; j < len; i++, j += 4) {
		output[i] = ((jonj_hash_uint32) input[j]) | (((jonj_hash_uint32) input[j + 1]) << 8) |
...
/* {{{ JONJ_3HAVALTransform
 */
static void JONJ_3HAVALTransform(jonj_hash_uint32 state[8], const unsigned char block[128])
{
	jonj_hash_uint32 E[8];
	jonj_hash_uint32 x[32];
	int i;
...
/* {{{ JONJ_4HAVALTransform
 */
static void JONJ_4HAVALTransform(jonj_hash_uint32 state[8], const unsigned char block[128])
{
	jonj_hash_uint32 E[8];
	jonj_hash_uint32 x[32];
	int i;
...
/* {{{ JONJ_5HAVALTransform
 */
static void JONJ_5HAVALTransform(jonj_hash_uint32 state[8], const unsigned char block[128])
{
	jonj_hash_uint32 E[8];
	jonj_hash_uint32 x[32];
	int i;
...
#define JONJ_HASH_HAVAL_INIT(p,b) \
const jonj_hash_ops jonj_hash_##p##haval##b##_ops = { \
	(jonj_hash_init_func_t) JONJ_##p##HAVAL##b##Init, \
	(jonj_hash_update_func_t) JONJ_HAVALUpdate, \
	(jonj_hash_final_func_t) JONJ_HAVAL##b##Final, \
	(jonj_hash_copy_func_t) jonj_hash_copy, \
	((b) / 8), 128, sizeof(JONJ_HAVAL_CTX) }; \
JONJ_HASH_API void JONJ_##p##HAVAL##b##Init(JONJ_HAVAL_CTX *context) \
{	int i; context->count[0] = 	context->count[1] = 	0; \
	for(i = 0; i < 8; i++) context->state[i] = D0[i]; \
	context->passes = p;	context->output = b; \
	context->Transform = JONJ_##p##HAVALTransform; }

JONJ_HASH_HAVAL_INIT(3,128)
JONJ_HASH_HAVAL_INIT(3,160)
JONJ_HASH_HAVAL_INIT(3,192)
JONJ_HASH_HAVAL_INIT(3,224)
JONJ_HASH_HAVAL_INIT(3,256)

JONJ_HASH_HAVAL_INIT(4,128)
JONJ_HASH_HAVAL_INIT(4,160)
JONJ_HASH_HAVAL_INIT(4,192)
JONJ_HASH_HAVAL_INIT(4,224)
JONJ_HASH_HAVAL_INIT(4,256)

JONJ_HASH_HAVAL_INIT(5,128)
JONJ_HASH_HAVAL_INIT(5,160)
JONJ_HASH_HAVAL_INIT(5,192)
JONJ_HASH_HAVAL_INIT(5,224)
JONJ_HASH_HAVAL_INIT(5,256)

/* {{{ JONJ_HAVALUpdate
 */
JONJ_HASH_API void JONJ_HAVALUpdate(JONJ_HAVAL_CTX *context, const unsigned char *input, unsigned int inputLen)
{
...
#define JONJ_HASH_HAVAL_VERSION	0x01

/* {{{ JONJ_HAVAL128Final
 */
JONJ_HASH_API void JONJ_HAVAL128Final(unsigned char *digest, JONJ_HAVAL_CTX * context)
{
	unsigned char bits[10];
	unsigned int index, padLen;

	/* Version, Passes, and Digest Length */
	bits[0] =	(JONJ_HASH_HAVAL_VERSION & 0x07) |
	...
	JONJ_HAVALUpdate(context, PADDING, padLen);

	/* Append version, passes, digest length, and message length */
	JONJ_HAVALUpdate(context, bits, 10);
...
/* {{{ JONJ_HAVAL160Final
 */
JONJ_HASH_API void JONJ_HAVAL160Final(unsigned char *digest, JONJ_HAVAL_CTX * context)
{
	unsigned char bits[10];
	unsigned int index, padLen;
...
/* {{{ JONJ_HAVAL192Final
 */
JONJ_HASH_API void JONJ_HAVAL192Final(unsigned char *digest, JONJ_HAVAL_CTX * context)
{
	unsigned char bits[10];
	unsigned int index, padLen;
...
/* {{{ JONJ_HAVAL224Final
 */
JONJ_HASH_API void JONJ_HAVAL224Final(unsigned char *digest, JONJ_HAVAL_CTX * context)
{
	unsigned char bits[10];
	unsigned int index, padLen;
...
/* {{{ JONJ_HAVAL256Final
 */
JONJ_HASH_API void JONJ_HAVAL256Final(unsigned char *digest, JONJ_HAVAL_CTX * context)
{
	unsigned char bits[10];
	unsigned int index, padLen;
