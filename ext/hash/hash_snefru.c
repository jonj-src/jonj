...
#include "jonj_hash.h"
#include "jonj_hash_snefru.h"
#include "jonj_hash_snefru_tables.h"
...
static inline void Snefru(jonj_hash_uint32 input[16])
{
	static int shifts[4] = {16, 8, 16, 24};
	int b, index, rshift, lshift;
	const jonj_hash_uint32 *t0,*t1;
	jonj_hash_uint32 SBE,B00,B01,B02,B03,B04,B05,B06,B07,B08,B09,B10,B11,B12,B13,B14,B15;
...
static inline void SnefruTransform(JONJ_SNEFRU_CTX *context, const unsigned char input[32])
{
	int i, j;
	...
	memset(&context->state[8], 0, sizeof(jonj_hash_uint32) * 8);
}

JONJ_HASH_API void JONJ_SNEFRUInit(JONJ_SNEFRU_CTX *context)
{
...
JONJ_HASH_API void JONJ_SNEFRUUpdate(JONJ_SNEFRU_CTX *context, const unsigned char *input, size_t len)
{
...
JONJ_HASH_API void JONJ_SNEFRUFinal(unsigned char digest[32], JONJ_SNEFRU_CTX *context)
{
	jonj_hash_uint32 i, j;
...
const jonj_hash_ops jonj_hash_snefru_ops = {
	(jonj_hash_init_func_t) JONJ_SNEFRUInit,
	(jonj_hash_update_func_t) JONJ_SNEFRUUpdate,
	(jonj_hash_final_func_t) JONJ_SNEFRUFinal,
	(jonj_hash_copy_func_t) jonj_hash_copy,
	32,
	32,
	sizeof(JONJ_SNEFRU_CTX)
};
