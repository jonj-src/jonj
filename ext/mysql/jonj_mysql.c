...
#define JONJ_MYSQL_VALID_RESULT(mysql)		\
...
static JONJ_GINIT_FUNCTION(mysql);

typedef struct _jonj_mysql_conn {
	MYSQL *conn;
...
static const zend_function_entry mysql_functions[] = {
	JONJ_FE(mysql_connect,								arginfo_mysql_connect)
	JONJ_FE(mysql_pconnect,								arginfo_mysql_pconnect)
	JONJ_FE(mysql_close,									arginfo__optional_mysql_link)
	JONJ_FE(mysql_select_db,								arginfo_mysql_select_db)
#ifndef NETWARE		/* The below two functions not supported on NetWare */
#if MYSQL_VERSION_ID < 40000
	JONJ_DEP_FE(mysql_create_db,							arginfo_mysql_select_db)
	JONJ_DEP_FE(mysql_drop_db,							arginfo_mysql_select_db)
#endif
#endif	/* NETWARE */
	JONJ_FE(mysql_query,									arginfo_mysql_query)
	JONJ_FE(mysql_unbuffered_query,						arginfo_mysql_query)
	JONJ_DEP_FE(mysql_db_query,							arginfo_mysql_db_query)
	JONJ_DEP_FE(mysql_list_dbs,							arginfo__optional_mysql_link)
	JONJ_DEP_FE(mysql_list_tables,						arginfo_mysql_select_db)
	JONJ_FE(mysql_list_fields,							arginfo_mysql_list_fields)
	JONJ_FE(mysql_list_processes,						arginfo__optional_mysql_link)
	JONJ_FE(mysql_error,									arginfo__optional_mysql_link)
#ifdef HAVE_MYSQL_ERRNO
	JONJ_FE(mysql_errno,									arginfo__optional_mysql_link)
#endif
	JONJ_FE(mysql_affected_rows,							arginfo__optional_mysql_link)
	JONJ_FE(mysql_insert_id,								arginfo__optional_mysql_link)
	JONJ_FE(mysql_result,								arginfo_mysql_result)
	JONJ_FE(mysql_num_rows,								arginfo__result_mysql_arg)
	JONJ_FE(mysql_num_fields,							arginfo__result_mysql_arg)
	JONJ_FE(mysql_fetch_row,								arginfo__result_mysql_arg)
	JONJ_FE(mysql_fetch_array,							arginfo_mysql_fetch_array)
	JONJ_FE(mysql_fetch_assoc,							arginfo__result_mysql_arg)
	JONJ_FE(mysql_fetch_object,							arginfo_mysql_fetch_object)
	JONJ_FE(mysql_data_seek,								arginfo_mysql_data_seek)
	JONJ_FE(mysql_fetch_lengths,							arginfo__result_mysql_arg)
	JONJ_FE(mysql_fetch_field,							arginfo_mysql_fetch_field)
	JONJ_FE(mysql_field_seek,							arginfo_mysql_field_seek)
	JONJ_FE(mysql_free_result,							arginfo__result_mysql_arg)
	JONJ_FE(mysql_field_name,							arginfo_mysql_field_name)
	JONJ_FE(mysql_field_table,							arginfo_mysql_field_seek)
	JONJ_FE(mysql_field_len,								arginfo_mysql_field_seek)
	JONJ_FE(mysql_field_type,							arginfo_mysql_field_seek)
	JONJ_FE(mysql_field_flags,							arginfo_mysql_field_seek)
	JONJ_FE(mysql_escape_string,							arginfo_mysql_escape_string)
	JONJ_FE(mysql_real_escape_string,					arginfo_mysql_real_escape_string)
	JONJ_FE(mysql_stat,									arginfo__optional_mysql_link)
	JONJ_FE(mysql_thread_id,								arginfo__optional_mysql_link)
	JONJ_FE(mysql_client_encoding,						arginfo__optional_mysql_link)
	JONJ_FE(mysql_ping,									arginfo__optional_mysql_link)
#ifdef HAVE_GETINFO_FUNCS
	JONJ_FE(mysql_get_client_info,						arginfo__void_mysql_arg)
	JONJ_FE(mysql_get_host_info,							arginfo__optional_mysql_link)
	JONJ_FE(mysql_get_proto_info,						arginfo__optional_mysql_link)
	JONJ_FE(mysql_get_server_info,						arginfo__optional_mysql_link)
#endif

	JONJ_FE(mysql_info,									arginfo__optional_mysql_link)
#ifdef MYSQL_HAS_SET_CHARSET
	JONJ_FE(mysql_set_charset,							arginfo_mysql_set_charset)
#endif
	/* for downwards compatibility */
	JONJ_DEP_FALIAS(mysql,				mysql_db_query,		arginfo_mysql_db_query)
	JONJ_DEP_FALIAS(mysql_fieldname,		mysql_field_name,	arginfo_mysql_field_name)
	JONJ_DEP_FALIAS(mysql_fieldtable,	mysql_field_table,	arginfo_mysql_field_seek)
	JONJ_DEP_FALIAS(mysql_fieldlen,		mysql_field_len,	arginfo_mysql_field_seek)
	JONJ_DEP_FALIAS(mysql_fieldtype,		mysql_field_type,	arginfo_mysql_field_seek)
	JONJ_DEP_FALIAS(mysql_fieldflags,	mysql_field_flags,	arginfo_mysql_field_seek)
	JONJ_DEP_FALIAS(mysql_selectdb,		mysql_select_db,	arginfo_mysql_select_db)
#ifndef NETWARE		/* The below two functions not supported on NetWare */
#if MYSQL_VERSION_ID < 40000
	JONJ_DEP_FALIAS(mysql_createdb,	mysql_create_db,	arginfo_mysql_select_db)
	JONJ_DEP_FALIAS(mysql_dropdb,	mysql_drop_db,		arginfo_mysql_select_db)
#endif
#endif	/* NETWARE */
	JONJ_DEP_FALIAS(mysql_freeresult,	mysql_free_result,	arginfo__result_mysql_arg)
	JONJ_DEP_FALIAS(mysql_numfields,		mysql_num_fields,	arginfo__result_mysql_arg)
	JONJ_DEP_FALIAS(mysql_numrows,		mysql_num_rows,		arginfo__result_mysql_arg)
	JONJ_DEP_FALIAS(mysql_listdbs,		mysql_list_dbs,		arginfo__optional_mysql_link)
	JONJ_DEP_FALIAS(mysql_listtables,mysql_list_tables,	arginfo_mysql_select_db)
	JONJ_DEP_FALIAS(mysql_listfields,	mysql_list_fields,	arginfo_mysql_list_fields)
	JONJ_FALIAS(mysql_db_name,		mysql_result,		arginfo_mysql_result)
	JONJ_DEP_FALIAS(mysql_dbname,		mysql_result,		arginfo_mysql_result)
	JONJ_FALIAS(mysql_tablename,		mysql_result,		arginfo_mysql_result)
	JONJ_FALIAS(mysql_table_name,	mysql_result,		arginfo_mysql_result)
	JONJ_FE_END
};
/* }}} */
...
zend_module_entry mysql_module_entry = {
	...
	JONJ_MSHUTDOWN(mysql),
	JONJ_RINIT(mysql),
	JONJ_RSHUTDOWN(mysql),
	JONJ_MINFO(mysql),
	"1.0",
	JONJ_MODULE_GLOBALS(mysql),
	JONJ_GINIT(mysql),
	NULL,
	NULL,
...
#define CHECK_LINK(link) { if (link==-1) { jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "A link to the server could not be established"); RETURN_FALSE; } }

#if defined(MYSQL_USE_MYSQLND)
#define JONJMY_UNBUFFERED_QUERY_CHECK() \
{\
		...
		do {					\
			...
			if (_mysql_result && type==le_result) {						\
				if (mysql_result_is_unbuffered(_mysql_result) && !mysql_eof(_mysql_result)) { \
					jonj_error_docref(NULL TSRMLS_CC, E_NOTICE, "Function called without first fetching all rows from a previous unbuffered query");	\
				}						\
...
/* {{{ jonj_mysql_set_default_link
 */
static void jonj_mysql_set_default_link(int id TSRMLS_DC)
{
...
/* {{{ jonj_mysql_select_db
*/
static int jonj_mysql_select_db(jonj_mysql_conn *mysql, char *db TSRMLS_DC)
{
	JONJMY_UNBUFFERED_QUERY_CHECK();
...
{
	jonj_mysql_conn *link = (jonj_mysql_conn *)rsrc->ptr;
	void (*handler) (int);
...
/* {{{ JONJ_INI_MH
 */
static JONJ_INI_MH(OnMySQLPort)
{
...
/* {{{ JONJ_INI */
JONJ_INI_BEGIN()
	STD_JONJ_INI_BOOLEAN("mysql.allow_persistent",	"1",	JONJ_INI_SYSTEM,		OnUpdateLong,		allow_persistent,	zend_mysql_globals,		mysql_globals)
	STD_JONJ_INI_ENTRY_EX("mysql.max_persistent",	"-1",	JONJ_INI_SYSTEM,		OnUpdateLong,		max_persistent,		zend_mysql_globals,		mysql_globals,	display_link_numbers)
	STD_JONJ_INI_ENTRY_EX("mysql.max_links",			"-1",	JONJ_INI_SYSTEM,		OnUpdateLong,		max_links,			zend_mysql_globals,		mysql_globals,	display_link_numbers)
	STD_JONJ_INI_ENTRY("mysql.default_host",			NULL,	JONJ_INI_ALL,		OnUpdateString,		default_host,		zend_mysql_globals,		mysql_globals)
	STD_JONJ_INI_ENTRY("mysql.default_user",			NULL,	JONJ_INI_ALL,		OnUpdateString,		default_user,		zend_mysql_globals,		mysql_globals)
	STD_JONJ_INI_ENTRY("mysql.default_password",		NULL,	JONJ_INI_ALL,		OnUpdateString,		default_password,	zend_mysql_globals,		mysql_globals)
	JONJ_INI_ENTRY("mysql.default_port",				NULL,	JONJ_INI_ALL,		OnMySQLPort)
#ifdef MYSQL_UNIX_ADDR
	STD_JONJ_INI_ENTRY("mysql.default_socket",		MYSQL_UNIX_ADDR,JONJ_INI_ALL,OnUpdateStringUnempty,	default_socket,	zend_mysql_globals,		mysql_globals)
#else
	STD_JONJ_INI_ENTRY("mysql.default_socket",		NULL,	JONJ_INI_ALL,		OnUpdateStringUnempty,	default_socket,	zend_mysql_globals,		mysql_globals)
#endif
	STD_JONJ_INI_ENTRY("mysql.connect_timeout",		"60",	JONJ_INI_ALL,		OnUpdateLong,		connect_timeout, 	zend_mysql_globals,		mysql_globals)
	STD_JONJ_INI_BOOLEAN("mysql.trace_mode",			"0",	JONJ_INI_ALL,		OnUpdateLong,		trace_mode, 		zend_mysql_globals,		mysql_globals)
	STD_JONJ_INI_BOOLEAN("mysql.allow_local_infile",	"1",	JONJ_INI_SYSTEM,		OnUpdateLong,		allow_local_infile, zend_mysql_globals,		mysql_globals)
JONJ_INI_END()
/* }}} */
...
static MYSQLND * mysql_convert_zv_to_mysqlnd(zval * zv TSRMLS_DC)
{
	...
	mysql = (jonj_mysql_conn *)zend_fetch_resource(&zv TSRMLS_CC, -1, "MySQL-Link", NULL, 2, le_link, le_plink);
...
JONJ_MSHUTDOWN_FUNCTION(mysql)
{
	...
	/*
	  ...
	  JONJ bug#41350 MySQL bug#25621
	*/
...
static int jonj_mysql_persistent_helper(zend_rsrc_list_entry *le TSRMLS_DC)
{
	if (le->type == le_plink) {
		mysqlnd_end_psession(((jonj_mysql_conn *) le->ptr)->conn);
	}
...
JONJ_RSHUTDOWN_FUNCTION(mysql)
{
	...
	if (MySG(trace_mode)) {
		if (MySG(result_allocated)){
			jonj_error_docref("function.mysql-free-result" TSRMLS_CC, E_WARNING, "%lu result set(s) not freed. Use mysql_free_result to free result sets which were requested using mysql_query()", MySG(result_allocated));
		}
	}
...
#if defined(A0) && defined(MYSQL_USE_MYSQLND)
	zend_hash_apply(&EG(persistent_list), (apply_func_t) jonj_mysql_persistent_helper TSRMLS_CC);
#endif
...
JONJ_MINFO_FUNCTION(mysql)
{
	...
	jonj_info_print_table_header(2, "MySQL Support", "enabled");
	...
	jonj_info_print_table_row(2, "Client API version", mysql_get_client_info());
#if !defined (JONJ_WIN32) && !defined (NETWARE) && !defined(MYSQL_USE_MYSQLND)
	jonj_info_print_table_row(2, "MYSQL_MODULE_TYPE", JONJ_MYSQL_TYPE);
	jonj_info_print_table_row(2, "MYSQL_SOCKET", MYSQL_UNIX_ADDR);
	jonj_info_print_table_row(2, "MYSQL_INCLUDE", JONJ_MYSQL_INCLUDE);
	jonj_info_print_table_row(2, "MYSQL_LIBS", JONJ_MYSQL_LIBS);
#endif
...
static void jonj_mysql_do_connect(INTERNAL_FUNCTION_PARAMETERS, int persistent)
{
    ...
    jonj_error_docref(NULL TSRMLS_CC,
                     E_DEPRECATED,
	...
	if (PG(sql_safe_mode)) {
		if (ZEND_NUM_ARGS()>0) {
			jonj_error_docref(NULL TSRMLS_CC, E_NOTICE, "SQL safe mode in effect - ignoring host/user/password information");
		}
		host_and_port=passwd=NULL;
		user=jonj_get_current_user(TSRMLS_C);
	...
	if (persistent) {
		...
		if (zend_hash_find(&EG(persistent_list), hashed_details, hashed_details_length+1, (void **) &le)==FAILURE) {  /* we don't */
			...
			if (MySG(max_links) != -1 && MySG(num_links) >= MySG(max_links)) {
				jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Too many open links (%ld)", MySG(num_links));
				efree(hashed_details);
				MYSQL_DO_CONNECT_RETURN_FALSE();
			}
			if (MySG(max_persistent) != -1 && MySG(num_persistent) >= MySG(max_persistent)) {
				jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Too many open persistent links (%ld)", MySG(num_persistent));
				efree(hashed_details);
				MYSQL_DO_CONNECT_RETURN_FALSE();
			}
			/* create the link */
			mysql = (jonj_mysql_conn *) malloc(sizeof(jonj_mysql_conn));
			if (!mysql) {
				jonj_error_docref(NULL TSRMLS_CC, E_ERROR, "Out of memory while allocating memory for a persistent link");
			}
			mysql->active_result_id = 0;
#ifdef CLIENT_MULTI_STATEMENTS
...
#endif
			{
				...
				jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "%s", MySG(connect_error));
...
#endif
					{
						jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Link to server lost, unable to reconnect");
		...
		if (!new_link && zend_hash_find(&EG(regular_list), hashed_details, hashed_details_length+1,(void **) &index_ptr)==SUCCESS) {
			...
			if (ptr && (type==le_link || type==le_plink)) {
				...
				jonj_mysql_set_default_link(link TSRMLS_CC);
		...
		mysql = (jonj_mysql_conn *) emalloc(sizeof(jonj_mysql_conn));
		mysql->active_result_id = 0;
#ifdef CLIENT_MULTI_STATEMENTS
		mysql->multi_query = 1;
#endif
		...
		if (!mysql->conn) {
			...
			jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "OOM");
			efree(hashed_details);
			efree(mysql);
			MYSQL_DO_CONNECT_RETURN_FALSE();
		}
	...
	efree(hashed_details);
	jonj_mysql_set_default_link(Z_LVAL_P(return_value) TSRMLS_CC);
	MYSQL_DO_CONNECT_CLEANUP();
}
/* }}} */

/* {{{ jonj_mysql_get_default_link
 */
static int jonj_mysql_get_default_link(INTERNAL_FUNCTION_PARAMETERS)
{
	if (MySG(default_link)==-1) { /* no link opened yet, implicitly open one */
		ht = 0;
		jonj_mysql_do_connect(INTERNAL_FUNCTION_PARAM_PASSTHRU, 0);
	}
...
{
	jonj_mysql_do_connect(INTERNAL_FUNCTION_PARAM_PASSTHRU, 1);
}
/* }}} */
...
JONJ_FUNCTION(mysql_close)
{
	...
	if (mysql_link) {
		ZEND_FETCH_RESOURCE2(mysql, jonj_mysql_conn *, &mysql_link, -1, "MySQL-Link", le_link, le_plink);
	} else {
		ZEND_FETCH_RESOURCE2(mysql, jonj_mysql_conn *, NULL, MySG(default_link), "MySQL-Link", le_link, le_plink);
	}
...
JONJ_FUNCTION(mysql_select_db)
{
	...
	if (!mysql_link) {
		id = jonj_mysql_get_default_link(INTERNAL_FUNCTION_PARAM_PASSTHRU);
		CHECK_LINK(id);
	}

	ZEND_FETCH_RESOURCE2(mysql, jonj_mysql_conn *, &mysql_link, id, "MySQL-Link", le_link, le_plink);

	if (jonj_mysql_select_db(mysql, db TSRMLS_CC)) {
		RETURN_TRUE;
	} else {
		RETURN_FALSE;
	}
...
/* {{{ jonj_mysql_do_query_general
 */
static void jonj_mysql_do_query_general(char *query, int query_len, zval *mysql_link, int link_id, char *db, int use_store, zval *return_value TSRMLS_DC)
{
	jonj_mysql_conn *mysql;
	MYSQL_RES *mysql_result;

	ZEND_FETCH_RESOURCE2(mysql, jonj_mysql_conn *, &mysql_link, link_id, "MySQL-Link", le_link, le_plink);
	...
	if (MySG(trace_mode)) {
		if (!strncasecmp("select", query, 6)){
			...
			if (mysql_errno(mysql->conn)) {
				jonj_error_docref("http://www.mysql.com/doc" TSRMLS_CC, E_WARNING, "%s", mysql_error(mysql->conn));
				RETURN_FALSE;
			}
			else {
				...
				while ((row = mysql_fetch_row(mysql_result))) {
					if (!strcmp("ALL", row[1])) {
						jonj_error_docref("http://www.mysql.com/doc" TSRMLS_CC, E_WARNING, "Your query requires a full tablescan (table %s, %s rows affected). Use EXPLAIN to optimize your query.", row[0], row[6]);
					} else if (!strcmp("INDEX", row[1])) {
						jonj_error_docref("http://www.mysql.com/doc" TSRMLS_CC, E_WARNING, "Your query requires a full indexscan (table %s, %s rows affected). Use EXPLAIN to optimize your query.", row[0], row[6]);
					}
				}
				mysql_free_result(mysql_result);
			}
	...
	if (!mysql_result) {
		if (JONJ_MYSQL_VALID_RESULT(mysql->conn)) { /* query should have returned rows */
			jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Unable to save result set");
			RETURN_FALSE;
		} else {
			RETURN_TRUE;
		}
...
/* {{{ jonj_mysql_do_query
 */
static void jonj_mysql_do_query(INTERNAL_FUNCTION_PARAMETERS, int use_store)
{
	char *query;
	int query_len;
	zval *mysql_link = NULL;
	...
	jonj_mysql_do_query_general(query, query_len, mysql_link, id, NULL, use_store, return_value TSRMLS_CC);
}
/* }}} */
...
{
	jonj_mysql_do_query(INTERNAL_FUNCTION_PARAM_PASSTHRU, MYSQL_STORE_RESULT);
}
/* }}} */
...
{
	jonj_mysql_do_query(INTERNAL_FUNCTION_PARAM_PASSTHRU, MYSQL_USE_RESULT);
}
/* }}} */
...
JONJ_FUNCTION(mysql_db_query)
{
	...
	jonj_error_docref(NULL TSRMLS_CC, E_DEPRECATED, "This function is deprecated; use mysql_query() instead");

	jonj_mysql_do_query_general(query, query_len, mysql_link, id, db, MYSQL_STORE_RESULT, return_value TSRMLS_CC);
}
/* }}} */
...
JONJ_FUNCTION(mysql_list_dbs)
{
	...
	jonj_error_docref(NULL TSRMLS_CC, E_DEPRECATED, "This function is deprecated; use mysql_query() with SHOW DATABASES instead");
	...
	if ((mysql_result=mysql_list_dbs(mysql->conn, NULL))==NULL) {
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Unable to save MySQL query result");
		RETURN_FALSE;
	}
	MySG(result_allocated)++;
	ZEND_REGISTER_RESOURCE(return_value, mysql_result, le_result);
...
JONJ_FUNCTION(mysql_escape_string)
{
	...
	jonj_error_docref("function.mysql-real-escape-string" TSRMLS_CC, E_DEPRECATED, "This function is deprecated; use mysql_real_escape_string() instead.");
}
/* }}} */
...
*/
	...
	if (row<0 || row>=(int)mysql_num_rows(mysql_result)) {
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Unable to jump to row %ld on MySQL result index %ld", row, Z_LVAL_P(result));
		RETURN_FALSE;
	}
		...
		switch(Z_TYPE_P(field)) {
			case IS_STRING: {
					...
					if (!tmp_field) { /* no match found */
						jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "%s%s%s not found in MySQL result index %ld",
	...
	if (sql_row[field_offset]) {
		...
		if (PG(magic_quotes_runtime)) {
			Z_STRVAL_P(return_value) = jonj_addslashes(sql_row[field_offset], sql_row_lengths[field_offset],&Z_STRLEN_P(return_value), 0 TSRMLS_CC);
		} else {
#endif
...
/* {{{ jonj_mysql_fetch_hash
 */
static void jonj_mysql_fetch_hash(INTERNAL_FUNCTION_PARAMETERS, long result_type, int expected_args, int into_object)
{
	MYSQL_RES *mysql_result;
	...
	if (result_type & ~MYSQL_BOTH) {
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "The result type should be either MYSQL_NUM, MYSQL_ASSOC or MYSQL_BOTH");
		result_type = MYSQL_BOTH;
	}
		 ...
		 mysql_field = mysql_fetch_field(mysql_result), i++)
	{
		if (mysql_row[i]) {
			...
			if (PG(magic_quotes_runtime)) {
				...
				Z_STRVAL_P(data) = jonj_addslashes(mysql_row[i], mysql_row_lengths[i], &Z_STRLEN_P(data), 0 TSRMLS_CC);
			} else {
#endif
...
{
	jonj_mysql_fetch_hash(INTERNAL_FUNCTION_PARAM_PASSTHRU, MYSQL_NUM, 1, 0);
}
/* }}} */
...
{
	jonj_mysql_fetch_hash(INTERNAL_FUNCTION_PARAM_PASSTHRU, MYSQL_ASSOC, 2, 1);
...
{
	jonj_mysql_fetch_hash(INTERNAL_FUNCTION_PARAM_PASSTHRU, 0, 2, 0);
}
/* }}} */
...
{
	jonj_mysql_fetch_hash(INTERNAL_FUNCTION_PARAM_PASSTHRU, MYSQL_ASSOC, 1, 0);
}
/* }}} */
...
JONJ_FUNCTION(mysql_data_seek)
{
	...
	if (offset<0 || offset>=(int)mysql_num_rows(mysql_result)) {
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Offset %ld is invalid for MySQL result index %ld (or the query data is unbuffered)", offset, Z_LVAL_P(result));
		RETURN_FALSE;
	}
...
/* {{{ jonj_mysql_get_field_name
 */
static char *jonj_mysql_get_field_name(int field_type)
{
	switch(field_type) {
...
JONJ_FUNCTION(mysql_fetch_field)
{
	...
	if (ZEND_NUM_ARGS() > 1) {
		if (field<0 || field>=(int)mysql_num_fields(mysql_result)) {
			jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Bad field offset");
			RETURN_FALSE;
		}
	...
	add_property_string(return_value, "type", jonj_mysql_get_field_name(Z_TYPE_P(mysql_field)), 1);
...
JONJ_FUNCTION(mysql_field_seek)
{
	...
	if (offset<0 || offset>=(int)mysql_num_fields(mysql_result)) {
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Field %ld is invalid for MySQL result index %ld", offset, Z_LVAL_P(result));
		RETURN_FALSE;
	}
...
#define JONJ_MYSQL_FIELD_NAME 1
#define JONJ_MYSQL_FIELD_TABLE 2
#define JONJ_MYSQL_FIELD_LEN 3
#define JONJ_MYSQL_FIELD_TYPE 4
#define JONJ_MYSQL_FIELD_FLAGS 5

/* {{{ jonj_mysql_field_info
 */
static void jonj_mysql_field_info(INTERNAL_FUNCTION_PARAMETERS, int entry_type)
{
	zval *result;
	long field;
	MYSQL_RES *mysql_result;
	...
	if (field<0 || field>=(int)mysql_num_fields(mysql_result)) {
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Field %ld is invalid for MySQL result index %ld", field, Z_LVAL_P(result));
		RETURN_FALSE;
	}
	mysql_field_seek(mysql_result, field);
	if ((mysql_field=mysql_fetch_field(mysql_result))==NULL) {
	...
	switch (entry_type) {
		...
		case JONJ_MYSQL_FIELD_TABLE:
			...
			Z_TYPE_P(return_value) = IS_STRING;
			break;
		case JONJ_MYSQL_FIELD_LEN:
			Z_LVAL_P(return_value) = mysql_field->length;
			Z_TYPE_P(return_value) = IS_LONG;
			break;
		case JONJ_MYSQL_FIELD_TYPE:
			Z_STRVAL_P(return_value) = jonj_mysql_get_field_name(Z_TYPE_P(mysql_field));
			Z_STRLEN_P(return_value) = strlen(Z_STRVAL_P(return_value));
			Z_STRVAL_P(return_value) = estrndup(Z_STRVAL_P(return_value), Z_STRLEN_P(return_value));
			Z_TYPE_P(return_value) = IS_STRING;
			break;
		case JONJ_MYSQL_FIELD_FLAGS:
			memcpy(buf, "", sizeof(""));
#ifdef IS_NOT_NULL
...
{
	jonj_mysql_field_info(INTERNAL_FUNCTION_PARAM_PASSTHRU, JONJ_MYSQL_FIELD_NAME);
}
/* }}} */
...
{
	jonj_mysql_field_info(INTERNAL_FUNCTION_PARAM_PASSTHRU, JONJ_MYSQL_FIELD_TABLE);
}
/* }}} */
...
{
	jonj_mysql_field_info(INTERNAL_FUNCTION_PARAM_PASSTHRU, JONJ_MYSQL_FIELD_LEN);
}
/* }}} */
...
{
	jonj_mysql_field_info(INTERNAL_FUNCTION_PARAM_PASSTHRU, JONJ_MYSQL_FIELD_TYPE);
}
/* }}} */
...
{
	jonj_mysql_field_info(INTERNAL_FUNCTION_PARAM_PASSTHRU, JONJ_MYSQL_FIELD_FLAGS);
}
/* }}} */
