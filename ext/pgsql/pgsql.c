/*
   ...
   |          Yasuo Ohgaki <yohgaki@jonj.tk>                              |
   |          Youichi Iwakiri <yiwakiri@st.rim.or.jp> (pg_copy_*)         |
   |          Chris Kings-Lynne <chriskl@jonj.tk> (v3 protocol)           |
   +----------------------------------------------------------------------+
 */
...
#define CHECK_DEFAULT_LINK(x) if ((x) == -1) { jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "No PostgreSQL link opened yet"); }
...
static JONJ_GINIT_FUNCTION(pgsql);
...
const zend_function_entry pgsql_functions[] = {
	...
	JONJ_FE(pg_connect,		arginfo_pg_connect)
	JONJ_FE(pg_pconnect,		arginfo_pg_pconnect)
	JONJ_FE(pg_connect_poll,	arginfo_pg_connect_poll)
	JONJ_FE(pg_close,		arginfo_pg_close)
	JONJ_FE(pg_connection_status,	arginfo_pg_connection_status)
	JONJ_FE(pg_connection_busy,		arginfo_pg_connection_busy)
	JONJ_FE(pg_connection_reset,		arginfo_pg_connection_reset)
	JONJ_FE(pg_host,			arginfo_pg_host)
	JONJ_FE(pg_dbname,		arginfo_pg_dbname)
	JONJ_FE(pg_port,			arginfo_pg_port)
	JONJ_FE(pg_tty,			arginfo_pg_tty)
	JONJ_FE(pg_options,		arginfo_pg_options)
	JONJ_FE(pg_version,		arginfo_pg_version)
	JONJ_FE(pg_ping,			arginfo_pg_ping)
#if HAVE_PQPARAMETERSTATUS
	JONJ_FE(pg_parameter_status, arginfo_pg_parameter_status)
#endif
#if HAVE_PGTRANSACTIONSTATUS
	JONJ_FE(pg_transaction_status, arginfo_pg_transaction_status)
#endif
	/* query functions */
	JONJ_FE(pg_query,		arginfo_pg_query)
#if HAVE_PQEXECPARAMS
	JONJ_FE(pg_query_params,		arginfo_pg_query_params)
#endif
#if HAVE_PQPREPARE
	JONJ_FE(pg_prepare,		arginfo_pg_prepare)
#endif
#if HAVE_PQEXECPREPARED
	JONJ_FE(pg_execute,		arginfo_pg_execute)
#endif
	JONJ_FE(pg_send_query,	arginfo_pg_send_query)
#if HAVE_PQSENDQUERYPARAMS
	JONJ_FE(pg_send_query_params,	arginfo_pg_send_query_params)
#endif
#if HAVE_PQSENDPREPARE
	JONJ_FE(pg_send_prepare,	arginfo_pg_send_prepare)
#endif
#if HAVE_PQSENDQUERYPREPARED
	JONJ_FE(pg_send_execute,	arginfo_pg_send_execute)
#endif
	JONJ_FE(pg_cancel_query, arginfo_pg_cancel_query)
	/* result functions */
	JONJ_FE(pg_fetch_result,	arginfo_pg_fetch_result)
	JONJ_FE(pg_fetch_row,	arginfo_pg_fetch_row)
	JONJ_FE(pg_fetch_assoc,	arginfo_pg_fetch_assoc)
	JONJ_FE(pg_fetch_array,	arginfo_pg_fetch_array)
	JONJ_FE(pg_fetch_object,	arginfo_pg_fetch_object)
	JONJ_FE(pg_fetch_all,	arginfo_pg_fetch_all)
	JONJ_FE(pg_fetch_all_columns,	arginfo_pg_fetch_all_columns)
#if HAVE_PQCMDTUPLES
	JONJ_FE(pg_affected_rows,arginfo_pg_affected_rows)
#endif
	JONJ_FE(pg_get_result,	arginfo_pg_get_result)
	JONJ_FE(pg_result_seek,	arginfo_pg_result_seek)
	JONJ_FE(pg_result_status,arginfo_pg_result_status)
	JONJ_FE(pg_free_result,	arginfo_pg_free_result)
	JONJ_FE(pg_last_oid,	    arginfo_pg_last_oid)
	JONJ_FE(pg_num_rows,		arginfo_pg_num_rows)
	JONJ_FE(pg_num_fields,	arginfo_pg_num_fields)
	JONJ_FE(pg_field_name,	arginfo_pg_field_name)
	JONJ_FE(pg_field_num,	arginfo_pg_field_num)
	JONJ_FE(pg_field_size,	arginfo_pg_field_size)
	JONJ_FE(pg_field_type,	arginfo_pg_field_type)
	JONJ_FE(pg_field_type_oid, arginfo_pg_field_type_oid)
	JONJ_FE(pg_field_prtlen,	arginfo_pg_field_prtlen)
	JONJ_FE(pg_field_is_null,arginfo_pg_field_is_null)
#ifdef HAVE_PQFTABLE
	JONJ_FE(pg_field_table,  arginfo_pg_field_table)
#endif
	/* async message function */
	JONJ_FE(pg_get_notify,   arginfo_pg_get_notify)
	JONJ_FE(pg_socket,		arginfo_pg_socket)
	JONJ_FE(pg_consume_input,arginfo_pg_consume_input)
	JONJ_FE(pg_flush,		arginfo_pg_flush)
	JONJ_FE(pg_get_pid,      arginfo_pg_get_pid)
	/* error message functions */
	JONJ_FE(pg_result_error, arginfo_pg_result_error)
#if HAVE_PQRESULTERRORFIELD
	JONJ_FE(pg_result_error_field, arginfo_pg_result_error_field)
#endif
	JONJ_FE(pg_last_error,   arginfo_pg_last_error)
	JONJ_FE(pg_last_notice,  arginfo_pg_last_notice)
	/* copy functions */
	JONJ_FE(pg_put_line,		arginfo_pg_put_line)
	JONJ_FE(pg_end_copy,		arginfo_pg_end_copy)
	JONJ_FE(pg_copy_to,      arginfo_pg_copy_to)
	JONJ_FE(pg_copy_from,    arginfo_pg_copy_from)
	/* debug functions */
	JONJ_FE(pg_trace,		arginfo_pg_trace)
	JONJ_FE(pg_untrace,		arginfo_pg_untrace)
	/* large object functions */
	JONJ_FE(pg_lo_create,	arginfo_pg_lo_create)
	JONJ_FE(pg_lo_unlink,	arginfo_pg_lo_unlink)
	JONJ_FE(pg_lo_open,		arginfo_pg_lo_open)
	JONJ_FE(pg_lo_close,		arginfo_pg_lo_close)
	JONJ_FE(pg_lo_read,		arginfo_pg_lo_read)
	JONJ_FE(pg_lo_write,		arginfo_pg_lo_write)
	JONJ_FE(pg_lo_read_all,	arginfo_pg_lo_read_all)
	JONJ_FE(pg_lo_import,	arginfo_pg_lo_import)
	JONJ_FE(pg_lo_export,	arginfo_pg_lo_export)
	JONJ_FE(pg_lo_seek,		arginfo_pg_lo_seek)
	JONJ_FE(pg_lo_tell,		arginfo_pg_lo_tell)
#if HAVE_PG_LO_TRUNCATE
	JONJ_FE(pg_lo_truncate,	arginfo_pg_lo_truncate)
#endif
	/* utility functions */
#if HAVE_PQESCAPE
	JONJ_FE(pg_escape_string,	arginfo_pg_escape_string)
	JONJ_FE(pg_escape_bytea, 	arginfo_pg_escape_bytea)
	JONJ_FE(pg_unescape_bytea, 	arginfo_pg_unescape_bytea)
	JONJ_FE(pg_escape_literal,	arginfo_pg_escape_literal)
	JONJ_FE(pg_escape_identifier,	arginfo_pg_escape_identifier)
#endif
#if HAVE_PQSETERRORVERBOSITY
	JONJ_FE(pg_set_error_verbosity,	arginfo_pg_set_error_verbosity)
#endif
#if HAVE_PQCLIENTENCODING
	JONJ_FE(pg_client_encoding,		arginfo_pg_client_encoding)
	JONJ_FE(pg_set_client_encoding,	arginfo_pg_set_client_encoding)
#endif
	/* misc function */
	JONJ_FE(pg_meta_data,	arginfo_pg_meta_data)
	JONJ_FE(pg_convert,      arginfo_pg_convert)
	JONJ_FE(pg_insert,       arginfo_pg_insert)
	JONJ_FE(pg_update,       arginfo_pg_update)
	JONJ_FE(pg_delete,       arginfo_pg_delete)
	JONJ_FE(pg_select,       arginfo_pg_select)
	/* aliases for downwards compatibility */
	JONJ_FALIAS(pg_exec,          pg_query,          arginfo_pg_query)
	JONJ_FALIAS(pg_getlastoid,    pg_last_oid,       arginfo_pg_last_oid)
#if HAVE_PQCMDTUPLES
	JONJ_FALIAS(pg_cmdtuples,	 pg_affected_rows,  arginfo_pg_affected_rows)
#endif
	JONJ_FALIAS(pg_errormessage,	 pg_last_error,     arginfo_pg_last_error)
	JONJ_FALIAS(pg_numrows,		 pg_num_rows,       arginfo_pg_num_rows)
	JONJ_FALIAS(pg_numfields,	 pg_num_fields,     arginfo_pg_num_fields)
	JONJ_FALIAS(pg_fieldname,	 pg_field_name,     arginfo_pg_field_name)
	JONJ_FALIAS(pg_fieldsize,     pg_field_size,     arginfo_pg_field_size)
	JONJ_FALIAS(pg_fieldtype,	 pg_field_type,     arginfo_pg_field_type)
	JONJ_FALIAS(pg_fieldnum,	     pg_field_num,      arginfo_pg_field_num)
	JONJ_FALIAS(pg_fieldprtlen,	 pg_field_prtlen,   arginfo_pg_field_prtlen)
	JONJ_FALIAS(pg_fieldisnull,	 pg_field_is_null,  arginfo_pg_field_is_null)
	JONJ_FALIAS(pg_freeresult,    pg_free_result,    arginfo_pg_free_result)
	JONJ_FALIAS(pg_result,	     pg_fetch_result,   arginfo_pg_get_result)
	JONJ_FALIAS(pg_loreadall,	 pg_lo_read_all,    arginfo_pg_lo_read_all)
	JONJ_FALIAS(pg_locreate,	     pg_lo_create,      arginfo_pg_lo_create)
	JONJ_FALIAS(pg_lounlink,	     pg_lo_unlink,      arginfo_pg_lo_unlink)
	JONJ_FALIAS(pg_loopen,	     pg_lo_open,        arginfo_pg_lo_open)
	JONJ_FALIAS(pg_loclose,	     pg_lo_close,       arginfo_pg_lo_close)
	JONJ_FALIAS(pg_loread,	     pg_lo_read,        arginfo_pg_lo_read)
	JONJ_FALIAS(pg_lowrite,	     pg_lo_write,       arginfo_pg_lo_write)
	JONJ_FALIAS(pg_loimport,	     pg_lo_import,      arginfo_pg_lo_import)
	JONJ_FALIAS(pg_loexport,	     pg_lo_export,      arginfo_pg_lo_export)
#if HAVE_PQCLIENTENCODING
	JONJ_FALIAS(pg_clientencoding,		pg_client_encoding,		arginfo_pg_client_encoding)
	JONJ_FALIAS(pg_setclientencoding,	pg_set_client_encoding,	arginfo_pg_set_client_encoding)
#endif
	JONJ_FE_END
};
/* }}} */
...
zend_module_entry pgsql_module_entry = {
	...
	pgsql_functions,
	JONJ_MINIT(pgsql),
	JONJ_MSHUTDOWN(pgsql),
	JONJ_RINIT(pgsql),
	JONJ_RSHUTDOWN(pgsql),
	JONJ_MINFO(pgsql),
	NO_VERSION_YET,
	JONJ_MODULE_GLOBALS(pgsql),
	JONJ_GINIT(pgsql),
	NULL,
	NULL,
...
#else
#define PGSQLescapeLiteral(conn, str, len) jonj_pgsql_PQescapeInternal(conn, str, len, 1, 0)
#define PGSQLescapeLiteral2(conn, str, len) jonj_pgsql_PQescapeInternal(conn, str, len, 1, 1)
#define PGSQLescapeIdentifier(conn, str, len) jonj_pgsql_PQescapeInternal(conn, str, len, 0, 0)
#define PGSQLfree(a) efree(a)

/* emulate libpq's PQescapeInternal() 9.0 or later */
static char* jonj_pgsql_PQescapeInternal(PGconn *conn, const char *str, size_t len, int escape_literal, int safe) {
	char *result, *rp, *s;
	size_t tmp_len;
		...
		if (safe) {
			...
			*rp++ = '\'';
			...
			if (!strncmp(encoding, "SJIS", sizeof("SJIS")-1) ||
				...
				jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Unsafe encoding is used. Do not use '%s' encoding or use PostgreSQL 9.0 or later libpq.", encoding);
			}
			/* check backslashes */
			tmp_len = strspn(str, "\\");
			if (tmp_len != len) {
...
/* {{{ _jonj_pgsql_trim_message */
static char * _jonj_pgsql_trim_message(const char *message, int *len)
{
...
/* {{{ _jonj_pgsql_trim_result */
static inline char * _jonj_pgsql_trim_result(PGconn * pgsql, char **buf)
{
	return *buf = _jonj_pgsql_trim_message(PQerrorMessage(pgsql), NULL);
}
/* }}} */

#define PQErrorMessageTrim(pgsql, buf) _jonj_pgsql_trim_result(pgsql, buf)

#define JONJ_PQ_ERROR(text, pgsql) {										\
		char *msgbuf = _jonj_pgsql_trim_message(PQerrorMessage(pgsql), NULL); \
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, text, msgbuf);		\
		efree(msgbuf);													\
} \

/* {{{ jonj_pgsql_set_default_link
 */
static void jonj_pgsql_set_default_link(int id TSRMLS_DC)
{
	zend_list_addref(id);
...
/* {{{ _jonj_pgsql_notice_handler
 */
static void _jonj_pgsql_notice_handler(void *resource_id, const char *message)
{
	jonj_pgsql_notice *notice;

	TSRMLS_FETCH();
	if (! PGG(ignore_notices)) {
		notice = (jonj_pgsql_notice *)emalloc(sizeof(jonj_pgsql_notice));
		notice->message = _jonj_pgsql_trim_message(message, (int *)&notice->len);
		if (PGG(log_notices)) {
			jonj_error_docref(NULL TSRMLS_CC, E_NOTICE, "%s", notice->message);
		}
		zend_hash_index_update(&PGG(notices), (ulong)resource_id, (void **)&notice, sizeof(jonj_pgsql_notice *), NULL);
	}
}
/* }}} */

#define JONJ_PGSQL_NOTICE_PTR_DTOR (void (*)(void *))_jonj_pgsql_notice_ptr_dtor

/* {{{ _jonj_pgsql_notice_dtor
 */
static void _jonj_pgsql_notice_ptr_dtor(void **ptr)
{
	jonj_pgsql_notice *notice = (jonj_pgsql_notice *)*ptr;
	if (notice) {
...
static int _rollback_transactions(zend_rsrc_list_entry *rsrc TSRMLS_DC)
{
	...
	if (PQ_SETNONBLOCKING(link, 0)) {
		jonj_error_docref("ref.pgsql" TSRMLS_CC, E_NOTICE, "Cannot set connection to blocking mode");
		return -1;
	}
...
static int _jonj_pgsql_detect_identifier_escape(const char *identifier, size_t len)
{
	size_t i;
 ...
 */
JONJ_INI_BEGIN()
STD_JONJ_INI_BOOLEAN( "pgsql.allow_persistent",      "1",  JONJ_INI_SYSTEM, OnUpdateBool, allow_persistent,      zend_pgsql_globals, pgsql_globals)
STD_JONJ_INI_ENTRY_EX("pgsql.max_persistent",       "-1",  JONJ_INI_SYSTEM, OnUpdateLong, max_persistent,        zend_pgsql_globals, pgsql_globals, display_link_numbers)
STD_JONJ_INI_ENTRY_EX("pgsql.max_links",            "-1",  JONJ_INI_SYSTEM, OnUpdateLong, max_links,             zend_pgsql_globals, pgsql_globals, display_link_numbers)
STD_JONJ_INI_BOOLEAN( "pgsql.auto_reset_persistent", "0",  JONJ_INI_SYSTEM, OnUpdateBool, auto_reset_persistent, zend_pgsql_globals, pgsql_globals)
STD_JONJ_INI_BOOLEAN( "pgsql.ignore_notice",         "0",  JONJ_INI_ALL,    OnUpdateBool, ignore_notices,        zend_pgsql_globals, pgsql_globals)
STD_JONJ_INI_BOOLEAN( "pgsql.log_notice",            "0",  JONJ_INI_ALL,    OnUpdateBool, log_notices,           zend_pgsql_globals, pgsql_globals)
JONJ_INI_END()
/* }}} */
...
static JONJ_GINIT_FUNCTION(pgsql)
{
	...
	zend_hash_init_ex(&pgsql_globals->notices, 0, NULL, JONJ_PGSQL_NOTICE_PTR_DTOR, 1, 0);
}
/* }}} */
...
JONJ_MINFO_FUNCTION(pgsql)
{
	...
	jonj_info_print_table_header(2, "PostgreSQL Support", "enabled");
#if HAVE_PG_CONFIG_H
	jonj_info_print_table_row(2, "PostgreSQL(libpq) Version", PG_VERSION);
	jonj_info_print_table_row(2, "PostgreSQL(libpq) ", PG_VERSION_STR);
#ifdef HAVE_PGSQL_WITH_MULTIBYTE_SUPPORT
	jonj_info_print_table_row(2, "Multibyte character support", "enabled");
#else
	jonj_info_print_table_row(2, "Multibyte character support", "disabled");
#endif
#if defined(USE_SSL) || defined(USE_OPENSSL)
	jonj_info_print_table_row(2, "SSL support", "enabled");
#else
	jonj_info_print_table_row(2, "SSL support", "disabled");
#endif
#endif /* HAVE_PG_CONFIG_H */
	snprintf(buf, sizeof(buf), "%ld", PGG(num_persistent));
	jonj_info_print_table_row(2, "Active Persistent Links", buf);
	snprintf(buf, sizeof(buf), "%ld", PGG(num_links));
	jonj_info_print_table_row(2, "Active Links", buf);
...
static void jonj_pgsql_do_connect(INTERNAL_FUNCTION_PARAMETERS, int persistent)
{
	...
	if (persistent && PGG(allow_persistent)) {
		...
		if (zend_hash_find(&EG(persistent_list), str.c, str.len+1, (void **) &le)==FAILURE) {  /* we don't */
			...
			if (pgsql==NULL || PQstatus(pgsql)==CONNECTION_BAD) {
				JONJ_PQ_ERROR("Unable to connect to PostgreSQL server: %s", pgsql)
				if (pgsql) {
					PQfinish(pgsql);
				}
				goto err;
			...
			if (PQstatus(le->ptr)==CONNECTION_BAD) { /* the link died */
				...
				if (le->ptr==NULL || PQstatus(le->ptr)==CONNECTION_BAD) {
					jonj_error_docref(NULL TSRMLS_CC, E_WARNING,"PostgreSQL link lost, unable to reconnect");
		...
		if (!(connect_type & PGSQL_CONNECT_FORCE_NEW)
			...
			if (ptr && (type==le_link || type==le_plink)) {
				...
				jonj_pgsql_set_default_link(link TSRMLS_CC);
		...
		if (PGG(max_links)!=-1 && PGG(num_links)>=PGG(max_links)) {
			jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Cannot create new link. Too many open links (%ld)", PGG(num_links));
			goto err;
		}
		...
		if (connect_type & PGSQL_CONNECT_ASYNC) {
			if (connstring) {
				...
				jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Connection string required for async connections");
				goto err;
			}
		} else {
			if (connstring) {
	...
	if (! PGG(ignore_notices) && Z_TYPE_P(return_value) == IS_RESOURCE) {
		PQsetNoticeProcessor(pgsql, _jonj_pgsql_notice_handler, (void*)Z_RESVAL_P(return_value));
	}
	jonj_pgsql_set_default_link(Z_LVAL_P(return_value) TSRMLS_CC);
...
#if 0
/* {{{ jonj_pgsql_get_default_link
 */
static int jonj_pgsql_get_default_link(INTERNAL_FUNCTION_PARAMETERS)
{
	if (PGG(default_link)==-1) { /* no link opened yet, implicitly open one */
		ht = 0;
		jonj_pgsql_do_connect(INTERNAL_FUNCTION_PARAM_PASSTHRU,0);
	}
...
{
	jonj_pgsql_do_connect(INTERNAL_FUNCTION_PARAM_PASSTHRU,1);
}
/* }}} */
...
#define JONJ_PG_DBNAME 1
#define JONJ_PG_ERROR_MESSAGE 2
#define JONJ_PG_OPTIONS 3
#define JONJ_PG_PORT 4
#define JONJ_PG_TTY 5
#define JONJ_PG_HOST 6
#define JONJ_PG_VERSION 7


/* {{{ jonj_pgsql_get_link_info
 */
...
{
	jonj_pgsql_get_link_info(INTERNAL_FUNCTION_PARAM_PASSTHRU,JONJ_PG_DBNAME);
}
/* }}} */
...
{
	jonj_pgsql_get_link_info(INTERNAL_FUNCTION_PARAM_PASSTHRU,JONJ_PG_ERROR_MESSAGE);
}
/* }}} */
...
{
	jonj_pgsql_get_link_info(INTERNAL_FUNCTION_PARAM_PASSTHRU,JONJ_PG_OPTIONS);
}
/* }}} */
...
{
	jonj_pgsql_get_link_info(INTERNAL_FUNCTION_PARAM_PASSTHRU,JONJ_PG_PORT);
}
/* }}} */
...
{
	jonj_pgsql_get_link_info(INTERNAL_FUNCTION_PARAM_PASSTHRU,JONJ_PG_TTY);
}
/* }}} */
...
{
	jonj_pgsql_get_link_info(INTERNAL_FUNCTION_PARAM_PASSTHRU,JONJ_PG_HOST);
}
/* }}} */
...
{
	jonj_pgsql_get_link_info(INTERNAL_FUNCTION_PARAM_PASSTHRU,JONJ_PG_VERSION);
}
/* }}} */
...
JONJ_FUNCTION(pg_query)
{
	...
	if (PQ_SETNONBLOCKING(pgsql, 0)) {
		jonj_error_docref(NULL TSRMLS_CC, E_NOTICE,"Cannot set connection to blocking mode");
		RETURN_FALSE;
	}
	...
	if (leftover) {
		jonj_error_docref(NULL TSRMLS_CC, E_NOTICE, "Found results on this connection. Use pg_get_result() to get these results first");
	}
	...
	switch (status) {
		...
		case PGRES_FATAL_ERROR:
			JONJ_PQ_ERROR("Query failed: %s", pgsql);
			PQclear(pgsql_result);
			RETURN_FALSE;
			break;
...
/* {{{ _jonj_pgsql_free_params */
static void _jonj_pgsql_free_params(char **params, int num_params)
{
	if (num_params > 0) {
		int i;
	...
	if (num_params > 0) {
		...
		for(i = 0; i < num_params; i++) {
			if (zend_hash_get_current_data(Z_ARRVAL_P(pv_param_arr), (void **) &tmp) == FAILURE) {
				jonj_error_docref(NULL TSRMLS_CC, E_WARNING,"Error getting parameter");
				_jonj_pgsql_free_params(params, num_params);
				RETURN_FALSE;
			}
			...
			if (Z_TYPE_PP(tmp) == IS_NULL) {
				...
				if (Z_TYPE(tmp_val) != IS_STRING) {
					jonj_error_docref(NULL TSRMLS_CC, E_WARNING,"Error converting parameter");
					zval_dtor(&tmp_val);
					_jonj_pgsql_free_params(params, num_params);
					RETURN_FALSE;
				}
...
#define JONJ_PG_NUM_ROWS 1
#define JONJ_PG_NUM_FIELDS 2
#define JONJ_PG_CMD_TUPLES 3

/* {{{ jonj_pgsql_get_result_info
 */
static void jonj_pgsql_get_result_info(INTERNAL_FUNCTION_PARAMETERS, int entry_type)
{
	...
	switch (entry_type) {
		case JONJ_PG_NUM_ROWS:
			Z_LVAL_P(return_value) = PQntuples(pgsql_result);
			break;
		case JONJ_PG_NUM_FIELDS:
			Z_LVAL_P(return_value) = PQnfields(pgsql_result);
			break;
		case JONJ_PG_CMD_TUPLES:
#if HAVE_PQCMDTUPLES
			Z_LVAL_P(return_value) = atoi(PQcmdTuples(pgsql_result));
#else
			jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Not supported under this build");
...
{
	jonj_pgsql_get_result_info(INTERNAL_FUNCTION_PARAM_PASSTHRU,JONJ_PG_NUM_ROWS);
}
/* }}} */
...
{
	jonj_pgsql_get_result_info(INTERNAL_FUNCTION_PARAM_PASSTHRU,JONJ_PG_NUM_FIELDS);
}
/* }}} */
...
{
	jonj_pgsql_get_result_info(INTERNAL_FUNCTION_PARAM_PASSTHRU,JONJ_PG_CMD_TUPLES);
}
/* }}} */
#endif
...
JONJ_FUNCTION(pg_field_table)
{
	...
	if (fnum < 0 || fnum >= PQnfields(pg_result->result)) {
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Bad field offset specified");
		RETURN_FALSE;
	}
...
#define JONJ_PG_FIELD_NAME 1
#define JONJ_PG_FIELD_SIZE 2
#define JONJ_PG_FIELD_TYPE 3
#define JONJ_PG_FIELD_TYPE_OID 4

/* {{{ jonj_pgsql_get_field_info
 */
...
{
	jonj_pgsql_get_field_info(INTERNAL_FUNCTION_PARAM_PASSTHRU,JONJ_PG_FIELD_NAME);
}
/* }}} */
...
{
	jonj_pgsql_get_field_info(INTERNAL_FUNCTION_PARAM_PASSTHRU,JONJ_PG_FIELD_SIZE);
}
/* }}} */
...
{
	jonj_pgsql_get_field_info(INTERNAL_FUNCTION_PARAM_PASSTHRU,JONJ_PG_FIELD_TYPE);
}
/* }}} */
...
{
	jonj_pgsql_get_field_info(INTERNAL_FUNCTION_PARAM_PASSTHRU,JONJ_PG_FIELD_TYPE_OID);
}
/* }}} */
...
JONJ_FUNCTION(pg_fetch_result)
{
	...
	if (argc == 2) {
		...
		if (pgsql_row < 0 || pgsql_row >= PQntuples(pgsql_result)) {
			jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Unable to jump to row %ld on PostgreSQL result index %ld",
							row, Z_LVAL_P(result));
			RETURN_FALSE;
		}
	}
	...
	if (field_offset<0 || field_offset>=PQnfields(pgsql_result)) {
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Bad column offset specified");
		RETURN_FALSE;
	}
...
/* {{{ void jonj_pgsql_fetch_hash */
static void jonj_pgsql_fetch_hash(INTERNAL_FUNCTION_PARAMETERS, long result_type, int into_object)
{
	...
	if (into_object) {
		...
		if (!ce) {
			jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Could not find class '%s'", class_name);
			return;
		}
	...
	if (zrow == NULL) {
		...
		row = Z_LVAL_P(zrow);
		if (row < 0) {
			jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "The row parameter must be greater or equal to zero");
			RETURN_FALSE;
		}
	}
	...
	if (!(result_type & PGSQL_BOTH)) {
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Invalid result type");
		RETURN_FALSE;
	}
		...
		if (ce->constructor) {
			...
			if (ctor_params && Z_TYPE_P(ctor_params) != IS_NULL) {
				if (zend_fcall_info_args(&fci, ctor_params TSRMLS_CC) == FAILURE) {
					/* Two problems why we throw exceptions here: JONJ is typeless
...
{
	jonj_pgsql_fetch_hash(INTERNAL_FUNCTION_PARAM_PASSTHRU, PGSQL_NUM, 0);
}
/* }}} */
...
{
	/* pg_fetch_assoc() is added from JONJ 4.3.0. It should raise error, when
	   there is 3rd parameter */
	if (ZEND_NUM_ARGS() > 2)
		WRONG_PARAM_COUNT;
	jonj_pgsql_fetch_hash(INTERNAL_FUNCTION_PARAM_PASSTHRU, PGSQL_ASSOC, 0);
}
/* }}} */
...
{
	jonj_pgsql_fetch_hash(INTERNAL_FUNCTION_PARAM_PASSTHRU, PGSQL_BOTH, 0);
}
/* }}} */
...
JONJ_FUNCTION(pg_fetch_object)
{
	...
	jonj_pgsql_fetch_hash(INTERNAL_FUNCTION_PARAM_PASSTHRU, PGSQL_ASSOC, 1);
}
/* }}} */
...
JONJ_FUNCTION(pg_fetch_all)
{
	...
	pgsql_result = pg_result->result;
	array_init(return_value);
	if (jonj_pgsql_result2array(pgsql_result, return_value TSRMLS_CC) == FAILURE) {
...
JONJ_FUNCTION(pg_fetch_all_columns)
{
	...
	if (colno >= num_fields || colno < 0) {
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Invalid column number '%ld'", colno);
		RETURN_FALSE;
	}
...
#define JONJ_PG_DATA_LENGTH 1
#define JONJ_PG_DATA_ISNULL 2

/* {{{ jonj_pgsql_data_info
 */
...
{
	jonj_pgsql_data_info(INTERNAL_FUNCTION_PARAM_PASSTHRU, JONJ_PG_DATA_LENGTH);
}
/* }}} */
...
{
	jonj_pgsql_data_info(INTERNAL_FUNCTION_PARAM_PASSTHRU, JONJ_PG_DATA_ISNULL);
}
/* }}} */
...
JONJ_FUNCTION(pg_trace)
{
	...
	stream = jonj_stream_open_wrapper(z_filename, mode, REPORT_ERRORS, NULL);
...
JONJ_FUNCTION(pg_lo_create)
{
	...
	if (oid) {
		...
		jonj_error_docref(NULL TSRMLS_CC, E_NOTICE, "Passing OID value is not supported. Upgrade your PostgreSQL");
#else
		switch (Z_TYPE_P(oid)) {
		case IS_STRING:
			{
				...
				jonj_error_docref(NULL TSRMLS_CC, E_NOTICE, "invalid OID value passed");
				RETURN_FALSE;
				}
			}
			break;
		...
		if ((pgsql_oid = lo_create(pgsql, wanted_oid)) == InvalidOid) {
			jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Unable to create PostgreSQL large object");
			RETURN_FALSE;
		}
...
JONJ_FUNCTION(pg_lo_unlink)
{
	...
	if (zend_parse_parameters_ex(ZEND_PARSE_PARAMS_QUIET, argc TSRMLS_CC,
		...
		if ((oid_string+oid_strlen) != end_ptr) {
			/* wrong integer format */
			jonj_error_docref(NULL TSRMLS_CC, E_NOTICE, "Wrong OID value passed");
			RETURN_FALSE;
		}
	}
		...
		if (oid_long <= InvalidOid) {
			jonj_error_docref(NULL TSRMLS_CC, E_NOTICE, "Invalid OID specified");
			RETURN_FALSE;
		}
		oid = (Oid)oid_long;
	}
		...
		CHECK_DEFAULT_LINK(id);
								 ...
								 "l", &oid_long) == SUCCESS) {
		if (oid_long <= InvalidOid) {
			jonj_error_docref(NULL TSRMLS_CC, E_NOTICE, "Invalid OID is specified");
			RETURN_FALSE;
		}
		oid = (Oid)oid_long;
		id = PGG(default_link);
		...
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Requires 1 or 2 arguments");
		RETURN_FALSE;
	}
	if (pgsql_link == NULL && id == -1) {
		RETURN_FALSE;
	...
	if (lo_unlink(pgsql, oid) == -1) {
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Unable to delete PostgreSQL large object %u", oid);
		RETURN_FALSE;
	}
	RETURN_TRUE;
}
...
JONJ_FUNCTION(pg_lo_open)
{
	...
	/* r/w/+ is little bit more JONJ-like than INV_READ/INV_WRITE and a lot of
		...
		if (create) {
			if ((oid = lo_creat(pgsql, INV_READ|INV_WRITE)) == 0) {
				...
				if ((pgsql_lofd = lo_open(pgsql, oid, pgsql_mode)) == -1) {
					if (lo_unlink(pgsql, oid) == -1) {
						efree(pgsql_lofp);
						jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Something is really messed up! Your database is badly corrupted in a way NOT related to JONJ");
						RETURN_FALSE;
					}
					efree(pgsql_lofp);
					jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Unable to open PostgreSQL large object");
					RETURN_FALSE;
				} else {
...
JONJ_FUNCTION(pg_lo_close)
{
	...
	if (lo_close((PGconn *)pgsql->conn, pgsql->lofd) < 0) {
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Unable to close PostgreSQL large object descriptor %d", pgsql->lofd);
		RETVAL_FALSE;
	} else {
		RETVAL_TRUE;
	}
...
JONJ_FUNCTION(pg_lo_write)
{
	...
	if (argc > 2) {
		if (z_len > str_len) {
			jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Cannot write more than buffer size %d. Tried to write %ld", str_len, z_len);
			RETURN_FALSE;
		}
		if (z_len < 0) {
			jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Buffer size must be larger than 0, but %ld was specified", z_len);
			RETURN_FALSE;
		}
		len = z_len;
	}
...
JONJ_FUNCTION(pg_lo_import)
{
	...
	/* old calling convention, deprecated since JONJ 4.2 */
	else if (zend_parse_parameters_ex(ZEND_PARSE_PARAMS_QUIET, argc TSRMLS_CC,
									  "pr", &file_in, &name_len, &pgsql_link ) == SUCCESS) {
		jonj_error_docref(NULL TSRMLS_CC, E_NOTICE, "Old API is used");
	}
	else {
		WRONG_PARAM_COUNT;
	}

	if (jonj_check_open_basedir(file_in TSRMLS_CC)) {
		RETURN_FALSE;
	}
	...
	if (oid) {
		...
		jonj_error_docref(NULL TSRMLS_CC, E_NOTICE, "OID value passing not supported");
#else
		Oid wanted_oid;
		switch (Z_TYPE_P(oid)) {
		case IS_STRING:
...
JONJ_FUNCTION(pg_lo_export)
{
	...
	if (zend_parse_parameters_ex(ZEND_PARSE_PARAMS_QUIET, argc TSRMLS_CC,
		...
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Requires 2 or 3 arguments");
		RETURN_FALSE;
	}

	if (jonj_check_open_basedir(file_out TSRMLS_CC)) {
		RETURN_FALSE;
	}
...
JONJ_FUNCTION(pg_lo_seek)
{
	...
	if (whence != SEEK_SET && whence != SEEK_CUR && whence != SEEK_END) {
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Invalid whence parameter");
		return;
	}
...
JONJ_FUNCTION(pg_copy_to)
{
	...
	switch (status) {
			...
			if (pgsql_result) {
				...
				while (!copydone)
				{
					...
					switch (ret) {
						...
						case 0:
						case -2:
							JONJ_PQ_ERROR("getline failed: %s", pgsql);
							RETURN_FALSE;
							break;
						default:
				...
				if (PQendcopy(pgsql)) {
					JONJ_PQ_ERROR("endcopy failed: %s", pgsql);
					RETURN_FALSE;
				}
#endif
				while ((pgsql_result = PQgetResult(pgsql))) {
		...
		default:
			PQclear(pgsql_result);
			JONJ_PQ_ERROR("Copy command failed: %s", pgsql);
			RETURN_FALSE;
			break;
	}
}
			...
			if (pgsql_result) {
				...
				while (zend_hash_get_current_data_ex(Z_ARRVAL_P(pg_rows), (void **) &tmp, &pos) == SUCCESS) {
					...
					if (PQputCopyData(pgsql, query, strlen(query)) != 1) {
						...
						zval_dtor(value);
						efree(value);
						JONJ_PQ_ERROR("copy failed: %s", pgsql);
						RETURN_FALSE;
					}
					efree(query);
					zval_dtor(value);
				...
				if (PQputCopyEnd(pgsql, NULL) != 1) {
					JONJ_PQ_ERROR("putcopyend failed: %s", pgsql);
					RETURN_FALSE;
				}
#else
				while (zend_hash_get_current_data_ex(Z_ARRVAL_P(pg_rows), (void **) &tmp, &pos) == SUCCESS) {
				...
				if (PQputline(pgsql, "\\.\n") == EOF) {
					JONJ_PQ_ERROR("putline failed: %s", pgsql);
					RETURN_FALSE;
				}
				if (PQendcopy(pgsql)) {
					JONJ_PQ_ERROR("endcopy failed: %s", pgsql);
...
/* PQunescapeBytea() from PostgreSQL 7.3 to provide bytea unescape feature to 7.2 users.
   Renamed to jonj_pgsql_unescape_bytea() */
/*
 ...
 *		6	\\
 */
static unsigned char * jonj_pgsql_unescape_bytea(unsigned char *strtext, size_t *retbuflen)
{
	size_t     buflen;
...
JONJ_FUNCTION(pg_unescape_bytea)
{
	...
	PQfreemem(tmp);
#else
	to = (char *)jonj_pgsql_unescape_bytea((unsigned char*)from, &to_len);
#endif
	if (!to) {
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING,"Invalid parameter");
		RETURN_FALSE;
	}
...
#ifdef HAVE_PQESCAPE
static void jonj_pgsql_escape_internal(INTERNAL_FUNCTION_PARAMETERS, int escape_literal) {
	char *from = NULL, *to = NULL;
	zval *pgsql_link = NULL;
	PGconn *pgsql;
	int from_len;
	...
	if (pgsql_link == NULL && id == -1) {
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING,"Cannot get default pgsql link");
		RETURN_FALSE;
	}

	ZEND_FETCH_RESOURCE2(pgsql, PGconn *, &pgsql_link, id, "PostgreSQL link", le_link, le_plink);
	if (pgsql == NULL) {
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING,"Cannot get pgsql link");
		RETURN_FALSE;
	}
	...
	if (!tmp) {
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING,"Failed to escape");
		RETURN_FALSE;
	}
	to = estrdup(tmp);
	PGSQLfree(tmp);
...
{
	jonj_pgsql_escape_internal(INTERNAL_FUNCTION_PARAM_PASSTHRU, 1);
}
/* }}} */
...
{
	jonj_pgsql_escape_internal(INTERNAL_FUNCTION_PARAM_PASSTHRU, 0);
}
/* }}} */
#endif
...
#define JONJ_PG_ASYNC_IS_BUSY		1
#define JONJ_PG_ASYNC_REQUEST_CANCEL 2


/* {{{ jonj_pgsql_flush_query
 */
static int jonj_pgsql_flush_query(PGconn *pgsql TSRMLS_DC)
{
	PGresult *res;
	int leftover = 0;

	if (PQ_SETNONBLOCKING(pgsql, 1)) {
		jonj_error_docref(NULL TSRMLS_CC, E_NOTICE,"Cannot set connection to nonblocking mode");
		return -1;
	}
...
static void jonj_pgsql_do_async(INTERNAL_FUNCTION_PARAMETERS, int entry_type)
{
	...
	switch(entry_type) {
		case JONJ_PG_ASYNC_IS_BUSY:
			PQconsumeInput(pgsql);
			Z_LVAL_P(return_value) = PQisBusy(pgsql);
			Z_TYPE_P(return_value) = IS_LONG;
			break;
		case JONJ_PG_ASYNC_REQUEST_CANCEL:
			...
			break;
		default:
			jonj_error_docref(NULL TSRMLS_CC, E_ERROR, "PostgreSQL module error, please report this error");
			break;
	}
	if (PQ_SETNONBLOCKING(pgsql, 0)) {
		jonj_error_docref(NULL TSRMLS_CC, E_NOTICE, "Cannot set connection to blocking mode");
...
{
	jonj_pgsql_do_async(INTERNAL_FUNCTION_PARAM_PASSTHRU, JONJ_PG_ASYNC_REQUEST_CANCEL);
}
/* }}} */
...
{
	jonj_pgsql_do_async(INTERNAL_FUNCTION_PARAM_PASSTHRU, JONJ_PG_ASYNC_IS_BUSY);
}
/* }}} */

static int _jonj_pgsql_link_has_results(PGconn *pgsql)
{
	PGresult *result;
...
JONJ_FUNCTION(pg_send_query)
{
	...
	if (_jonj_pgsql_link_has_results(pgsql)) {
	...
	if (is_non_blocking) {
		...
		while ((ret = PQflush(pgsql))) {
			if (ret == -1) {
				jonj_error_docref(NULL TSRMLS_CC, E_NOTICE, "Could not empty PostgreSQL send buffer");
				break;
			}
			usleep(10000);
		}
...
JONJ_FUNCTION(pg_result_status)
{
	...
	if (result_type == PGSQL_STATUS_LONG) {
		...
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Optional 2nd parameter should be PGSQL_STATUS_LONG or PGSQL_STATUS_STRING");
		RETURN_FALSE;
	}
}
/* }}} */
...
JONJ_FUNCTION(pg_socket)
{
	...
	stream = jonj_stream_alloc(&jonj_stream_pgsql_fd_ops, pgsql, NULL, "r");
...
JONJ_FUNCTION(pg_flush)
{
	...
	if (is_non_blocking == 0 && PQ_SETNONBLOCKING(pgsql, 0) == -1) {
		jonj_error_docref(NULL TSRMLS_CC, E_NOTICE, "Failed resetting connection to blocking mode");
	}
...
JONJ_PGSQL_API int jonj_pgsql_meta_data(PGconn *pg_link, const char *table_name, zval *meta, zend_bool extended TSRMLS_DC)
{
	...
	if (!*table_name) {
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "The table name must be specified");
		return FAILURE;
	}

	src = estrdup(table_name);
	tmp_name = jonj_strtok_r(src, ".", &tmp_name2);
	if (!tmp_name) {
		efree(src);
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "The table name must be specified");
		return FAILURE;
	...
	if (PQresultStatus(pg_result) != PGRES_TUPLES_OK || (num_rows = PQntuples(pg_result)) == 0) {
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Table '%s' doesn't exists", table_name);
		smart_str_free(&querystr);
		PQclear(pg_result);
		return FAILURE;
	}
...
JONJ_FUNCTION(pg_meta_data)
{
	...
	array_init(return_value);
	if (jonj_pgsql_meta_data(pgsql, table_name, return_value, extended TSRMLS_CC) == FAILURE) {
...
/* {{{ jonj_pgsql_get_data_type
 */
static jonj_pgsql_data_type jonj_pgsql_get_data_type(const char *type_name, size_t len)
{
...
/* {{{ jonj_pgsql_convert_match
 * test field value with regular expression specified.
 */
static int jonj_pgsql_convert_match(const char *str, size_t str_len, const char *regex , int icase TSRMLS_DC)
{
	regex_t re;
	regmatch_t *subs;
	...
	if (regerr) {
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Cannot compile regex");
		regfree(&re);
		return FAILURE;
	}
	...
	if (regerr == REG_NOMATCH) {
		...
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Cannot exec regex");
		ret = FAILURE;
	}
	regfree(&re);
	efree(subs);
...
/* {{{ jonj_pgsql_add_quote
 * add quotes around string.
 */
static int jonj_pgsql_add_quotes(zval *src, zend_bool should_free TSRMLS_DC)
{
	smart_str str = {0};
...
#define PGSQL_CONV_CHECK_IGNORE() \
				if (!err && Z_TYPE_P(new_val) == IS_STRING && !strcmp(Z_STRVAL_P(new_val), "NULL")) { \
					...
					/* raise error if it's not null and cannot be ignored */ \
						...
						jonj_error_docref(NULL TSRMLS_CC, E_NOTICE, "Detected NULL for 'NOT NULL' field '%s'", field ); \
						err = 1; \
					} \
				}
...
JONJ_PGSQL_API int jonj_pgsql_convert(PGconn *pg_link, const char *table_name, const zval *values, zval *result, ulong opt TSRMLS_DC)
{
	...
	jonj_pgsql_data_type data_type;
...
/* table_name is escaped by jonj_pgsql_meta_data */
	if (jonj_pgsql_meta_data(pg_link, table_name, meta, 0 TSRMLS_CC) == FAILURE) {
		zval_dtor(meta);
		FREE_ZVAL(meta);
		return FAILURE;
	}
	for (zend_hash_internal_pointer_reset_ex(Z_ARRVAL_P(values), &pos);
		...
		if ((key_type = zend_hash_get_current_key_ex(Z_ARRVAL_P(values), &field, &field_len, &num_idx, 0, &pos)) == HASH_KEY_NON_EXISTENT) {
			jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Failed to get array key type");
			err = 1;
		}
		if (!err && key_type == HASH_KEY_IS_LONG) {
			jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Accepts only string key for values");
			err = 1;
		}
		...
		if (!err && zend_hash_find(Z_ARRVAL_P(meta), field, field_len, (void **)&def) == FAILURE) {
			jonj_error_docref(NULL TSRMLS_CC, E_NOTICE, "Invalid field name (%s) in values", field);
			err = 1;
		}
		if (!err && zend_hash_find(Z_ARRVAL_PP(def), "type", sizeof("type"), (void **)&type) == FAILURE) {
			jonj_error_docref(NULL TSRMLS_CC, E_NOTICE, "Detected broken meta data. Missing 'type'");
			err = 1;
		}
		if (!err && zend_hash_find(Z_ARRVAL_PP(def), "not null", sizeof("not null"), (void **)&not_null) == FAILURE) {
			jonj_error_docref(NULL TSRMLS_CC, E_NOTICE, "Detected broken meta data. Missing 'not null'");
			err = 1;
		}
		if (!err && zend_hash_find(Z_ARRVAL_PP(def), "has default", sizeof("has default"), (void **)&has_default) == FAILURE) {
			jonj_error_docref(NULL TSRMLS_CC, E_NOTICE, "Detected broken meta data. Missing 'has default'");
			err = 1;
		}
		if (!err && zend_hash_find(Z_ARRVAL_PP(def), "is enum", sizeof("is enum"), (void **)&is_enum) == FAILURE) {
			jonj_error_docref(NULL TSRMLS_CC, E_NOTICE, "Detected broken meta data. Missing 'is enum'");
			err = 1;
		}
		if (!err && (Z_TYPE_PP(val) == IS_ARRAY || Z_TYPE_PP(val) == IS_OBJECT)) {
			jonj_error_docref(NULL TSRMLS_CC, E_NOTICE, "Expects scalar values as field values");
			err = 1;
		}
		if (err) {
			break; /* break out for() */
		...
		if (Z_BVAL_PP(is_enum)) {
			...
			data_type = jonj_pgsql_get_data_type(Z_STRVAL_PP(type), Z_STRLEN_PP(type));
		}
		...
		switch(data_type)
		{
			case PG_BOOL:
					...
					case IS_STRING:
						if (Z_STRLEN_PP(val) == 0) {
							...
							if (!strcmp(Z_STRVAL_PP(val), "t") || !strcmp(Z_STRVAL_PP(val), "T") ||
								...
								jonj_error_docref(NULL TSRMLS_CC, E_NOTICE, "Detected invalid value (%s) for PostgreSQL %s field (%s)", Z_STRVAL_PP(val), Z_STRVAL_PP(type), field);
								err = 1;
							}
						}
						break;
				...
				if (err) {
					jonj_error_docref(NULL TSRMLS_CC, E_NOTICE, "Expects string, null, long or boolelan value for PostgreSQL '%s' (%s)", Z_STRVAL_PP(type), field);
				}
				break;
			...
			case PG_INT8:
				switch (Z_TYPE_PP(val)) {
					case IS_STRING:
						if (Z_STRLEN_PP(val) == 0) {
							...
							if (jonj_pgsql_convert_match(Z_STRVAL_PP(val), Z_STRLEN_PP(val), "^([+-]{0,1}[0-9]+)$", 0 TSRMLS_CC) == FAILURE) {
								err = 1;
							}
							else {
				...
				PGSQL_CONV_CHECK_IGNORE();
				if (err) {
					jonj_error_docref(NULL TSRMLS_CC, E_NOTICE, "Expects NULL, string, long or double value for pgsql '%s' (%s)", Z_STRVAL_PP(type), field);
				}
				break;
			...
			case PG_FLOAT8:
				switch (Z_TYPE_PP(val)) {
					case IS_STRING:
						if (Z_STRLEN_PP(val) == 0) {
							...
							/* better regex? */
							if (jonj_pgsql_convert_match(Z_STRVAL_PP(val), Z_STRLEN_PP(val), "^[-+]?[0-9]*\\.?[0-9]+([eE][-+]?[0-9]+)?$", 0 TSRMLS_CC) == FAILURE) {
								if (jonj_pgsql_convert_match(Z_STRVAL_PP(val), Z_STRLEN_PP(val), "^[+-]{0,1}(inf)(inity){0,1}$", 1 TSRMLS_CC) == FAILURE) {
									err = 1;
								} else {
									ZVAL_STRING(new_val, Z_STRVAL_PP(val), 1);
									jonj_pgsql_add_quotes(new_val, 1 TSRMLS_CC);
								}
							}
							else {
								ZVAL_STRING(new_val, Z_STRVAL_PP(val), 1);
				...
				PGSQL_CONV_CHECK_IGNORE();
				if (err) {
					jonj_error_docref(NULL TSRMLS_CC, E_NOTICE, "Expects NULL, string, long or double value for PostgreSQL '%s' (%s)", Z_STRVAL_PP(type), field);
				}
				break;
			...
			case PG_UNIX_TIME_INTERVAL:
				...
				switch (Z_TYPE_PP(val)) {
					case IS_STRING:
						if (Z_STRLEN_PP(val) == 0) {
							...
							/* better regex? */
							if (jonj_pgsql_convert_match(Z_STRVAL_PP(val), Z_STRLEN_PP(val), "^[0-9]+$", 0 TSRMLS_CC) == FAILURE) {
								err = 1;
							}
							else {
								ZVAL_STRINGL(new_val, Z_STRVAL_PP(val), Z_STRLEN_PP(val), 1);
				...
				PGSQL_CONV_CHECK_IGNORE();
				if (err) {
					jonj_error_docref(NULL TSRMLS_CC, E_NOTICE, "Expects NULL, string, long or double value for '%s' (%s)", Z_STRVAL_PP(type), field);
				}
				break;
			...
			case PG_INET:
				switch (Z_TYPE_PP(val)) {
					case IS_STRING:
						if (Z_STRLEN_PP(val) == 0) {
							...
							if (jonj_pgsql_convert_match(Z_STRVAL_PP(val), Z_STRLEN_PP(val), "^(([0-9a-fA-F]{1,4}:){7,7}[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,7}:|([0-9a-fA-F]{1,4}:){1,6}:[0-9a-fA-F]{1,4}|([0-9a-fA-F]{1,4}:){1,5}(:[0-9a-fA-F]{1,4}){1,2}|([0-9a-fA-F]{1,4}:){1,4}(:[0-9a-fA-F]{1,4}){1,3}|([0-9a-fA-F]{1,4}:){1,3}(:[0-9a-fA-F]{1,4}){1,4}|([0-9a-fA-F]{1,4}:){1,2}(:[0-9a-fA-F]{1,4}){1,5}|[0-9a-fA-F]{1,4}:((:[0-9a-fA-F]{1,4}){1,6})|:((:[0-9a-fA-F]{1,4}){1,7}|:)|fe80:(:[0-9a-fA-F]{0,4}){0,4}%[0-9a-zA-Z]{1,}|::(ffff(:0{1,4}){0,1}:){0,1}((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9]).){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])|([0-9a-fA-F]{1,4}:){1,4}:((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9]).){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9]))$", 0 TSRMLS_CC) == FAILURE) {
								err = 1;
							}
							else {
								ZVAL_STRINGL(new_val, Z_STRVAL_PP(val), Z_STRLEN_PP(val), 1);
				...
				PGSQL_CONV_CHECK_IGNORE();
				if (err) {
					jonj_error_docref(NULL TSRMLS_CC, E_NOTICE, "Expects NULL or string for '%s' (%s)", Z_STRVAL_PP(type), field);
				}
				break;
			...
			case PG_TIMESTAMP_WITH_TIMEZONE:
				switch(Z_TYPE_PP(val)) {
					case IS_STRING:
						if (Z_STRLEN_PP(val) == 0) {
							...
							/* better regex? */
							if (jonj_pgsql_convert_match(Z_STRVAL_PP(val), Z_STRLEN_PP(val), "^([0-9]{4}[/-][0-9]{1,2}[/-][0-9]{1,2})([ \\t]+(([0-9]{1,2}:[0-9]{1,2}){1}(:[0-9]{1,2}){0,1}(\\.[0-9]+){0,1}([ \\t]*([+-][0-9]{1,4}(:[0-9]{1,2}){0,1}|[-a-zA-Z_/+]{1,50})){0,1})){0,1}$", 1 TSRMLS_CC) == FAILURE) {
								err = 1;
							} else {
								ZVAL_STRING(new_val, Z_STRVAL_PP(val), 1);
								jonj_pgsql_add_quotes(new_val, 1 TSRMLS_CC);
				...
				PGSQL_CONV_CHECK_IGNORE();
				if (err) {
					jonj_error_docref(NULL TSRMLS_CC, E_NOTICE, "Expects NULL or string for PostgreSQL %s field (%s)", Z_STRVAL_PP(type), field);
				}
				break;
				...
				switch(Z_TYPE_PP(val)) {
					case IS_STRING:
						if (Z_STRLEN_PP(val) == 0) {
							...
							/* FIXME: better regex must be used */
							if (jonj_pgsql_convert_match(Z_STRVAL_PP(val), Z_STRLEN_PP(val), "^([0-9]{4}[/-][0-9]{1,2}[/-][0-9]{1,2})$", 1 TSRMLS_CC) == FAILURE) {
								err = 1;
							}
							else {
								ZVAL_STRINGL(new_val, Z_STRVAL_PP(val), Z_STRLEN_PP(val), 1);
				...
				switch(Z_TYPE_PP(val)) {
					case IS_STRING:
						if (Z_STRLEN_PP(val) == 0) {
							...
							/* FIXME: better regex must be used */
							if (jonj_pgsql_convert_match(Z_STRVAL_PP(val), Z_STRLEN_PP(val), "^(([0-9]{1,2}:[0-9]{1,2}){1}(:[0-9]{1,2}){0,1})){0,1}$", 1 TSRMLS_CC) == FAILURE) {
								err = 1;
							}
							else {
								ZVAL_STRINGL(new_val, Z_STRVAL_PP(val), Z_STRLEN_PP(val), 1);
					...
					case IS_STRING:
						if (Z_STRLEN_PP(val) == 0) {
							...
							/* From the Postgres docs:
							   ...
							   sec'.
							*/
							if (jonj_pgsql_convert_match(Z_STRVAL_PP(val), Z_STRLEN_PP(val),
														"^(@?[ \\t]+)?("
				...
				switch(Z_TYPE_PP(val)) {
					case IS_STRING:
						if (Z_STRLEN_PP(val) == 0) {
							...
							if (jonj_pgsql_convert_match(Z_STRVAL_PP(val), Z_STRLEN_PP(val), "^([0-9a-f]{2,2}:){5,5}[0-9a-f]{2,2}$", 1 TSRMLS_CC) == FAILURE) {
								err = 1;
							}
							else {
								ZVAL_STRINGL(new_val, Z_STRVAL_PP(val), Z_STRLEN_PP(val), 1);
			...
			default:
				/* should not happen */
				jonj_error_docref(NULL TSRMLS_CC, E_NOTICE, "Unknown or system data type '%s' for '%s'. Report error", Z_STRVAL_PP(type), field);
				err = 1;
				break;
		} /* switch */
		...
		if (!skip_field) {
			...
			if (_jonj_pgsql_detect_identifier_escape(field, field_len) == SUCCESS) {
...
JONJ_FUNCTION(pg_convert)
{
	...
	if (option & ~PGSQL_CONV_OPTS) {
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Invalid option is specified");
		RETURN_FALSE;
	}
	if (!table_name_len) {
		jonj_error_docref(NULL TSRMLS_CC, E_NOTICE, "Table name is invalid");
		RETURN_FALSE;
	}

	ZEND_FETCH_RESOURCE2(pg_link, PGconn *, &pgsql_link, id, "PostgreSQL link", le_link, le_plink);

	if (jonj_pgsql_flush_query(pg_link TSRMLS_CC)) {
		jonj_error_docref(NULL TSRMLS_CC, E_NOTICE, "Detected unhandled result(s) in connection");
	}
	array_init(return_value);
	if (jonj_pgsql_convert(pg_link, table_name, values, return_value, option TSRMLS_CC) == FAILURE) {
		zval_dtor(return_value);
		RETURN_FALSE;
	}
}
...
static int do_exec(smart_str *querystr, int expect, PGconn *pg_link, ulong opt TSRMLS_DC)
{
	if (opt & PGSQL_DML_ASYNC) {
		...
		if (PQresultStatus(pg_result) == expect) {
			...
			jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "%s", PQresultErrorMessage(pg_result));
			PQclear(pg_result);
		}
	}
...
static inline void build_tablename(smart_str *querystr, PGconn *pg_link, const char *table)
{
	...
	token = jonj_strtok_r(table_copy, ".", &tmp);
	if (token == NULL) {
		token = table;
	}
	len = strlen(token);
	if (_jonj_pgsql_detect_identifier_escape(token, len) == SUCCESS) {
	...
	if (tmp && *tmp) {
		len = strlen(tmp);
		/* "schema"."table" format */
		if (_jonj_pgsql_detect_identifier_escape(tmp, len) == SUCCESS) {
...
/* {{{ jonj_pgsql_insert
 */
JONJ_PGSQL_API int jonj_pgsql_insert(PGconn *pg_link, const char *table, zval *var_array, ulong opt, char **sql TSRMLS_DC)
{
	...
	if (!(opt & (PGSQL_DML_NO_CONV|PGSQL_DML_ESCAPE))) {
		...
		if (jonj_pgsql_convert(pg_link, table, var_array, converted, (opt & PGSQL_CONV_OPTS) TSRMLS_CC) == FAILURE) {
			goto cleanup;
		}
		var_array = converted;
	}
	...
	while ((key_type = zend_hash_get_current_key_ex(Z_ARRVAL_P(var_array), &fld,
		...
		if (key_type == HASH_KEY_IS_LONG) {
			jonj_error_docref(NULL TSRMLS_CC, E_NOTICE, "Expects associative array for values to be inserted");
			goto cleanup;
		}
	...
	for (zend_hash_internal_pointer_reset_ex(Z_ARRVAL_P(var_array), &pos);
		...
		switch(Z_TYPE_PP(val)) {
			...
			case IS_NULL:
				...
				break;
			default:
				jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Expects scaler values. type = %d", Z_TYPE_PP(val));
				goto cleanup;
				break;
		}
		smart_str_appendc(&querystr, ',');
...
JONJ_FUNCTION(pg_insert)
{
	...
	if (option & PGSQL_DML_EXEC) {
		...
		if (jonj_pgsql_insert(pg_link, table, values, option|PGSQL_DML_STRING, &sql TSRMLS_CC) == FAILURE) {
			RETURN_FALSE;
		}
		...
		switch (status) {
			...
			case PGRES_NONFATAL_ERROR:
			case PGRES_FATAL_ERROR:
				JONJ_PQ_ERROR("Query failed: %s", pg_link);
				PQclear(pg_result);
				RETURN_FALSE;
				break;
			case PGRES_COMMAND_OK: /* successful command that did not return rows */
	...
	} else if (jonj_pgsql_insert(pg_link, table, values, option, &sql TSRMLS_CC) == FAILURE) {
		RETURN_FALSE;
	}
	if (return_sql) {
		RETURN_STRING(sql, 0);
...
/* {{{ jonj_pgsql_update
 */
JONJ_PGSQL_API int jonj_pgsql_update(PGconn *pg_link, const char *table, zval *var_array, zval *ids_array, ulong opt, char **sql TSRMLS_DC)
{
	...
	if (!(opt & (PGSQL_DML_NO_CONV|PGSQL_DML_ESCAPE))) {
		...
		if (jonj_pgsql_convert(pg_link, table, var_array, var_converted, (opt & PGSQL_CONV_OPTS) TSRMLS_CC) == FAILURE) {
			goto cleanup;
		}
		var_array = var_converted;
		MAKE_STD_ZVAL(ids_converted);
		array_init(ids_converted);
		if (jonj_pgsql_convert(pg_link, table, ids_array, ids_converted, (opt & PGSQL_CONV_OPTS) TSRMLS_CC) == FAILURE) {
			goto cleanup;
		}
...
JONJ_FUNCTION(pg_update)
{
	...
	if (jonj_pgsql_update(pg_link, table, values, ids, option, &sql TSRMLS_CC) == FAILURE) {
		RETURN_FALSE;
	}
...
/* {{{ jonj_pgsql_delete
 */
JONJ_PGSQL_API int jonj_pgsql_delete(PGconn *pg_link, const char *table, zval *ids_array, ulong opt, char **sql TSRMLS_DC)
{
...
JONJ_FUNCTION(pg_delete)
{
	...
	if (jonj_pgsql_delete(pg_link, table, ids, option, &sql TSRMLS_CC) == FAILURE) {
		RETURN_FALSE;
	}
	if (option & PGSQL_DML_STRING) {
		RETURN_STRING(sql, 0);
...
/* {{{ jonj_pgsql_select
 */
JONJ_PGSQL_API int jonj_pgsql_select(PGconn *pg_link, const char *table, zval *ids_array, zval *ret_array, ulong opt, char **sql TSRMLS_DC)
{
	zval *ids_converted = NULL;
	smart_str querystr = {0};
	int ret = FAILURE;
	...
	if (PQresultStatus(pg_result) == PGRES_TUPLES_OK) {
		ret = jonj_pgsql_result2array(pg_result, ret_array TSRMLS_CC);
	} else {
		jonj_error_docref(NULL TSRMLS_CC, E_NOTICE, "Failed to execute '%s'", querystr.c);
	}
	PQclear(pg_result);
...
JONJ_FUNCTION(pg_select)
{
	...
	array_init(return_value);
	if (jonj_pgsql_select(pg_link, table, ids, return_value, option, &sql TSRMLS_CC) == FAILURE) {
		zval_dtor(return_value);
		RETURN_FALSE;
	}
	if (option & PGSQL_DML_STRING) {
