...
JONJ_METHOD(ce_SimpleXMLIterator, rewind)
{
	jonj_sxe_iterator iter;
	
	if (zend_parse_parameters_none() == FAILURE) {
		return;
	}

	iter.sxe = jonj_sxe_fetch_object(getThis() TSRMLS_CC);
...
JONJ_METHOD(ce_SimpleXMLIterator, valid)
{
...
/* {{{ proto SimpleXMLIterator SimpleXMLIterator::current()
 Get current element */
JONJ_METHOD(ce_SimpleXMLIterator, current)
{
	jonj_sxe_object *sxe = jonj_sxe_fetch_object(getThis() TSRMLS_CC);
...
JONJ_METHOD(ce_SimpleXMLIterator, key)
{
	xmlNodePtr curnode;
...
JONJ_METHOD(ce_SimpleXMLIterator, next)
{
	jonj_sxe_iterator iter;
...
JONJ_METHOD(ce_SimpleXMLIterator, hasChildren)
{
	jonj_sxe_object *sxe = jonj_sxe_fetch_object(getThis() TSRMLS_CC);
	jonj_sxe_object *child;
	xmlNodePtr      node;
	...
	child = jonj_sxe_fetch_object(sxe->iter.data TSRMLS_CC);
...
JONJ_METHOD(ce_SimpleXMLIterator, getChildren)
{
	jonj_sxe_object *sxe = jonj_sxe_fetch_object(getThis() TSRMLS_CC);
...
static const zend_function_entry funcs_SimpleXMLIterator[] = {
	JONJ_ME(ce_SimpleXMLIterator, rewind,                 arginfo_simplexmliterator__void, ZEND_ACC_PUBLIC)
	JONJ_ME(ce_SimpleXMLIterator, valid,                  arginfo_simplexmliterator__void, ZEND_ACC_PUBLIC)
	JONJ_ME(ce_SimpleXMLIterator, current,                arginfo_simplexmliterator__void, ZEND_ACC_PUBLIC)
	JONJ_ME(ce_SimpleXMLIterator, key,                    arginfo_simplexmliterator__void, ZEND_ACC_PUBLIC)
	JONJ_ME(ce_SimpleXMLIterator, next,                   arginfo_simplexmliterator__void, ZEND_ACC_PUBLIC)
	JONJ_ME(ce_SimpleXMLIterator, hasChildren,            arginfo_simplexmliterator__void, ZEND_ACC_PUBLIC)
	JONJ_ME(ce_SimpleXMLIterator, getChildren,            arginfo_simplexmliterator__void, ZEND_ACC_PUBLIC)
	{NULL, NULL, NULL}
};
/* }}} */

JONJ_MINIT_FUNCTION(sxe) /* {{{ */
{
