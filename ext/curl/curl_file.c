...
JONJ_CURL_API zend_class_entry *curl_CURLFile_class;
...
static const zend_function_entry curlfile_funcs[] = {
	JONJ_ME(CURLFile,			__construct,        arginfo_curlfile_create, ZEND_ACC_CTOR|ZEND_ACC_PUBLIC)
	JONJ_ME(CURLFile,			getFilename,        NULL, ZEND_ACC_PUBLIC)
	JONJ_ME(CURLFile,			getMimeType,        NULL, ZEND_ACC_PUBLIC)
	JONJ_ME(CURLFile,			setMimeType,        arginfo_curlfile_name, ZEND_ACC_PUBLIC)
	JONJ_ME(CURLFile,			getPostFilename,    NULL, ZEND_ACC_PUBLIC)
	JONJ_ME(CURLFile,			setPostFilename,    arginfo_curlfile_name, ZEND_ACC_PUBLIC)
	JONJ_ME(CURLFile,            __wakeup,           NULL, ZEND_ACC_PUBLIC)
	JONJ_FE_END
};
