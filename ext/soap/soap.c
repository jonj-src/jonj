	...
	{ \
		...
		if (zend_hash_find(Z_OBJPROP_P(this_ptr),"service", sizeof("service"), (void **)&tmp) != FAILURE) { \
			ss = (soapServicePtr)zend_fetch_resource(tmp TSRMLS_CC, -1, "service", NULL, 1, le_service); \
	                ...
	                jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Can not fetch service object"); \
...
#define JONJ_SOAP_SERVER_CLASSNAME "SoapServer"
#define JONJ_SOAP_CLIENT_CLASSNAME "SoapClient"
#define JONJ_SOAP_VAR_CLASSNAME    "SoapVar"
#define JONJ_SOAP_FAULT_CLASSNAME  "SoapFault"
#define JONJ_SOAP_PARAM_CLASSNAME  "SoapParam"
#define JONJ_SOAP_HEADER_CLASSNAME "SoapHeader"

JONJ_RINIT_FUNCTION(soap);
JONJ_MINIT_FUNCTION(soap);
JONJ_MSHUTDOWN_FUNCTION(soap);
JONJ_MINFO_FUNCTION(soap);

/*
  Registry Functions
  TODO: this!
*/
JONJ_FUNCTION(soap_encode_to_xml);
JONJ_FUNCTION(soap_encode_to_zval);
JONJ_FUNCTION(use_soap_error_handler);
JONJ_FUNCTION(is_soap_fault);


/* Server Functions */
JONJ_METHOD(SoapServer, SoapServer);
JONJ_METHOD(SoapServer, setClass);
JONJ_METHOD(SoapServer, setObject);
JONJ_METHOD(SoapServer, addFunction);
JONJ_METHOD(SoapServer, getFunctions);
JONJ_METHOD(SoapServer, handle);
JONJ_METHOD(SoapServer, setPersistence);
JONJ_METHOD(SoapServer, fault);
JONJ_METHOD(SoapServer, addSoapHeader);

/* Client Functions */
JONJ_METHOD(SoapClient, SoapClient);
JONJ_METHOD(SoapClient, __call);
JONJ_METHOD(SoapClient, __getLastRequest);
JONJ_METHOD(SoapClient, __getLastResponse);
JONJ_METHOD(SoapClient, __getLastRequestHeaders);
JONJ_METHOD(SoapClient, __getLastResponseHeaders);
JONJ_METHOD(SoapClient, __getFunctions);
JONJ_METHOD(SoapClient, __getTypes);
JONJ_METHOD(SoapClient, __doRequest);
JONJ_METHOD(SoapClient, __setCookie);
JONJ_METHOD(SoapClient, __getCookies);
JONJ_METHOD(SoapClient, __setLocation);
JONJ_METHOD(SoapClient, __setSoapHeaders);

/* SoapVar Functions */
JONJ_METHOD(SoapVar, SoapVar);

/* SoapFault Functions */
JONJ_METHOD(SoapFault, SoapFault);
JONJ_METHOD(SoapFault, __toString);

/* SoapParam Functions */
JONJ_METHOD(SoapParam, SoapParam);

/* SoapHeader Functions */
JONJ_METHOD(SoapHeader, SoapHeader);

#define SOAP_CTOR(class_name, func_name, arginfo, flags) JONJ_ME(class_name, func_name, arginfo, flags)
...
static const zend_function_entry soap_functions[] = {
	JONJ_FE(use_soap_error_handler, 	arginfo_soap_use_soap_error_handler)
	JONJ_FE(is_soap_fault, 			arginfo_soap_is_soap_fault)
	JONJ_FE_END
};

static const zend_function_entry soap_fault_functions[] = {
	SOAP_CTOR(SoapFault, SoapFault, arginfo_soapfault_soapfault, 0)
	JONJ_ME(SoapFault, __toString, arginfo_soap__void, 0)
	JONJ_FE_END
};

static const zend_function_entry soap_server_functions[] = {
	SOAP_CTOR(SoapServer, SoapServer, 	arginfo_soapserver_soapserver, 0)
	JONJ_ME(SoapServer, setPersistence, 	arginfo_soapserver_setpersistence, 0)
	JONJ_ME(SoapServer, setClass, 		arginfo_soapserver_setclass, 0)
	JONJ_ME(SoapServer, setObject, 		arginfo_soapserver_setobject, 0)
	JONJ_ME(SoapServer, addFunction, 	arginfo_soapserver_addfunction, 0)
	JONJ_ME(SoapServer, getFunctions, 	arginfo_soapserver_getfunctions, 0)
	JONJ_ME(SoapServer, handle, 			arginfo_soapserver_handle, 0)
	JONJ_ME(SoapServer, fault, 			arginfo_soapserver_fault, 0)
	JONJ_ME(SoapServer, addSoapHeader, 	arginfo_soapserver_addsoapheader, 0)
	JONJ_FE_END
};

static const zend_function_entry soap_client_functions[] = {
	SOAP_CTOR(SoapClient, SoapClient, arginfo_soapclient_soapclient, 0)
	JONJ_ME(SoapClient, __call, 						arginfo_soapclient___call, 0)
	ZEND_NAMED_ME(__soapCall, ZEND_MN(SoapClient___call), arginfo_soapclient___soapcall, 0)
	JONJ_ME(SoapClient, __getLastRequest, 			arginfo_soapclient___getlastrequest, 0)
	JONJ_ME(SoapClient, __getLastResponse, 			arginfo_soapclient___getlastresponse, 0)
	JONJ_ME(SoapClient, __getLastRequestHeaders, 	arginfo_soapclient___getlastrequestheaders, 0)
	JONJ_ME(SoapClient, __getLastResponseHeaders, 	arginfo_soapclient___getlastresponseheaders, 0)
	JONJ_ME(SoapClient, __getFunctions, 				arginfo_soapclient___getfunctions, 0)
	JONJ_ME(SoapClient, __getTypes, 					arginfo_soapclient___gettypes, 0)
	JONJ_ME(SoapClient, __doRequest, 				arginfo_soapclient___dorequest, 0)
	JONJ_ME(SoapClient, __setCookie, 				arginfo_soapclient___setcookie, 0)
	JONJ_ME(SoapClient, __getCookies, 				arginfo_soapclient___getcookies, 0)
	JONJ_ME(SoapClient, __setLocation, 				arginfo_soapclient___setlocation, 0)
	JONJ_ME(SoapClient, __setSoapHeaders, 			arginfo_soapclient___setsoapheaders, 0)
	JONJ_FE_END
};
...
static JONJ_INI_MH(OnUpdateCacheDir)
{
...
JONJ_INI_BEGIN()
STD_JONJ_INI_ENTRY("soap.wsdl_cache_enabled",     "1", JONJ_INI_ALL, OnUpdateBool,
                  cache_enabled, zend_soap_globals, soap_globals)
STD_JONJ_INI_ENTRY("soap.wsdl_cache_dir",         "/tmp", JONJ_INI_ALL, OnUpdateCacheDir,
                  cache_dir, zend_soap_globals, soap_globals)
STD_JONJ_INI_ENTRY("soap.wsdl_cache_ttl",         "86400", JONJ_INI_ALL, OnUpdateLong,
                  cache_ttl, zend_soap_globals, soap_globals)
STD_JONJ_INI_ENTRY("soap.wsdl_cache",             "1", JONJ_INI_ALL, OnUpdateCacheMode,
                  cache_mode, zend_soap_globals, soap_globals)
STD_JONJ_INI_ENTRY("soap.wsdl_cache_limit",       "5", JONJ_INI_ALL, OnUpdateLong,
                  cache_limit, zend_soap_globals, soap_globals)
JONJ_INI_END()

static HashTable defEnc, defEncIndex, defEncNs;

static void jonj_soap_prepare_globals()
{
	int i;
	encodePtr enc;
...
static void jonj_soap_init_globals(zend_soap_globals *soap_globals TSRMLS_DC)
{
...
JONJ_MINIT_FUNCTION(soap)
{
	...
	jonj_soap_prepare_globals();
	ZEND_INIT_MODULE_GLOBALS(soap, jonj_soap_init_globals, NULL);
...
JONJ_MINFO_FUNCTION(soap)
{
	...
	jonj_info_print_table_row(2, "Soap Client", "enabled");
	jonj_info_print_table_row(2, "Soap Server", "enabled");
...
JONJ_METHOD(SoapParam, SoapParam)
{
	...
	if (name_length == 0) {
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Invalid parameter name");
		return;
	}
...
JONJ_METHOD(SoapHeader, SoapHeader)
{
	...
	if (ns_len == 0) {
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Invalid namespace");
		return;
	}
	if (name_len == 0) {
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Invalid header name");
		return;
	}
	...
	if (actor == NULL) {
	  ...
	  (Z_LVAL_P(actor) == SOAP_ACTOR_NEXT ||
	   ...
	   Z_LVAL_P(actor) == SOAP_ACTOR_UNLIMATERECEIVER)) {
		...
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Invalid actor");
	}
}
	...
	if (Z_TYPE_P(code) == IS_NULL) {
		...
		if (Z_TYPE_PP(t_ns) == IS_STRING && Z_TYPE_PP(t_code) == IS_STRING) {
		  ...
		  fault_code_len = Z_STRLEN_PP(t_code);
			...
			jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Invalid fault code");
			return;
		}
	} else  {
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Invalid fault code");
...
JONJ_METHOD(SoapVar, SoapVar)
{
	...
	if (Z_TYPE_P(type) == IS_NULL) {
		...
		if (zend_hash_index_exists(&SOAP_GLOBAL(defEncIndex), Z_LVAL_P(type))) {
			...
			jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Invalid type ID");
			return;
		}
	}
...
static HashTable* soap_create_typemap(sdlPtr sdl, HashTable *ht TSRMLS_DC)
{
	...
	while (zend_hash_get_current_data_ex(ht, (void**)&tmp, &pos1) == SUCCESS) {
		...
		if (Z_TYPE_PP(tmp) != IS_ARRAY) {
			jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Wrong 'typemap' option");
			return NULL;
		}
		ht2 = Z_ARRVAL_PP(tmp);
...
JONJ_METHOD(SoapServer, SoapServer)
{
	...
	if (zend_parse_parameters_ex(ZEND_PARSE_PARAMS_QUIET, ZEND_NUM_ARGS() TSRMLS_CC, "z|a", &wsdl, &options) == FAILURE) {
		jonj_error_docref(NULL TSRMLS_CC, E_ERROR, "Invalid parameters");
	}
	...
	if (options != NULL) {
		...
		if (zend_hash_find(ht, "soap_version", sizeof("soap_version"), (void**)&tmp) == SUCCESS) {
			if (Z_TYPE_PP(tmp) == IS_LONG &&
				...
				jonj_error_docref(NULL TSRMLS_CC, E_ERROR, "'soap_version' option must be SOAP_1_1 or SOAP_1_2");
			}
		}
		...
		if (zend_hash_find(ht, "uri", sizeof("uri"), (void**)&tmp) == SUCCESS &&
			...
			jonj_error_docref(NULL TSRMLS_CC, E_ERROR, "'uri' option is required in nonWSDL mode");
		}
		...
		if (zend_hash_find(ht, "encoding", sizeof("encoding"), (void**)&tmp) == SUCCESS &&
			...
			if (encoding == NULL) {
				jonj_error_docref(NULL TSRMLS_CC, E_ERROR, "Invalid 'encoding' option - '%s'", Z_STRVAL_PP(tmp));
			} else {
	...
	if (zend_parse_parameters(ZEND_NUM_ARGS() TSRMLS_CC, "l", &value) != FAILURE) {
		if (service->type == SOAP_CLASS) {
			if (value == SOAP_PERSISTENCE_SESSION ||
				...
				jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Tried to set persistence with bogus value (%ld)", value);
				return;
			}
		} else {
			jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Tried to set persistence when you are using you SOAP SERVER in function mode, no persistence needed");
			return;
		}
	}
...
JONJ_METHOD(SoapServer, setClass)
{
	...
	if (found != FAILURE) {
		...
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Tried to set a non existent class (%s)", classname);
		return;
	}
...
JONJ_METHOD(SoapServer, addFunction)
{
	...
	if (function_name->type == IS_ARRAY) {
		if (service->type == SOAP_FUNCTIONS) {
			...
			while (zend_hash_get_current_data_ex(Z_ARRVAL_P(function_name), (void **)&tmp_function, &pos) != FAILURE) {
				...
				if (Z_TYPE_PP(tmp_function) != IS_STRING) {
					jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Tried to add a function that isn't a string");
					return;
				}
				...
				if (zend_hash_find(EG(function_table), key, key_len+1, (void**)&f) == FAILURE) {
					jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Tried to add a non existent function '%s'", Z_STRVAL_PP(tmp_function));
					return;
				}
		...
		if (zend_hash_find(EG(function_table), key, key_len+1, (void**)&f) == FAILURE) {
			jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Tried to add a non existent function '%s'", Z_STRVAL_P(function_name));
			return;
		}
		if (service->soap_functions.ft == NULL) {
			service->soap_functions.functions_all = FALSE;
		...
		if (Z_LVAL_P(function_name) == SOAP_FUNCTIONS_ALL) {
			...
			jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Invalid value passed");
			return;
		}
	}
...
*/
	...
	if (jonj_output_start_default(TSRMLS_C) != SUCCESS) {
		jonj_error_docref(NULL TSRMLS_CC, E_ERROR,"ob_start failed");
	}

	if (ZEND_NUM_ARGS() == 0) {
		if (SG(request_info).request_body && 0 == jonj_stream_rewind(SG(request_info).request_body)) {
			zval **server_vars, **encoding;
			jonj_stream_filter *zf = NULL;
			...
			if (zend_hash_find(&EG(symbol_table), "_SERVER", sizeof("_SERVER"), (void **) &server_vars) == SUCCESS &&
				...
				||  strcmp(Z_STRVAL_PP(encoding),"deflate") == 0
					...
					zf = jonj_stream_filter_create("zlib.inflate", &filter_params, 0 TSRMLS_CC);
					zval_dtor(&filter_params);

					if (zf) {
						jonj_stream_filter_append(&SG(request_info).request_body->readfilters, zf);
					} else {
						jonj_error_docref(NULL TSRMLS_CC, E_WARNING,"Can't uncompress compressed request");
						return;
					}
				} else {
					jonj_error_docref(NULL TSRMLS_CC, E_WARNING,"Request is compressed with unknown compression '%s'",Z_STRVAL_PP(encoding));
					return;
				}
			}

			doc_request = soap_xmlParseFile("jonj://input" TSRMLS_CC);

			if (zf) {
				jonj_stream_filter_remove(zf, 1 TSRMLS_CC);
			}
		} else {
		...
		if (soap_obj == NULL) {
			...
			if (zend_hash_exists(&Z_OBJCE_P(tmp_soap)->function_table, ZEND_CONSTRUCTOR_FUNC_NAME, sizeof(ZEND_CONSTRUCTOR_FUNC_NAME))) {
				...
				if (call_user_function(NULL, &tmp_soap, &constructor, &c_ret, service->soap_class.argc, service->soap_class.argv TSRMLS_CC) == FAILURE) {
					jonj_error_docref(NULL TSRMLS_CC, E_ERROR, "Error calling constructor");
				}
				if (EG(exception)) {
					jonj_output_discard(TSRMLS_C);
					if (Z_TYPE_P(EG(exception)) == IS_OBJECT &&
				...
				if (zend_hash_exists(&Z_OBJCE_P(tmp_soap)->function_table, jonj_strtolower(class_name, class_name_len), class_name_len+1)) {
					zval c_ret, constructor;
	...
	if (soap_headers != NULL) {
		...
		while (header != NULL) {
			...
			if (zend_hash_exists(function_table, jonj_strtolower(fn_name, Z_STRLEN(h->function_name)), Z_STRLEN(h->function_name) + 1) ||
				...
				if (call_status != SUCCESS) {
					jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Function '%s' call failed", Z_STRVAL(h->function_name));
					return;
				}
	...
	if (zend_hash_exists(function_table, jonj_strtolower(fn_name, Z_STRLEN(function_name)), Z_STRLEN(function_name) + 1) ||
	    ((service->type == SOAP_CLASS || service->type == SOAP_OBJECT) &&
	     zend_hash_exists(function_table, ZEND_CALL_FUNC_NAME, sizeof(ZEND_CALL_FUNC_NAME)))) {
		if (service->type == SOAP_CLASS || service->type == SOAP_OBJECT) {
		...
		jonj_error(E_ERROR, "Function '%s' doesn't exist", Z_STRVAL(function_name));
	}
	efree(fn_name);
	...
	if (call_status == SUCCESS) {
		...
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Function '%s' call failed", Z_STRVAL(function_name));
		return;
	}
	...
	if (doc_return) {
		...
		if (size == 0) {
			jonj_error_docref(NULL TSRMLS_CC, E_ERROR, "Dump memory failed");
		}
...
JONJ_METHOD(SoapServer, addSoapHeader)
{
	...
	if (!service || !service->soap_headers_ptr) {
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "The SoapServer::addSoapHeader function may be called only during SOAP request processing");
		return;
	}
	...
	if (SOAP_GLOBAL(error_object) &&
		...
		if (error_num == E_USER_ERROR ||
			...
			if (SOAP_GLOBAL(error_object) &&
				...
				if (jonj_output_get_length(&outbuflen TSRMLS_CC) != FAILURE && Z_LVAL(outbuflen) != 0) {
					ALLOC_INIT_ZVAL(outbuf);
					jonj_output_get_contents(outbuf TSRMLS_CC);
				}
				jonj_output_discard(TSRMLS_C);
...
JONJ_METHOD(SoapClient, SoapClient)
{
	...
	if (Z_TYPE_P(wsdl) != IS_STRING && Z_TYPE_P(wsdl) != IS_NULL) {
		jonj_error_docref(NULL TSRMLS_CC, E_ERROR, "$wsdl must be string or null");
	}
	...
	if (options != NULL) {
		...
		if (zend_hash_find(ht, "stream_context", sizeof("stream_context"), (void**)&tmp) == SUCCESS &&
			...
			context = jonj_stream_context_from_zval(*tmp, 1);
		...
		if (zend_hash_find(ht, "location", sizeof("location"), (void**)&tmp) == SUCCESS &&
			...
			jonj_error_docref(NULL TSRMLS_CC, E_ERROR, "'location' option is required in nonWSDL mode");
		}
		...
		if (zend_hash_find(ht, "local_cert", sizeof("local_cert"), (void**)&tmp) == SUCCESS &&
		  ...
		  if (!context) {
 			...
 			jonj_stream_context_set_option(context, "ssl", "local_cert", *tmp);
			if (zend_hash_find(ht, "passphrase", sizeof("passphrase"), (void**)&tmp) == SUCCESS &&
			    Z_TYPE_PP(tmp) == IS_STRING) {
				jonj_stream_context_set_option(context, "ssl", "passphrase", *tmp);
			}
		}
		...
		jonj_error_docref(NULL TSRMLS_CC, E_ERROR, "'location' and 'uri' options are required in nonWSDL mode");
	}
...
static void verify_soap_headers_array(HashTable *ht TSRMLS_DC)
{
	...
	while (zend_hash_get_current_data(ht, (void**)&tmp) == SUCCESS) {
		if (Z_TYPE_PP(tmp) != IS_OBJECT ||
			...
			jonj_error_docref(NULL TSRMLS_CC, E_ERROR, "Invalid SOAP header");
		}
...
JONJ_METHOD(SoapClient, __call)
{
	...
	if (headers == NULL || Z_TYPE_P(headers) == IS_NULL) {
		...
		jonj_error_docref(NULL TSRMLS_CC, E_WARNING, "Invalid SOAP header");
		return;
	}
	...
	if (func == NULL) {
		...
		if (sdl != NULL && function == NULL) {
			if (*version == SOAP_1_2) {
				...
				jonj_error(E_ERROR, "Procedure '%s' not present", func->name);
			}
		}
	}
	  ...
	  char *detail_name;
		...
		if (version == SOAP_1_1) {
			if (zend_hash_find(prop, "faultcode", sizeof("faultcode"), (void**)&tmp) == SUCCESS &&
				...
				char *str = jonj_escape_html_entities((unsigned char*)Z_STRVAL_PP(tmp), Z_STRLEN_PP(tmp), &new_len, 0, 0, NULL TSRMLS_CC);
