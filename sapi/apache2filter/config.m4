...
if test "$JONJ_APXS2FILTER" != "no"; then
  if test "$JONJ_APXS2FILTER" = "yes"; then
    APXS=apxs
    ...
    JONJ_EXPAND_PATH($JONJ_APXS2FILTER, APXS)
  fi
  ...
  *aix*)
    ...
    JONJ_SELECT_SAPI(apache2filter, shared, sapi_apache2.c apache_config.c jonj_functions.c, $APACHE_CFLAGS)
  ...
  *darwin*)
    ...
    JONJ_SELECT_SAPI(apache2filter, bundle, sapi_apache2.c apache_config.c jonj_functions.c, $APACHE_CFLAGS)
