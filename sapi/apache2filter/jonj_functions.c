...
static const zend_function_entry apache_functions[] = {
	JONJ_FE(apache_lookup_uri, 		arginfo_apache2filter_lookup_uri)
	JONJ_FE(virtual, 				arginfo_apache2filter_virtual)
	JONJ_FE(apache_request_headers, 	arginfo_apache2filter_getallheaders)
	JONJ_FE(apache_response_headers, arginfo_apache2filter_response_headers)
	JONJ_FE(apache_setenv, 			arginfo_apache2filter_setenv)
	JONJ_FE(apache_getenv, 			arginfo_apache2filter_getenv)
	JONJ_FE(apache_note, 			arginfo_apache2filter_note)
	JONJ_FE(apache_get_version, 		arginfo_apache2filter_get_version)
	JONJ_FE(apache_get_modules, 		arginfo_apache2filter_get_modules)
	JONJ_FALIAS(getallheaders, 		apache_request_headers, arginfo_apache2filter_getallheaders)
	{NULL, NULL, NULL}
};
