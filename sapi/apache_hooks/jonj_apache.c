...
const zend_function_entry apache_functions[] = {
	JONJ_FE(virtual,									arginfo_apachehooks_virtual)
	JONJ_FE(apache_request_headers,					arginfo_apachehooks__void)
	JONJ_FE(apache_note,								arginfo_apachehooks_note)
	JONJ_FE(apache_lookup_uri,						arginfo_apachehooks_lookup_uri)
	JONJ_FE(apache_child_terminate,					arginfo_apachehooks__void)
	JONJ_FE(apache_setenv,							arginfo_apachehooks_setenv)
	JONJ_FE(apache_response_headers,					arginfo_apachehooks__void)
	JONJ_FE(apache_get_version,						arginfo_apachehooks__void)
	JONJ_FE(apache_get_modules,						arginfo_apachehooks__void)
	JONJ_FALIAS(getallheaders, apache_request_headers, arginfo_apachehooks__void)
	{NULL, NULL, NULL}
};

/* {{{ jonj_apache ini entries
 */
JONJ_INI_BEGIN()
...
#define APREQ_GET_THIS(ZVAL)		if (NULL == (ZVAL = getThis())) { \
										jonj_error(E_WARNING, "%s(): underlying ApacheRequest object missing", \
...
static void jonj_apache_request_free(zend_rsrc_list_entry *rsrc TSRMLS_DC)
{
...
static request_rec *get_apache_request(zval *z TSRMLS_DC)
{
	...
	if (NULL == z) {
		jonj_error(E_WARNING, "get_apache_request() invalid wrapper passed");
		return NULL;
	}

	if (Z_TYPE_P(z) != IS_OBJECT) {
		jonj_error(E_WARNING, "%s(): wrapper is not an object", get_active_function_name(TSRMLS_C));
		return NULL;
	}

	if (zend_hash_index_find(Z_OBJPROP_P(z), 0, (void **)&addr) == FAILURE) {
		jonj_error(E_WARNING, "%s(): underlying object missing", get_active_function_name(TSRMLS_C));
		return NULL;
	}

	r = (request_rec *)Z_LVAL_PP(addr);
	if (!r) {
		jonj_error(E_WARNING, "%s(): request_rec invalid", get_active_function_name(TSRMLS_C));
		return NULL;
	}
...
/* {{{ jonj_apache_request_new(request_rec *r)
 ...
 */
JONJ_FUNCTION(apache_request_filename)
{
 ...
 */
JONJ_FUNCTION(apache_request_uri)
{
 ...
 */
JONJ_FUNCTION(apache_request_unparsed_uri)
{
 ...
 */
JONJ_FUNCTION(apache_request_path_info)
{
 ...
 */
JONJ_FUNCTION(apache_request_args)
{
 ...
 */
JONJ_FUNCTION(apache_request_boundary)
{
 ...
 */
JONJ_FUNCTION(apache_request_content_type)
{
 ...
 */
JONJ_FUNCTION(apache_request_content_encoding)
{
 ...
 */
JONJ_FUNCTION(apache_request_handler)
{
 ...
 */
JONJ_FUNCTION(apache_request_the_request)
{
 ...
 */
JONJ_FUNCTION(apache_request_protocol)
{
 ...
 */
JONJ_FUNCTION(apache_request_hostname)
{
 ...
 */
JONJ_FUNCTION(apache_request_status_line)
{
 ...
 */
JONJ_FUNCTION(apache_request_method)
{
 ...
 */
JONJ_FUNCTION(apache_request_proto_num)
{
 ...
 */
JONJ_FUNCTION(apache_request_assbackwards)
{
 ...
 */
JONJ_FUNCTION(apache_request_proxyreq)
{
 ...
 */
JONJ_FUNCTION(apache_request_chunked)
{
 ...
 */
JONJ_FUNCTION(apache_request_header_only)
{
 ...
 */
JONJ_FUNCTION(apache_request_request_time)
{
 ...
 */
JONJ_FUNCTION(apache_request_status)
{
 ...
 */
JONJ_FUNCTION(apache_request_method_number)
{
 ...
 */
JONJ_FUNCTION(apache_request_allowed)
{
 ...
 */
JONJ_FUNCTION(apache_request_bytes_sent)
{
 ...
 */
JONJ_FUNCTION(apache_request_mtime)
{
 ...
 */
JONJ_FUNCTION(apache_request_content_length)
{
	zval *id;
	long zlen;
	request_rec *r;
 ...
 */
JONJ_FUNCTION(apache_request_remaining)
{
 ...
 */
JONJ_FUNCTION(apache_request_no_cache)
{
 ...
 */
JONJ_FUNCTION(apache_request_no_local_copy)
{
 ...
 */
JONJ_FUNCTION(apache_request_read_body)
{
 ...
 */
JONJ_FUNCTION(apache_request_headers_in)
{
	zval *id;
	request_rec *r;
			...
			case 3:
				...
				while (zend_hash_get_current_data_ex(Z_ARRVAL_P(first), (void **)&entry, &pos) == SUCCESS) {
					switch(zend_hash_get_current_key_ex(Z_ARRVAL_P(first), &string_key, &string_key_len, &num_key, 0, &pos)) {
						...
						default:
							jonj_error(E_WARNING, "%s(): Can only add STRING keys to headers!", get_active_function_name(TSRMLS_C));
							break;
					}
 ...
 */
JONJ_FUNCTION(apache_request_headers_out)
{
	zval *id;
	request_rec *r;
 ...
 */
JONJ_FUNCTION(apache_request_err_headers_out)
{
	zval *id;
	request_rec *r;
 ...
 */
JONJ_FUNCTION(apache_request_server_port)
{
	zval *id;
	request_rec *r;
 ...
 */
JONJ_FUNCTION(apache_request_remote_host)
{
	zval *id;
	long type = 0;
	request_rec *r;
 ...
 */
JONJ_FUNCTION(apache_request_update_mtime)
{
	zval *id;
	request_rec *r;
	long mtime = 0;
 ...
 */
JONJ_FUNCTION(apache_request_set_etag)
{
	zval *id;
	request_rec *r;
 ...
 */
JONJ_FUNCTION(apache_request_set_last_modified)
{
	zval *id;
	request_rec *r;
 ...
 */
JONJ_FUNCTION(apache_request_meets_conditions)
{
	zval *id;
	request_rec *r;
 ...
 */
JONJ_FUNCTION(apache_request_discard_request_body)
{
	zval *id;
	request_rec *r;
 ...
 */
JONJ_FUNCTION(apache_request_satisfies)
{
	zval *id;
	request_rec *r;
 ...
 */
JONJ_FUNCTION(apache_request_is_initial_req)
{
	zval *id;
	request_rec *r;
 ...
 */
JONJ_FUNCTION(apache_request_some_auth_required)
{
	zval *id;
	request_rec *r;
 ...
 */
JONJ_FUNCTION(apache_request_auth_type)
{
	zval *id;
	request_rec *r;
	char *t;
 ...
 */
JONJ_FUNCTION(apache_request_auth_name)
{
	zval *id;
	request_rec *r;
	char *t;
 ...
 */
JONJ_FUNCTION(apache_request_basic_auth_pw)
{
	zval *id, *zpw;
	request_rec *r;
	const char *pw;
...
JONJ_FUNCTION(apache_request_send_http_header)
{
    zval *id;
    request_rec *r;
    char *type = NULL;
...
JONJ_FUNCTION(apache_request_basic_http_header)
{
    zval *id;
    request_rec *r;
...
JONJ_FUNCTION(apache_request_send_http_trace)
{
    zval *id;
    request_rec *r;
...
JONJ_FUNCTION(apache_request_send_http_options)
{
    zval *id;
    request_rec *r;
...
JONJ_FUNCTION(apache_request_send_error_response)
{
    zval *id;
    request_rec *r;
	long rec = 0;
...
JONJ_FUNCTION(apache_request_set_content_length)
{
	long length;
    zval *id;
    request_rec *r;
...
JONJ_FUNCTION(apache_request_set_keepalive)
{
    zval *id;
    request_rec *r;
...
JONJ_FUNCTION(apache_request_send_fd) 
{
}

JONJ_FUNCTION(apache_request_send_fd_length)
{
}
*/

/* These are for overriding default output behaviour */
JONJ_FUNCTION(apache_request_rputs)
{
    char *buffer;
	int buffer_len;
    zval *id;
...
/* This stuff would be useful for custom POST handlers, 
   ...
   sapi_activate at all inside a jonjResponseHandler
...
JONJ_FUNCTION(apache_request_setup_client_block)
{
}

JONJ_FUNCTION(apache_request_should_client_block)
{
}

JONJ_FUNCTION(apache_request_get_client_block)
{
}
 ...
 */
JONJ_FUNCTION(apache_request_log_error)
{
    zval *id;
	char *z_errstr;
	int z_errstr_len;
...
*/
JONJ_FUNCTION(apache_request_sub_req_lookup_uri)
{
    zval *id;
	char *file;
	int file_len;
    ...
    return_value = jonj_apache_request_new(sub_r);
}
/* }}} */
...
/* {{{ proto object apache_request_sub_req_lookup_file(string file)
    ...
    need to run it yourself with run().
*/
JONJ_FUNCTION(apache_request_sub_req_lookup_file)
{
    zval *id;
	char *file;
	int file_len;
...
/* {{{ proto object apache_request_sub_req_method_uri(string method, string uri)
    ...
    need to run it yourself with run().
*/
JONJ_FUNCTION(apache_request_sub_req_method_uri)
{
    zval *id;
	char *file, *method;
...
*/
JONJ_FUNCTION(apache_request_run)
{
    zval *id;
    request_rec *r;
    int status;
...
JONJ_FUNCTION(apache_request_internal_redirect)
{
    zval *id;
	char *new_uri;
	int new_uri_len;
...
JONJ_FUNCTION(apache_request_send_header_field)
{
...
/* {{{ jonj_apache_request_class_functions
 */
const static zend_function_entry jonj_apache_request_class_functions[] = {
	/* string slots */
	JONJ_FALIAS(args,						apache_request_args,				NULL)
	JONJ_FALIAS(boundary,					apache_request_boundary,			NULL)
	JONJ_FALIAS(content_encoding,			apache_request_content_encoding,	NULL)
	JONJ_FALIAS(content_type,				apache_request_content_type,		NULL)
	JONJ_FALIAS(filename,					apache_request_filename,			NULL)
	JONJ_FALIAS(handler,						apache_request_handler,				NULL)
	JONJ_FALIAS(hostname,					apache_request_hostname,			NULL)
	JONJ_FALIAS(method,						apache_request_method,				NULL)
	JONJ_FALIAS(path_info,					apache_request_path_info,			NULL)
	JONJ_FALIAS(protocol,					apache_request_protocol,			NULL)
	JONJ_FALIAS(status_line,					apache_request_status_line,			NULL)
	JONJ_FALIAS(the_request,					apache_request_the_request,			NULL)
	JONJ_FALIAS(unparsed_uri,				apache_request_unparsed_uri,		NULL)
	JONJ_FALIAS(uri,							apache_request_uri,					NULL)

	/* int slots */
	JONJ_FALIAS(allowed,						apache_request_allowed,				NULL)
	JONJ_FALIAS(bytes_sent,					apache_request_bytes_sent,			NULL)
	JONJ_FALIAS(chunked,						apache_request_chunked,				NULL)
	JONJ_FALIAS(content_length,				apache_request_content_length,		NULL)
	JONJ_FALIAS(header_only,					apache_request_header_only,			NULL)
	JONJ_FALIAS(method_number,				apache_request_method_number,		NULL)
	JONJ_FALIAS(mtime,						apache_request_mtime,				NULL)
	JONJ_FALIAS(no_cache,					apache_request_no_cache,			NULL)
	JONJ_FALIAS(no_local_copy,				apache_request_no_local_copy,		NULL)
	JONJ_FALIAS(proto_num,					apache_request_proto_num,			NULL)
	JONJ_FALIAS(proxyreq,					apache_request_proxyreq,			NULL)
	JONJ_FALIAS(read_body,					apache_request_read_body,			NULL)
	JONJ_FALIAS(remaining,					apache_request_remaining,			NULL)
	JONJ_FALIAS(request_time,				apache_request_request_time,		NULL)
	JONJ_FALIAS(status,						apache_request_status,				NULL)

	/* tables & arrays */
	JONJ_FALIAS(headers_in,					apache_request_headers_in,			NULL)
	JONJ_FALIAS(headers_out,					apache_request_headers_out,			NULL)
	JONJ_FALIAS(err_headers_out,				apache_request_err_headers_out,			NULL)
...
#undef internal_redirect
	JONJ_FALIAS(auth_name,					apache_request_auth_name,				NULL)
	JONJ_FALIAS(auth_type,					apache_request_auth_type,				NULL)
	JONJ_FALIAS(basic_auth_pw,				apache_request_basic_auth_pw,			NULL)
	JONJ_FALIAS(discard_request_body,		apache_request_discard_request_body,	NULL)
	JONJ_FALIAS(is_initial_req,				apache_request_is_initial_req,			NULL)
	JONJ_FALIAS(meets_conditions,			apache_request_meets_conditions,		NULL)
	JONJ_FALIAS(remote_host,					apache_request_remote_host,				NULL)
	JONJ_FALIAS(satisfies,					apache_request_satisfies,				NULL)
	JONJ_FALIAS(server_port,					apache_request_server_port,				NULL)
	JONJ_FALIAS(set_etag,					apache_request_set_etag,				NULL)
	JONJ_FALIAS(set_last_modified,			apache_request_set_last_modified,		NULL)
	JONJ_FALIAS(some_auth_required,			apache_request_some_auth_required,		NULL)
	JONJ_FALIAS(update_mtime,				apache_request_update_mtime,			NULL)
	JONJ_FALIAS(send_http_header,			apache_request_send_http_header,		NULL)
	JONJ_FALIAS(basic_http_header,			apache_request_basic_http_header,		NULL)
    JONJ_FALIAS(send_header_field,           apache_request_send_header_field,       NULL)
	JONJ_FALIAS(send_http_trace,			    apache_request_send_http_trace,		    NULL)
	JONJ_FALIAS(send_http_options,			apache_request_send_http_trace,		    NULL)
	JONJ_FALIAS(send_error_response,			apache_request_send_error_response,	    NULL)
    JONJ_FALIAS(set_content_length,          apache_request_set_content_length,      NULL)
    JONJ_FALIAS(set_keepalive,               apache_request_set_keepalive,           NULL)
    JONJ_FALIAS(rputs,                       apache_request_rputs,                   NULL)
    JONJ_FALIAS(log_error,                   apache_request_log_error,               NULL)
    JONJ_FALIAS(lookup_uri,                  apache_request_sub_req_lookup_uri,      NULL)
    JONJ_FALIAS(lookup_file,                 apache_request_sub_req_lookup_file,     NULL)
    JONJ_FALIAS(method_uri,                  apache_request_sub_req_method_uri,      NULL)
    JONJ_FALIAS(run,                         apache_request_run,                     NULL)
    JONJ_FALIAS(internal_redirect,           apache_request_internal_redirect,       NULL)
	JONJ_FE_END
};
/* }}} */
...
static JONJ_MINIT_FUNCTION(apache)
{
	...
	le_apachereq = zend_register_list_destructors_ex(jonj_apache_request_free, NULL, "ApacheRequest", module_number);
	INIT_OVERLOADED_CLASS_ENTRY(ce, "ApacheRequest", jonj_apache_request_class_functions, NULL, NULL, NULL);
...
JONJ_FUNCTION(apache_child_terminate)
{
	...
	if (AP(terminate_child)) {
		...
		jonj_error(E_WARNING, "apache.child_terminate is disabled");
		RETURN_FALSE;
	}
#else
		jonj_error(E_WARNING, "apache_child_terminate() is not supported in this build");
		RETURN_FALSE;
#endif
}
/* }}} */
...
JONJ_MINFO_FUNCTION(apache)
{
	...
	jonj_info_print_table_row(2, "Apache Version", SERVER_VERSION);
...
JONJ_FUNCTION(virtual)
{
	...
	if (!(rr = sub_req_lookup_uri (filename, ((request_rec *) SG(server_context))))) {
		jonj_error(E_WARNING, "Unable to include '%s' - URI lookup failed", filename);
		if (rr)
			destroy_sub_req (rr);
		RETURN_FALSE;
	}
	...
	if (rr->status != 200) {
		jonj_error(E_WARNING, "Unable to include '%s' - error finding URI", filename);
		if (rr)
			destroy_sub_req (rr);
		RETURN_FALSE;
	}
	...
	if (run_sub_req(rr)) {
		jonj_error(E_WARNING, "Unable to include '%s' - request execution failed", filename);
		if (rr)
			destroy_sub_req (rr);
		RETURN_FALSE;
	} 
...
JONJ_FUNCTION(apache_lookup_uri)
{
	...
	if(!(rr = sub_req_lookup_uri(filename, ((request_rec *) SG(server_context))))) {
		jonj_error(E_WARNING, "URI lookup failed", filename);
		RETURN_FALSE;
	}
...
JONJ_FUNCTION(apache_exec_uri)
{
	...
	if(!(rr = ap_sub_req_lookup_uri((*filename)->value.str.val, ((request_rec *) SG(server_context))))) {
		jonj_error(E_WARNING, "URI lookup failed", (*filename)->value.str.val);
		RETURN_FALSE;
	}
