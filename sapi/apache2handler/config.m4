...
if test "$JONJ_APXS2" != "no"; then
  if test "$JONJ_APXS2" = "yes"; then
    APXS=apxs
    ...
    JONJ_EXPAND_PATH($JONJ_APXS2, APXS)
  fi
  ...
  *aix*)
    ...
    JONJ_SELECT_SAPI(apache2handler, shared, mod_jonj5.c sapi_apache2.c apache_config.c jonj_functions.c, $APACHE_CFLAGS)
  ...
  *darwin*)
    ...
    JONJ_SELECT_SAPI(apache2handler, bundle, mod_jonj5.c sapi_apache2.c apache_config.c jonj_functions.c, $APACHE_CFLAGS)
