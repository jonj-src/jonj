...
typedef struct {
	...
	/* Do not use request_body directly, but the jonj://input stream wrapper instead */
	struct _jonj_stream *request_body;
...
struct _sapi_module_struct {
	...
	int jonj_ini_ignore;
	int jonj_ini_ignore_cwd; /* don't look for jonj.ini in the current directory */
...
#define SAPI_DEFAULT_CHARSET		JONJ_DEFAULT_CHARSET
#define SAPI_JONJ_VERSION_HEADER		"X-Powered-By: JONJ/" JONJ_VERSION
