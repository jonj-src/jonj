...
AC_DEFUN([LIBZEND_BISON_CHECK],[
  ...
  case $jonj_cv_bison_version in
    ""|invalid[)]
      bison_msg="This bison version is not supported for regeneration of the Zend/JONJ parsers (found: $bison_version, min: $bison_version_min, excluded: $bison_version_exclude)."
...
[AC_CACHE_CHECK([whether byte ordering is bigendian], ac_cv_c_bigendian_jonj,
 [
  ac_cv_c_bigendian_jonj=unknown
  AC_TRY_RUN(
  [
int main(void)
{
  ...
  ], [ac_cv_c_bigendian_jonj=yes], [ac_cv_c_bigendian_jonj=no], [ac_cv_c_bigendian_jonj=unknown])
 ])
 if test $ac_cv_c_bigendian_jonj = yes; then
...
dnl See: http://wiki.jonj.tk/rfc/rounding
