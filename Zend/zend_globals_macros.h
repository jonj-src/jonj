...
typedef struct _zend_jonj_scanner_globals zend_jonj_scanner_globals;
...
/* Language Scanner */
#ifdef ZTS
# define LANG_SCNG(v) TSRMG(language_scanner_globals_id, zend_jonj_scanner_globals *, v)
extern ZEND_API ts_rsrc_id language_scanner_globals_id;
#else
# define LANG_SCNG(v) (language_scanner_globals.v)
extern ZEND_API zend_jonj_scanner_globals language_scanner_globals;
#endif
